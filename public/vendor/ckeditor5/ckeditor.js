...
!function (t) {
    t.en = Object.assign(t.en || {}, {
        ...
        o: "media widget",
        p: "Insert media",
        q: "The URL must not be empty.",
        r: "This media URL is not supported.",
        s: "Insert table",
        t: "Header column",
        u: "Insert column before",
        v: "Insert column after",
        w: "Delete column",
        x: "Column",
        y: "Header row",
        z: "Insert row below",
        ...
        am: "Choose heading",
        an: "Heading",
        ao: "Upload in progress",
        ap: "Change image text alternative",
        aq: "Unlink",
        ar: "Edit link",
        as: "Open link in new tab",
        at: "This link has no URL",
        au: "Rich Text Editor, %0",
        av: "Rich Text Editor",
        aw: "Save",
        ax: "Cancel",
        ay: "Text alternative",
    ...
    return function (t) {
        ...
        "use strict";
        var o = n(9), i = "object" == typeof self && self && self.Object === Object && self, r = o.a || i || Function("return this")();
        e.a = r
    }, function (t, e, n) {
        "use strict";
        (function (t) {
            var o = n(9), i = "object" == typeof exports && exports && !exports.nodeType && exports, r = i && "object" == typeof t && t && !t.nodeType && t, s = r && r.exports === i && o.a.process, a = function () {
                try {
        ...
        "use strict";
        (function (t) {
            var o = n(4), i = n(18), r = "object" == typeof exports && exports && !exports.nodeType && exports, s = r && "object" == typeof t && t && !t.nodeType && t, a = s && s.exports === r ? o.a.Buffer : void 0, c = (a ? a.isBuffer : void 0) || i.a;
            e.a = c
        }).call(this, n(11)(t))
    }, function (t, e) {
        ...
        "use strict";
        (function (t) {
            var o = n(4), i = "object" == typeof exports && exports && !exports.nodeType && exports, r = i && "object" == typeof t && t && !t.nodeType && t, s = r && r.exports === i ? o.a.Buffer : void 0, a = s ? s.allocUnsafe : void 0;
            e.a = function (t, e) {
                if (e)return t.slice();
                var n = t.length, o = a ? a(n) : new t.constructor(n);
                return t.copy(o), o
            }
        }).call(this, n(11)(t))
    }, function (t, e) {
        ...
        t.exports = ".ck.ck-labeled-input .ck-labeled-input__error{font-size:var(--ck-font-size-small);color:var(--ck-color-base-error);margin-top:var(--ck-spacing-small)}"
    }, function (t, e, n) {
        var o = n(68);
        "string" == typeof o && (o = [[t.i, o, ""]]);
        var i = {singleton: !0, hmr: !0, transform: void 0, insertInto: void 0};
        ...
        t.exports = ".ck.ck-placeholder:before,.ck .ck-placeholder:before{content:attr(data-placeholder);pointer-event:none;cursor:text;color:var(--ck-color-engine-placeholder-text)}"
    }, function (t, e, n) {
        var o = n(95);
        "string" == typeof o && (o = [[t.i, o, ""]]);
        var i = {singleton: !0, hmr: !0, transform: void 0, insertInto: void 0};
        ...
        "use strict";
        n.r(e);
        var o = n(4), i = o.a.Symbol, r = Object.prototype, s = r.hasOwnProperty, a = r.toString, c = i ? i.toStringTag : void 0;
        var l = function (t) {
        ...
        var u = function (t) {
            return d.call(t)
        }, h = "[object Null]", f = "[object Undefined]", m = i ? i.toStringTag : void 0;
        var p = function (t) {
        ...
        }, _ = "[object Object]", k = Function.prototype, v = Object.prototype, y = k.toString, x = v.hasOwnProperty, A = y.call(Object);
        var C = function (t) {
        ...
        class S {
            constructor(t, e) {
                this.source = t, this.name = e, this.path = [], this.stop = P(), this.off = P()
            }
        }
        function E() {
            let t = "e";
        ...
        const N = Symbol("listeningTo"), O = Symbol("emitterId");
        var R = {
            on(t, e, n = {}){
                ...
                const c = V(t, e), l = I.get(o.priority), d = {callback: n, priority: l};
                for (const t of c) {
                    let e = !1;
                ...
                if (!(!o || t && !r || e && !s))if (n)z(t, e, n); else if (s) {
                    for (; n = s.pop();)z(t, e, n);
                ...
                const n = t instanceof S ? t : new S(this, t), o = n.name;
                ...
                if (n.path.push(this), i) {
                    const t = [n, ...e];
                    i = Array.from(i);
                    for (let e = 0; e < i.length && (i[e].callback.apply(this, t), n.off.called && (delete n.off.called, z(this, o, i[e].callback)), !n.stop.called); e++);
                }
        ...
        var G = function (t) {
            ...
            return !(n < 0 || (n == e.length - 1 ? e.pop() : Y.call(e, n, 1), --this.size, 0))
        };
        var $ = function (t) {
            var e = this.__data__, n = W(e, t);
        ...
        K.prototype.clear = H, K.prototype.delete = G, K.prototype.get = $, K.prototype.has = Q, K.prototype.set = J;
        var Z = K;
        var X = function () {
        ...
        }, it = "[object AsyncFunction]", rt = "[object Function]", st = "[object GeneratorFunction]", at = "[object Proxy]";
        var ct = function (t) {
            if (!ot(t))return !1;
            var e = p(t);
            return e == rt || e == st || e == it || e == at
        }, lt = o.a["__core-js_shared__"], dt = function () {
        ...
        var ft = function (t) {
            ...
            return ""
        }, mt = /^\[object .+?Constructor\]$/, pt = Function.prototype, gt = Object.prototype, bt = pt.toString, wt = gt.hasOwnProperty, _t = RegExp("^" + bt.call(wt).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
        var kt = function (t) {
            return !(!ot(t) || ut(t)) && (ct(t) ? _t : mt).test(ft(t))
        };
        var vt = function (t, e) {
        ...
        }, xt = yt(o.a, "Map"), At = yt(Object, "create");
        var Ct = function () {
        ...
        }, Mt = "__lodash_hash_undefined__", Pt = Object.prototype.hasOwnProperty;
        var St = function (t) {
            var e = this.__data__;
            if (At) {
                var n = e[t];
        ...
        var It = function (t) {
            var e = this.__data__;
            return At ? void 0 !== e[t] : Et.call(e, t)
        }, Nt = "__lodash_hash_undefined__";
        var Ot = function (t, e) {
            var n = this.__data__;
            return this.size += this.has(t) ? 0 : 1, n[t] = At && void 0 === e ? Nt : e, this
        };
        ...
        Rt.prototype.clear = Ct, Rt.prototype.delete = Tt, Rt.prototype.get = St, Rt.prototype.has = It, Rt.prototype.set = Ot;
        var Dt = Rt;
        var Lt = function () {
            this.size = 0, this.__data__ = {hash: new Dt, map: new (xt || Z), string: new Dt}
        };
        var jt = function (t) {
            var e = typeof t;
        ...
        var Vt = function (t, e) {
            var n = t.__data__;
            return jt(e) ? n["string" == typeof e ? "string" : "hash"] : n.map
        };
        var Ft = function (t) {
        ...
        Ht.prototype.clear = Lt, Ht.prototype.delete = Ft, Ht.prototype.get = zt, Ht.prototype.has = Bt, Ht.prototype.set = Ut;
        var qt = Ht, Wt = 200;
        var Yt = function (t, e) {
            var n = this.__data__;
            if (n instanceof Z) {
                var o = n.__data__;
                if (!xt || o.length < Wt - 1)return o.push([t, e]), this.size = ++n.size, this;
        ...
        Gt.prototype.clear = X, Gt.prototype.delete = tt, Gt.prototype.get = et, Gt.prototype.has = nt, Gt.prototype.set = Yt;
        var $t = Gt;
        var Qt = function (t, e) {
        ...
        var Kt = function (t, e, n) {
            "__proto__" == e && Jt ? Jt(t, e, {configurable: !0, enumerable: !0, value: n, writable: !0}) : t[e] = n
        }, Zt = Object.prototype.hasOwnProperty;
        var Xt = function (t, e, n) {
            var o = t[e];
            Zt.call(t, e) && q(o, n) && (void 0 !== n || e in t) || Kt(t, e, n)
        };
        var te = function (t, e, n, o) {
            var i = !n;
            n || (n = {});
            for (var r = -1, s = e.length; ++r < s;) {
                var a = e[r], c = o ? o(n[a], t[a], a, n, t) : void 0;
                void 0 === c && (c = t[a]), i ? Kt(n, a, c) : Xt(n, a, c)
            }
            return n
        };
        var ee = function (t, e) {
        ...
        var oe = function (t) {
            return w(t) && p(t) == ne
        }, ie = Object.prototype, re = ie.hasOwnProperty, se = ie.propertyIsEnumerable, ae = oe(function () {
            return arguments
        }()) ? oe : function (t) {
            return w(t) && re.call(t, "callee") && !se.call(t, "callee")
        }, ce = Array.isArray, le = n(6), de = 9007199254740991, ue = /^(?:0|[1-9]\d*)$/;
        var he = function (t, e) {
            var n = typeof t;
            return !!(e = null == e ? de : e) && ("number" == n || "symbol" != n && ue.test(t)) && t > -1 && t % 1 == 0 && t < e
        }, fe = 9007199254740991;
        var me = function (t) {
        ...
        var ge = function (t) {
            return w(t) && me(t.length) && !!pe[p(t)]
        };
        var be = function (t) {
            return function (e) {
                return t(e)
            }
        }, we = n(5), _e = we.a && we.a.isTypedArray, ke = _e ? be(_e) : ge, ve = Object.prototype.hasOwnProperty;
        var ye = function (t, e) {
            var n = ce(t), o = !n && ae(t), i = !n && !o && Object(le.a)(t), r = !n && !o && !i && ke(t), s = n || o || i || r, a = s ? ee(t.length, String) : [], c = a.length;
            for (var l in t)!e && !ve.call(t, l) || s && ("length" == l || i && ("offset" == l || "parent" == l) || r && ("buffer" == l || "byteLength" == l || "byteOffset" == l) || he(l, c)) || a.push(l);
            return a
        }, xe = Object.prototype;
        var Ae = function (t) {
            var e = t && t.constructor;
            return t === ("function" == typeof e && e.prototype || xe)
        }, Ce = g(Object.keys, Object), Te = Object.prototype.hasOwnProperty;
        var Me = function (t) {
            if (!Ae(t))return Ce(t);
            var e = [];
            for (var n in Object(t))Te.call(t, n) && "constructor" != n && e.push(n);
            return e
        };
        var Pe = function (t) {
            return null != t && me(t.length) && !ct(t)
        };
        var Se = function (t) {
            return Pe(t) ? ye(t) : Me(t)
        };
        var Ee = function (t, e) {
            return t && te(e, Se(e), t)
        };
        var Ie = function (t) {
            var e = [];
        ...
        var Oe = function (t) {
            if (!ot(t))return Ie(t);
            var e = Ae(t), n = [];
            for (var o in t)("constructor" != o || !e && Ne.call(t, o)) && n.push(o);
            return n
        };
        var Re = function (t) {
            return Pe(t) ? ye(t, !0) : Oe(t)
        };
        var De = function (t, e) {
            return t && te(e, Re(e), t)
        }, Le = n(19);
        var je = function (t, e) {
            var n = -1, o = t.length;
        ...
        var Fe = function () {
            return []
        }, ze = Object.prototype.propertyIsEnumerable, Be = Object.getOwnPropertySymbols, Ue = Be ? function (t) {
            return null == t ? [] : (t = Object(t), Ve(Be(t), function (e) {
                return ze.call(t, e)
            }))
        } : Fe;
        var He = function (t, e) {
        ...
        var qe = function (t, e) {
            ...
            return t
        }, We = Object.getOwnPropertySymbols ? function (t) {
            for (var e = []; t;)qe(e, Ue(t)), t = b(t);
            return e
        } : Fe;
        var Ye = function (t, e) {
            return te(t, We(t), e)
        ...
        var Qe = function (t) {
            return Ge(t, Re, We)
        }, Je = yt(o.a, "DataView"), Ke = yt(o.a, "Promise"), Ze = yt(o.a, "Set"), Xe = yt(o.a, "WeakMap"), tn = ft(Je), en = ft(xt), nn = ft(Ke), on = ft(Ze), rn = ft(Xe), sn = p;
        (Je && "[object DataView]" != sn(new Je(new ArrayBuffer(1))) || xt && "[object Map]" != sn(new xt) || Ke && "[object Promise]" != sn(Ke.resolve()) || Ze && "[object Set]" != sn(new Ze) || Xe && "[object WeakMap]" != sn(new Xe)) && (sn = function (t) {
            var e = p(t), n = "[object Object]" == e ? t.constructor : void 0, o = n ? ft(n) : "";
            if (o)switch (o) {
                case tn:
        ...
        var an = sn, cn = Object.prototype.hasOwnProperty;
        var ln = function (t) {
            var e = t.length, n = new t.constructor(e);
            return e && "string" == typeof t[0] && cn.call(t, "index") && (n.index = t.index, n.input = t.input), n
        }, dn = o.a.Uint8Array;
        var un = function (t) {
            var e = new t.constructor(t.byteLength);
            return new dn(e).set(new dn(t)), e
        };
        var hn = function (t, e) {
            var n = e ? un(t.buffer) : t.buffer;
            return new t.constructor(n, t.byteOffset, t.byteLength)
        }, fn = /\w*$/;
        var mn = function (t) {
            var e = new t.constructor(t.source, fn.exec(t));
            return e.lastIndex = t.lastIndex, e
        }, pn = i ? i.prototype : void 0, gn = pn ? pn.valueOf : void 0;
        var bn = function (t) {
        ...
        var Bn = function (t) {
            return "function" != typeof t.constructor || Ae(t) ? {} : zn(b(t))
        }, Un = "[object Map]";
        var Hn = function (t) {
            return w(t) && an(t) == Un
        }, qn = we.a && we.a.isMap, Wn = qn ? be(qn) : Hn, Yn = "[object Set]";
        var Gn = function (t) {
            return w(t) && an(t) == Yn
        }, $n = we.a && we.a.isSet, Qn = $n ? be($n) : Gn, Jn = 1, Kn = 2, Zn = 4, Xn = "[object Arguments]", to = "[object Function]", eo = "[object GeneratorFunction]", no = "[object Object]", oo = {};
        oo[Xn] = oo["[object Array]"] = oo["[object ArrayBuffer]"] = oo["[object DataView]"] = oo["[object Boolean]"] = oo["[object Date]"] = oo["[object Float32Array]"] = oo["[object Float64Array]"] = oo["[object Int8Array]"] = oo["[object Int16Array]"] = oo["[object Int32Array]"] = oo["[object Map]"] = oo["[object Number]"] = oo[no] = oo["[object RegExp]"] = oo["[object Set]"] = oo["[object String]"] = oo["[object Symbol]"] = oo["[object Uint8Array]"] = oo["[object Uint8ClampedArray]"] = oo["[object Uint16Array]"] = oo["[object Uint32Array]"] = !0, oo["[object Error]"] = oo[to] = oo["[object WeakMap]"] = !1;
        var io = function t(e, n, o, i, r, s) {
            var a, c = n & Jn, l = n & Kn, d = n & Zn;
            if (o && (a = r ? o(e, i, r, s) : o(e)), void 0 !== a)return a;
            if (!ot(e))return e;
            var u = ce(e);
            if (u) {
                if (a = ln(e), !c)return je(e, a)
            } else {
                var h = an(e), f = h == to || h == eo;
                if (Object(le.a)(e))return Object(Le.a)(e, c);
                if (h == no || h == Xn || f && !r) {
                    if (a = l || f ? {} : Bn(e), !c)return l ? Ye(e, De(a, e)) : He(e, Ee(a, e))
                } else {
                    if (!oo[h])return r ? e : {};
                    a = Vn(e, h, c)
                }
            ...
            var m = s.get(e);
            if (m)return m;
            if (s.set(e, a), Qn(e))return e.forEach(function (i) {
                a.add(t(i, n, o, i, e, s))
            }), a;
            if (Wn(e))return e.forEach(function (i, r) {
                a.set(r, t(i, n, o, r, e, s))
            }), a;
            var p = d ? l ? Qe : $e : l ? keysIn : Se, g = u ? void 0 : p(e);
            return Qt(g || e, function (i, r) {
                g && (i = e[r = i]), Xt(a, r, t(i, n, o, r, e, s))
            }), a
        }, ro = 4;
        var so = function (t) {
            return io(t, ro)
        ...
        class ao {
            ...
            get document() {
                return this.parent instanceof ao ? this.parent.document : null
            }
            ...
            isBefore(t) {
                ...
                const e = this.getPath(), n = t.getPath(), o = U(e, n);
                switch (o) {
                    case"prefix":
                        return !0;
                    case"extension":
        ...
        class co extends ao {
            ...
            isSimilar(t) {
                return t instanceof co && (this === t || this.data === t.data)
            }
        ...
        class po extends ao {
            constructor(t, e, n) {
                if (super(), this.name = t, this._attrs = function (t) {
                    ...
                    bo(this._classes, t), this._attrs.delete("class")
                }
                this._styles = new Map, this._attrs.has("style") && (go(this._styles, this._attrs.get("style")), this._attrs.delete("style")), this._customProperties = new Map
            }
            ...
            *getCustomProperties() {
            ...
            getIdentity() {
                const t = Array.from(this._classes).sort().join(","), e = Array.from(this._styles).map(t=>`${t[0]}:${t[1]}`).sort().join(";"), n = Array.from(this._attrs).map(t=>`${t[0]}="${t[1]}"`).sort().join(" ");
            ...
            _insertChild(t, e) {
                ...
                let n = 0;
                const o = function (t) {
                    if ("string" == typeof t)return [new co(t)];
                    ho(t) || (t = [t]);
                    return Array.from(t).map(t=>"string" == typeof t ? new co(t) : t instanceof lo ? new co(t.data) : t)
                }(e);
            ...
            _setAttribute(t, e) {
                e = String(e), this._fireChange("attributes", this), "class" == t ? bo(this._classes, e) : "style" == t ? go(this._styles, e) : this._attrs.set(t, e)
            }
                ...
                for (let s = 0; s < e.length; s++) {
                    ...
                    if (null === n)switch (a) {
                        ...
                        case"'":
                            ...
                            break;
                        case";": {
                            const n = e.substr(i, s - i);
                            r && t.set(r.trim(), n.trim()), r = null, o = s + 1;
                            break
                        }
                    } else a === n && (n = null)
                }
        ...
        class wo extends po {
            constructor(t, e, n) {
                super(t, e, n), this.getFillerOffset = _o
            }
        ...
        var xo = function (t, e, n) {
            return e = yo(void 0 === e ? t.length - 1 : e, 0), function () {
                for (var o = arguments, i = -1, r = yo(o.length - e, 0), s = Array(r); ++i < r;)s[i] = o[e + i];
                i = -1;
                for (var a = Array(e + 1); ++i < e;)a[i] = o[i];
                return a[e] = n(s), vo(t, this, a)
            }
        };
        var Ao = function (t) {
            return function () {
            ...
            return Jt(t, "toString", {configurable: !0, enumerable: !1, value: Ao(e), writable: !0})
        } : ko, To = 800, Mo = 16, Po = Date.now;
        var So = function (t) {
            var e = 0, n = 0;
            return function () {
                var o = Po(), i = Mo - (o - n);
                if (n = o, i > 0) {
                    if (++e >= To)return arguments[0]
                } else e = 0;
                return t.apply(void 0, arguments)
            }
        }(Co);
        var Eo = function (t, e) {
            return So(xo(t, e, ko), t + "")
        };
        var Io = function (t, e, n) {
            if (!ot(n))return !1;
            var o = typeof e;
            return !!("number" == o ? Pe(n) && he(e, n.length) : "string" == o && e in n) && q(n[e], t)
        };
        var No = function (t) {
            return Eo(function (e, n) {
                var o = -1, i = n.length, r = i > 1 ? n[i - 1] : void 0, s = i > 2 ? n[2] : void 0;
                for (r = t.length > 3 && "function" == typeof r ? (i--, r) : void 0, s && Io(n[0], n[1], s) && (r = i < 3 ? void 0 : r, i = 1), e = Object(e); ++o < i;) {
                    var a = n[o];
                    a && t(e, a, o, r)
                }
                return e
        ...
        const Oo = Symbol("observableProperties"), Ro = Symbol("boundObservables"), Do = Symbol("boundProperties"), Lo = {
            set(t, e){
                if (ot(t))return void Object.keys(t).forEach(e=> {
                    this.set(e, t[e])
                }, this);
                Vo(this);
                const n = this[Oo];
                ...
                if (!t.length || !Bo(t))throw new M.b("observable-bind-wrong-properties: All properties must be strings.");
                ...
                return t.forEach(t=> {
                    ...
                    e.set(t, o), n.set(t, o)
                }), {to: Fo, toMany: zo, _observable: this, _bindProperties: t, _to: [], _bindings: n}
            }, unbind(...t){
                if (!(Oo in this))return;
                const e = this[Do], n = this[Ro];
                if (t.length) {
                    if (!Bo(t))throw new M.b("observable-unbind-wrong-properties: Properties must be strings.");
                    t.forEach(t=> {
                        const o = e.get(t);
                        if (!o)return;
                        let i, r, s, a;
        ...
        function Vo(t) {
            Oo in t || (Object.defineProperty(t, Oo, {value: new Map}), Object.defineProperty(t, Ro, {value: new Map}), Object.defineProperty(t, Do, {value: new Map}))
        }
        ...
        class qo extends wo {
            ...
            get document() {
                return this.getCustomProperty(Ho)
            }

            set _document(t) {
                if (this.getCustomProperty(Ho))throw new M.b("view-editableelement-document-already-set: View document is already set.");
                this._setCustomProperty(Ho, t), this.bind("isReadOnly").to(t), this.bind("isFocused").to(t, "isFocused", e=>e && t.selection.editableElement == this), this.listenTo(t.selection, "change", ()=> {
                    this.isFocused = t.isFocused && t.selection.editableElement == this
                })
            }
        }
        B(qo, jo);
        const Wo = Symbol("rootName");
        class Yo extends qo {
            constructor(t) {
            ...
            get rootName() {
                return this.getCustomProperty(Wo)
            }

            set rootName(t) {
                this._setCustomProperty(Wo, t)
            }
        ...
        class Go {
            ...
            _next() {
                let t = $o.createFromPosition(this.position);
                ...
                let o;
                if (n instanceof co) {
                    if (t.isAtEnd)return this.position = $o.createAfter(n), this._next();
                    o = n.data[t.offset]
                } else o = n.getChild(t.offset);
                if (o instanceof po)return this.shallow ? t.offset++ : t = new $o(o, 0), this.position = t, this._formatReturnValue("elementStart", o, e, t, 1);
                if (o instanceof co) {
                    if (this.singleCharacters)return t = new $o(o, 0), this.position = t, this._next();
                    {
                        let n, i = o.data.length;
                        return o == this._boundaryEndParent ? (i = this.boundaries.end.offset, n = new lo(o, 0, i), t = $o.createAfter(n)) : (n = new lo(o, 0, o.data.length), t.offset++), this.position = t, this._formatReturnValue("text", n, e, t, i)
                    }
                }
                if ("string" == typeof o) {
                    let o;
                    ...
                    const i = new lo(n, t.offset, o);
                    return t.offset += o, this.position = t, this._formatReturnValue("text", i, e, t, o)
                }
                return t = $o.createAfter(n), this.position = t, this.ignoreElementEnd ? this._next() : this._formatReturnValue("elementEnd", n, e, t)
            }
            ...
            _previous() {
                ...
                let o;
                if (n instanceof co) {
                    if (t.isAtStart)return this.position = $o.createBefore(n), this._previous();
                    o = n.data[t.offset - 1]
                } else o = n.getChild(t.offset - 1);
                if (o instanceof po)return this.shallow ? (t.offset--, this.position = t, this._formatReturnValue("elementStart", o, e, t, 1)) : (t = new $o(o, o.childCount), this.position = t, this.ignoreElementEnd ? this._previous() : this._formatReturnValue("elementEnd", o, e, t));
                if (o instanceof co) {
                    if (this.singleCharacters)return t = new $o(o, o.data.length), this.position = t, this._previous();
                    {
                        let n, i = o.data.length;
                        if (o == this._boundaryStartParent) {
                            const e = this.boundaries.start.offset;
                            i = (n = new lo(o, e, o.data.length - e)).data.length, t = $o.createBefore(n)
                        } else n = new lo(o, 0, o.data.length), t.offset--;
                ...
                return t = $o.createBefore(n), this.position = t, this._formatReturnValue("elementStart", n, e, t, 1)
            }

            _formatReturnValue(t, e, n, o, i) {
                return e instanceof lo && (e.offsetInText + e.data.length == e.textNode.data.length && ("forward" != this.direction || this.boundaries && this.boundaries.end.isEqual(this.position) ? n = $o.createAfter(e.textNode) : (o = $o.createAfter(e.textNode), this.position = o)), 0 === e.offsetInText && ("backward" != this.direction || this.boundaries && this.boundaries.start.isEqual(this.position) ? n = $o.createBefore(e.textNode) : (o = $o.createBefore(e.textNode), this.position = o))), {
                    done: !1,
        ...
        class $o {
            ...
            getShiftedBy(t) {
                const e = $o.createFromPosition(this), n = e.offset + t;
            ...
            compareWith(t) {
                ...
                const e = this.parent.is("node") ? this.parent.getPath() : [], n = t.parent.is("node") ? t.parent.getPath() : [];
            ...
            static createAt(t, e) {
                if (t instanceof $o)return this.createFromPosition(t);
                {
                    const n = t;
        ...
        class Qo {
            constructor(t, e = null) {
                this.start = $o.createFromPosition(t), this.end = e ? $o.createFromPosition(e) : $o.createFromPosition(t)
            }

            *[Symbol.iterator]() {
                yield*new Go({boundaries: this, ignoreElementEnd: !0})
            }
            ...
            getEnlarged() {
                let t = this.start.getLastMatchingPosition(Jo, {direction: "backward"}), e = this.end.getLastMatchingPosition(Jo);
                return t.parent.is("text") && t.isAtStart && (t = $o.createBefore(t.parent)), e.parent.is("text") && e.isAtEnd && (e = $o.createAfter(e.parent)), new Qo(t, e)
            }

            getTrimmed() {
                let t = this.start.getLastMatchingPosition(Jo);
                if (t.isAfter(this.end) || t.isEqual(this.end))return new Qo(t, t);
                let e = this.end.getLastMatchingPosition(Jo, {direction: "backward"});
                const n = t.nodeAfter, o = e.nodeBefore;
                return n && n.is("text") && (t = new $o(n, 0)), o && o.is("text") && (e = new $o(o, o.data.length)), new Qo(t, e)
            }
            ...
            containsRange(t, e = !1) {
                t.isCollapsed && (e = !1);
                const n = this.containsPosition(t.start) || e && this.start.isEqual(t.start), o = this.containsPosition(t.end) || e && this.end.isEqual(t.end);
                return n && o
            }

            getDifference(t) {
                const e = [];
                return this.isIntersecting(t) ? (this.containsPosition(t.start) && e.push(new Qo(this.start, t.start)), this.containsPosition(t.end) && e.push(new Qo(t.end, this.end))) : e.push(Qo.createFromRange(this)), e
            }

            getIntersection(t) {
                if (this.isIntersecting(t)) {
                    let e = this.start, n = this.end;
                    return this.containsPosition(t.start) && (e = t.start), this.containsPosition(t.end) && (n = t.end), new Qo(e, n)
                }
                return null
            }

            getWalker(t = {}) {
                return t.boundaries = this, new Go(t)
            }
            ...
            *getPositions(t = {}) {
            ...
            static createFromParentsAndOffsets(t, e, n, o) {
                return new this(new $o(t, e), new $o(n, o))
            }
            ...
            static createOn(t) {
                ...
                return this.createFromPositionAndShift($o.createBefore(t), e)
            }

            static createCollapsedAt(t, e) {
                const n = $o.createAt(t, e), o = $o.createFromPosition(n);
                return new Qo(n, o)
            }
        }
        function Jo(t) {
        ...
        class Zo {
            ...
            *getRanges() {
                for (const t of this._ranges)yield Qo.createFromRange(t)
            }

            getFirstRange() {
                let t = null;
                for (const e of this._ranges)t && !e.start.isBefore(t.start) || (t = e);
                return t ? Qo.createFromRange(t) : null
            }
            ...
            getFirstPosition() {
                ...
                return t ? $o.createFromPosition(t.start) : null
            }

            getLastPosition() {
                const t = this.getLastRange();
                return t ? $o.createFromPosition(t.end) : null
            }
            ...
            isSimilar(t) {
                ...
                const e = Ko(this.getRanges());
                if (e != Ko(t.getRanges()))return !1;
                if (0 == e)return !0;
            ...
            getSelectedElement() {
                ...
                return e instanceof po && e == n ? e : null
            }

            setTo(t, e, n) {
                if (null === t)this._setRanges([]), this._setFakeOptions(e); else if (t instanceof Zo || t instanceof Xo)this._setRanges(t.getRanges(), t.isBackward), this._setFakeOptions({
                    fake: t.isFake,
                    label: t.fakeSelectionLabel
                }); else if (t instanceof Qo)this._setRanges([t], e && e.backward), this._setFakeOptions(e); else if (t instanceof $o)this._setRanges([new Qo(t)]), this._setFakeOptions(e); else if (t instanceof ao) {
                    ...
                    i = "in" == e ? Qo.createIn(t) : "on" == e ? Qo.createOn(t) : Qo.createCollapsedAt(t, e), this._setRanges([i], o), this._setFakeOptions(n)
                } else {
                    if (!ho(t))throw new M.b("view-selection-setTo-not-selectable: Cannot set selection to given place.");
            ...
            setFocus(t, e) {
                ...
                const n = $o.createAt(t, e);
                if ("same" == n.compareWith(this.focus))return;
                const o = this.anchor;
                this._ranges.pop(), "before" == n.compareWith(o) ? this._addRange(new Qo(n, o), !0) : this._addRange(new Qo(o, n)), this.fire("change")
            }
            ...
            _addRange(t, e = !1) {
                if (!(t instanceof Qo))throw new M.b("view-selection-add-range-not-range: Selection range set to an object that is not an instance of view.Range");
            ...
            _pushRange(t) {
                ...
                this._ranges.push(Qo.createFromRange(t))
            }
        }
        B(Zo, R);
        class Xo {
            constructor(t = null, e, n) {
                this._selection = new Zo, this._selection.delegate("change").to(this), this._selection.setTo(t, e, n)
            }
        ...
        class ei {
            constructor() {
                this.selection = new Xo, this.roots = new ti({idProperty: "rootName"}), this.set("isReadOnly", !1), this.set("isFocused", !1), this.set("isComposing", !1), this._postFixers = new Set
            }
        ...
        class oi extends po {
            constructor(t, e, n) {
                super(t, e, n), this.getFillerOffset = ii, this._priority = ni, this._id = null, this._clonesGroup = null
            }
        ...
        function ii() {
            if (ri(this))return null;
            let t = this.parent;
            for (; t && t.is("attributeElement");) {
                if (ri(t) > 1)return null;
                t = t.parent
            }
            return !t || ri(t) > 1 ? null : this.childCount
        }
        ...
        oi.DEFAULT_PRIORITY = ni;
        class si extends po {
            constructor(t, e, n) {
                super(t, e, n), this.getFillerOffset = ai
            }
            ...
            _insertChild(t, e) {
                if (e && (e instanceof ao || Array.from(e).length > 0))throw new M.b("view-emptyelement-cannot-add: Cannot add child nodes to EmptyElement instance.")
            }
        }
        function ai() {
            return null
        ...
        const ci = navigator.userAgent.toLowerCase();
        var li = {
            isMac: function (t) {
                return t.indexOf("macintosh") > -1
            }(ci), isEdge: function (t) {
                return !!t.match(/edge\/(\d+.?\d*)/)
            }(ci)
        };
        const di = {"⌘": "ctrl", "⇧": "shift", "⌥": "alt"}, ui = {ctrl: "⌘", shift: "⇧", alt: "⌥"}, hi = function () {
            const t = {
                arrowleft: 37,
                arrowup: 38,
                arrowright: 39,
        ...
        function fi(t) {
            let e;
            if ("string" == typeof t) {
                if (!(e = hi[t.toLowerCase()]))throw new M.b("keyboard-unknown-key: Unknown key name.", {key: t})
            } else e = t.keyCode + (t.altKey ? hi.alt : 0) + (t.ctrlKey ? hi.ctrl : 0) + (t.shiftKey ? hi.shift : 0);
            return e
        }

        function mi(t) {
            return "string" == typeof t && (t = pi(t)), t.map(t=>"string" == typeof t ? fi(t) : t).reduce((t, e)=>e + t, 0)
        }
        ...
        class gi extends po {
            constructor(t, e, n) {
                super(t, e, n), this.getFillerOffset = wi
            }
            ...
            _insertChild(t, e) {
                if (e && (e instanceof ao || Array.from(e).length > 0))throw new M.b("view-uielement-cannot-add: Cannot add child nodes to UIElement instance.")
            }
        ...
        function bi(t) {
            t.document.on("keydown", (e, n)=>(function (t, e, n) {
                if (e.keyCode == hi.arrowright) {
                    const t = e.domTarget.ownerDocument.defaultView.getSelection(), o = 1 == t.rangeCount && t.getRangeAt(0).collapsed;
                    if (o || e.shiftKey) {
        ...
        class ki {
            ...
            breakAttributes(t) {
                return t instanceof $o ? this._breakAttributes(t) : this._breakAttributesRange(t)
            }
            ...
            breakContainer(t) {
                ...
                if (t.isAtStart)return $o.createBefore(e);
                if (!t.isAtEnd) {
                    const n = e._clone(!1);
                    this.insert($o.createAfter(e), n);
                    const o = new Qo(t, $o.createAt(e, "end")), i = new $o(n, 0);
                    this.move(o, i)
                }
                return $o.createAfter(e)
            }
            ...
            mergeAttributes(t) {
                ...
                if (n.is("attributeElement") && 0 === n.childCount) {
                    ...
                    return n._remove(), this._removeFromClonedElementsGroup(n), this.mergeAttributes(new $o(t, e))
                }
                const o = n.getChild(e - 1), i = n.getChild(e);
                if (!o || !i)return t;
                if (o.is("text") && i.is("text"))return Ci(o, i);
                if (o.is("attributeElement") && i.is("attributeElement") && o.isSimilar(i)) {
                    const t = o.childCount;
                    return o._appendChild(i.getChildren()), i._remove(), this._removeFromClonedElementsGroup(i), this.mergeAttributes(new $o(o, t))
                }
                return t
            }
            ...
            mergeContainers(t) {
                ...
                const o = e.getChild(e.childCount - 1), i = o instanceof co ? $o.createAt(o, "end") : $o.createAt(e, "end");
                return this.move(Qo.createIn(n), $o.createAt(e, "end")), this.remove(Qo.createOn(n)), i
            }

            insert(t, e) {
                (function t(e) {
                    for (const n of e) {
                        if (!Ti.some(t=>n instanceof t))throw new M.b("view-writer-insert-invalid-node");
            ...
            remove(t) {
                const e = t instanceof Qo ? t : Qo.createOn(t);
                if (Pi(e), e.isCollapsed)return new _i;
                const {start:n, end:o}=this._breakAttributesRange(e, !0), i = n.parent, r = o.offset - n.offset, s = i._removeChildren(n.offset, r);
                for (const t of s)this._removeFromClonedElementsGroup(t);
                const a = this.mergeAttributes(n);
                return e.start = a, e.end = $o.createFromPosition(a), new _i(s)
            }
            ...
            clear(t, e) {
                ...
                for (const o of n) {
                    const n = o.item;
                    let i;
                    if (n.is("element") && e.isSimilar(n))i = Qo.createOn(n); else if (!o.nextPosition.isAfter(t.start) && n.is("textProxy")) {
            ...
            wrap(t, e) {
                if (!(e instanceof oi))throw new M.b("view-writer-wrap-invalid-attribute");
                if (Pi(t), t.isCollapsed) {
                    ...
                    return o.isCollapsed && o.getFirstPosition().isEqual(t.start) && this.setSelection(n), new Qo(n)
                }
                return this._wrapRange(t, e)
            }

            unwrap(t, e) {
                if (!(e instanceof oi))throw new M.b("view-writer-unwrap-invalid-attribute");
                if (Pi(t), t.isCollapsed)return t;
                const {start:n, end:o}=this._breakAttributesRange(t, !0);
                if (o.isEqual(n.getShiftedBy(1))) {
                    const t = n.nodeAfter;
                    if (!e.isSimilar(t) && t instanceof oi && this._unwrapAttributeElement(e, t)) {
                ...
                const i = n.parent, r = this._unwrapChildren(i, n.offset, o.offset, e), s = this.mergeAttributes(r.start);
            ...
            rename(t, e) {
                const n = new wo(t, e.getAttributes());
                return this.insert($o.createAfter(e), n), this.move(Qo.createIn(e), $o.createAt(n)), this.remove(Qo.createOn(e)), n
            }
            ...
            _wrapChildren(t, e, n, o) {
                ...
                const r = [];
                for (; i < n;) {
                    const e = t.getChild(i), n = e.is("text"), s = e.is("attributeElement"), a = e.is("emptyElement"), c = e.is("uiElement");
                    if (n || a || c || s && yi(o, e)) {
                        const n = o._clone();
                        e._remove(), n._appendChild(e), t._insertChild(i, n), this._addToClonedElementsGroup(n), r.push(new $o(t, i))
                ...
                return Qo.createFromParentsAndOffsets(t, e, t, n)
            }
            ...
            _unwrapChildren(t, e, n, o) {
                ...
                for (; i < n;) {
                    ...
                    if (e.isSimilar(o)) {
                        ...
                        e._remove(), t._insertChild(i, o), this._removeFromClonedElementsGroup(e), r.push(new $o(t, i), new $o(t, i + s)), i += s, n += s - 1
            ...
            _wrapRange(t, e) {
                if (function (t) {
                    ...
                    const e = t.start.parent, n = this.mergeAttributes($o.createAfter(e)), o = this.mergeAttributes($o.createBefore(e));
                    return new Qo(o, n)
                }
                const {start:n, end:o}=this._breakAttributesRange(t, !0);
                if (o.isEqual(n.getShiftedBy(1))) {
                    const t = n.nodeAfter;
                    if (t instanceof oi && this._wrapAttributeElement(e, t)) {
                        const t = this.mergeAttributes(n);
                        t.isEqual(n) || o.offset--;
                        const e = this.mergeAttributes(o);
                        return new Qo(t, e)
                ...
                const i = n.parent, r = this._unwrapChildren(i, n.offset, o.offset, e), s = this._wrapChildren(i, r.start.offset, r.end.offset, e), a = this.mergeAttributes(s.start);
            ...
            _wrapPosition(t, e) {
                if (e.isSimilar(t.parent))return xi($o.createFromPosition(t));
                t.parent.is("text") && (t = Ai(t));
                const n = this.createAttributeElement();
                n._priority = Number.POSITIVE_INFINITY, n.isSimilar = (()=>!1), t.parent._insertChild(t.offset, n);
                const o = new Qo(t, t.getShiftedBy(1));
                this.wrap(o, e);
                const i = new $o(n.parent, n.index);
                n._remove();
                const r = i.nodeBefore, s = i.nodeAfter;
                return r instanceof co && s instanceof co ? Ci(r, s) : xi(i)
            }
            ...
            _breakAttributesRange(t, e = !1) {
                ...
                return i.offset += i.parent.childCount - r, new Qo(s, i)
            }
            ...
            _breakAttributes(t, e = !1) {
                ...
                if (!e && o.is("text") && Mi(o.parent))return $o.createFromPosition(t);
                if (Mi(o))return $o.createFromPosition(t);
                if (o.is("text"))return this._breakAttributes(Ai(t), e);
                if (n == o.childCount) {
                    const t = new $o(o.parent, o.index + 1);
                    return this._breakAttributes(t, e)
                }
                if (0 === n) {
                    const t = new $o(o.parent, o.index);
                    return this._breakAttributes(t, e)
                }
                {
        ...
        function xi(t) {
            ...
            if (e && e.is("text"))return new $o(e, e.data.length);
            const n = t.nodeAfter;
            return n && n.is("text") ? new $o(n, 0) : t
        }

        function Ai(t) {
            if (t.offset == t.parent.data.length)return new $o(t.parent.parent, t.parent.index + 1);
            if (0 === t.offset)return new $o(t.parent.parent, t.parent.index);
            const e = t.parent.data.slice(t.offset);
            return t.parent._data = t.parent.data.slice(0, t.offset), t.parent.parent._insertChild(t.parent.index + 1, new co(e)), new $o(t.parent.parent, t.parent.index + 1)
        }

        function Ci(t, e) {
            const n = t.data.length;
            return t._data += e.data, e._remove(), new $o(t, n)
        }

        const Ti = [co, oi, wo, si, gi];
        ...
        }, Ni = t=>t.createTextNode(" "), Oi = 7;
        let Ri = "";
        for (let t = 0; t < Oi; t++)Ri += "​";
        function Di(t) {
            return Ei(t) && t.data.substr(0, Oi) === Ri
        }

        function Li(t) {
            return t.data.length == Oi && Di(t)
        }

        function ji(t) {
            return Di(t) ? t.data.slice(Oi) : t.data
        }
        ...
        function Bi(t, e, n) {
            ...
            function d(a) {
                const d = (void 0 !== l[a - 1] ? l[a - 1] : -1) + 1, u = void 0 !== l[a + 1] ? l[a + 1] : -1, h = d > u ? -1 : 1;
                c[a + h] && (c[a] = c[a + h].slice(0)), c[a] || (c[a] = []), c[a].push(d > u ? o : i);
                let f = Math.max(d, u), m = f - a;
                for (; m < r && f < s && n(t[m], e[f]);)m++, f++, c[a].push("equal");
                return f
            }
        ...
        function Wi(t, e) {
            ...
            return function (t, e) {
                ...
                const n = Yi(t, e), o = Gi(t, n), i = Gi(e, n), r = Yi(o, i), s = t.length - r, a = e.length - r;
        ...
        class $i {
            ...
            render() {
                ...
                if (t) {
                    ...
                    Di(e.parent) ? this._inlineFiller = e.parent : this._inlineFiller = Qi(n, e.parent, e.offset)
            ...
            _updateChildrenMappings(t) {
                ...
                if (!e)return;
                const n = this.domConverter.mapViewToDom(t).childNodes, o = Array.from(this.domConverter.viewChildrenToDom(t, e.ownerDocument, {withChildren: !1})), i = this._diffNodeLists(n, o), r = this._findReplaceActions(i, n, o);
                if (-1 !== r.indexOf("replace")) {
                    ...
                    for (const i of r)if ("replace" === i) {
                        ...
                        s && !s.is("uiElement") && this._updateElementMappings(s, n[r]), Hi(o[i]), e.equal++
                    } else e[i]++
                }
            }
            ...
            _getInlineFillerPosition() {
                ...
                return t.parent.is("text") ? $o.createBefore(this.selection.getFirstPosition().parent) : t
            }
            ...
            _isSelectionInInlineFiller() {
                ...
                return !!(e && Ei(e.parent) && Di(e.parent))
            }

            _removeInlineFiller() {
                const t = this._inlineFiller;
                if (!Di(t))throw new M.b("view-renderer-filler-was-lost: The inline filler node was lost.");
                Li(t) ? t.parentNode.removeChild(t) : t.data = t.data.substr(Oi), this._inlineFiller = null
            }
            ...
            _needsInlineFillerAtSelection() {
                ...
                return !(o instanceof co || i instanceof co)
            }

            _updateText(t, e) {
                const n = this.domConverter.findCorrespondingDomText(t), o = this.domConverter.viewToDom(t, n.ownerDocument), i = n.data;
                let r = o.data;
                const s = e.inlineFillerPosition;
                if (s && s.parent == t.parent && s.offset == t.index && (r = Ri + r), i != r) {
                    const t = Wi(i, r);
            ...
            _updateChildren(t, e) {
                ...
                if (!n)return;
                const o = e.inlineFillerPosition, i = this.domConverter.mapViewToDom(t).childNodes, r = Array.from(this.domConverter.viewChildrenToDom(t, n.ownerDocument, {
                    bind: !0,
                    inlineFillerPosition: o
                }));
                o && o.parent === t && Qi(n.ownerDocument, r, o.offset);
                const s = this._diffNodeLists(i, r);
                let a = 0;
                const c = new Set;
                for (const t of s)"insert" === t ? (Ui(n, a, r[a]), a++) : "delete" === t ? (c.add(i[a]), Hi(i[a])) : (this._markDescendantTextToSync(this.domConverter.domToView(r[a])), a++);
                for (const t of c)t.parentNode || this.domConverter.unbindDomElement(t)
            }

            _diffNodeLists(t, e) {
                return Bi(t, e, function (t, e, n) {
                    if (e === n)return !0;
                    if (Ei(e) && Ei(n))return e.data === n.data;
                    if (Fi(e, t) && Fi(n, t))return !0;
                    return !1
            ...
            _findReplaceActions(t, e, n) {
                ...
                for (const a of t)"insert" === a ? r.push(n[s.equal + s.insert]) : "delete" === a ? i.push(e[s.equal + s.delete]) : ((o = o.concat(Bi(i, r, Ji).map(t=>"equal" === t ? "replace" : t))).push("equal"), i = [], r = []), s[a]++;
                return o.concat(Bi(i, r, Ji).map(t=>"equal" === t ? "replace" : t))
            }
            ...
            _updateFakeSelection(t) {
                ...
                n || (this._fakeSelectionContainer = n = e.createElement("div"), Object.assign(n.style, {
                    ...
                    left: "-9999px",
                    width: "42px"
                }), n.appendChild(e.createTextNode(" "))), n.parentElement || t.appendChild(n), n.firstChild.data = this.selection.fakeSelectionLabel || " ";
            ...
            _updateDomSelection(t) {
                ...
                const n = this.domConverter.viewPositionToDom(this.selection.anchor), o = this.domConverter.viewPositionToDom(this.selection.focus);
        ...
        function Qi(t, e, n) {
            ...
            if (Ei(i))return i.data = Ri + i.data, i;
            {
                const i = t.createTextNode(Ri);
                return Array.isArray(e) ? o.splice(n, 0, i) : Ui(e, n, i), i
            }
        }

        function Ji(t, e) {
            return qi(t) && qi(e) && !Ei(t) && !Ei(e) && t.tagName.toLowerCase() === e.tagName.toLowerCase()
        }

        B($i, jo);
        var Ki = {window: window, document: document};
        ...
        class er {
            constructor(t = {}) {
                this.blockFiller = t.blockFiller || Ii, this.preElements = ["pre"], this.blockElements = ["p", "div", "h1", "h2", "h3", "h4", "h5", "h6"], this._domToViewMapping = new WeakMap, this._viewToDomMapping = new WeakMap, this._fakeSelectionMapping = new WeakMap
            }

            bindFakeSelection(t, e) {
                this._fakeSelectionMapping.set(t, new Zo(e))
            }
            ...
            *viewChildrenToDom(t, e, n = {}) {
            ...
            viewRangeToDom(t) {
                const e = this.viewPositionToDom(t.start), n = this.viewPositionToDom(t.end), o = document.createRange();
            ...
            viewPositionToDom(t) {
                ...
                if (e.is("text")) {
                    ...
                    if (!n)return null;
                    let o = t.offset;
                    return Di(n) && (o += Oi), {parent: n, offset: o}
                }
                {
                    let n, o, i;
                    if (0 === t.offset) {
                    ...
                    if (Ei(i) && Di(i))return {parent: i, offset: Oi};
                    return {parent: n, offset: o ? Zi(o) + 1 : 0}
                }
            }

            domToView(t, e = {}) {
                if (Fi(t, this.blockFiller))return null;
                ...
                if (this.isComment(t))return null;
                {
                    ...
                    let n;
                    if (this.isDocumentFragment(t))n = new _i, e.bind && this.bindDocumentFragments(t, n); else {
                        const o = e.keepOriginalCase ? t.tagName : t.tagName.toLowerCase();
                        n = new po(o), e.bind && this.bindElements(t, n);
            ...
            *domChildrenToView(t, e = {}) {
            ...
            domSelectionToView(t) {
                ...
                return new Zo(n, {backward: e})
            }

            domRangeToView(t) {
                const e = this.domPositionToView(t.startContainer, t.startOffset), n = this.domPositionToView(t.endContainer, t.endOffset);
                return e && n ? new Qo(e, n) : null
            }

            domPositionToView(t, e) {
                if (Fi(t, this.blockFiller))return this.domPositionToView(t.parentNode, Zi(t));
                const n = this.mapDomToView(t);
                if (n && n.is("uiElement"))return $o.createBefore(n);
                if (Ei(t)) {
                    if (Li(t))return this.domPositionToView(t.parentNode, Zi(t));
                    const n = this.findCorrespondingViewText(t);
                    let o = e;
                    return n ? (Di(t) && (o = (o -= Oi) < 0 ? 0 : o), new $o(n, o)) : null
                }
                if (0 === e) {
                    const e = this.mapDomToView(t);
                    if (e)return new $o(e, 0)
                } else {
                    const n = t.childNodes[e - 1], o = Ei(n) ? this.findCorrespondingViewText(n) : this.mapDomToView(n);
                    if (o && o.parent)return new $o(o.parent, o.index + 1)
                }
                return null
            }
            ...
            findCorrespondingViewText(t) {
                ...
                if (n) {
                    ...
                    if (t) {
                        return t.nextSibling instanceof co ? t.nextSibling : null
                    }
                } else {
                    const e = this.mapDomToView(t.parentNode);
                    if (e) {
                        const t = e.getChild(0);
                        return t instanceof co ? t : null
                    }
                }
                return null
            }
            ...
            focus(t) {
                ...
                if (e && e.ownerDocument.activeElement !== e) {
                    const {scrollX:t, scrollY:n}=Ki.window, o = [];
                    or(e, t=> {
            ...
            _isDomSelectionPositionCorrect(t, e) {
                if (Ei(t) && Di(t) && e < Oi)return !1;
                if (this.isElement(t) && Di(t.childNodes[e]))return !1;
                const n = this.mapDomToView(t);
            ...
            _processDataFromDomText(t) {
                let e = t.data;
                if (nr(t, this.preElements))return ji(t);
                e = e.replace(/[ \n\t\r]{1,}/g, " ");
                const n = this._getTouchingInlineDomNode(t, !1), o = this._getTouchingInlineDomNode(t, !0), i = this._checkShouldLeftTrimDomText(n), r = this._checkShouldRightTrimDomText(t, o);
                return i && (e = e.replace(/^ /, "")), r && (e = e.replace(/ $/, "")), e = (e = ji(new Text(e))).replace(/ \u00A0/g, "  "), i && (e = e.replace(/^\u00A0/, " ")), Ei(o) && " " != o.data.charAt(0) || (e = e.replace(/\u00A0( *)$/, " $1")), e
            }

            _checkShouldLeftTrimDomText(t) {
                return !t || (!!tr(t) || /[^\S\u00A0]/.test(t.data.charAt(t.data.length - 1)))
            }
            ...
            _getTouchingViewTextNode(t, e) {
                const n = new Go({
                    startPosition: e ? $o.createAfter(t) : $o.createBefore(t),
            ...
            _getTouchingInlineDomNode(t, e) {
                ...
                const n = e ? "nextNode" : "previousNode", o = t.ownerDocument, i = Xi(t)[0], r = o.createTreeWalker(i, NodeFilter.SHOW_TEXT | NodeFilter.SHOW_ELEMENT, {acceptNode: t=>Ei(t) ? NodeFilter.FILTER_ACCEPT : "BR" == t.tagName ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP});
                r.currentNode = t;
                const s = r[n]();
                if (null !== s) {
        ...
        function or(t, e) {
            for (; t && t != Ki.document;)e(t), t = t.parentNode
        }
        ...
        var rr = No({}, R, {
            listenTo(t, ...e){
                if (qi(t) || ir(t)) {
                    const n = this._getProxyEmitter(t) || new sr(t);
                    n.attach(...e), t = n
                }
                R.listenTo.call(this, t, ...e)
            }, stopListening(t, e, n){
                if (qi(t) || ir(t)) {
                ...
                R.stopListening.call(this, t, e, n), t instanceof sr && t.detach(e)
            }, _getProxyEmitter(t){
                return function (t, e) {
                    return t[N] && t[N][e] ? t[N][e].emitter : null
                }(this, ar(t))
            }
        });
        class sr {
            constructor(t) {
                D(this, ar(t)), this._domNode = t
            }
        }
        function ar(t) {
        ...
        hr.prototype.add = hr.prototype.push = dr, hr.prototype.has = ur;
        var fr = hr;
        var mr = function (t, e) {
        ...
        var wr = function (t, e, n, o, i, r) {
            var s = n & gr, a = t.length, c = e.length;
            if (a != c && !(s && c > a))return !1;
            var l = r.get(t);
            if (l && r.get(e))return l == e;
            var d = -1, u = !0, h = n & br ? new fr : void 0;
            for (r.set(t, e), r.set(e, t); ++d < a;) {
                ...
                if (h) {
                    if (!mr(e, function (t, e) {
                            if (!pr(h, e) && (f === t || i(f, t, n, o, r)))return h.push(e)
                        })) {
                        u = !1;
                        break
                    }
        ...
        }, vr = 1, yr = 2, xr = "[object Boolean]", Ar = "[object Date]", Cr = "[object Error]", Tr = "[object Map]", Mr = "[object Number]", Pr = "[object RegExp]", Sr = "[object Set]", Er = "[object String]", Ir = "[object Symbol]", Nr = "[object ArrayBuffer]", Or = "[object DataView]", Rr = i ? i.prototype : void 0, Dr = Rr ? Rr.valueOf : void 0;
        var Lr = function (t, e, n, o, i, r, s) {
            switch (n) {
                case Or:
                ...
                case Sr:
                    ...
                    if (l)return l == e;
                    o |= yr, s.set(t, e);
                    var d = wr(a(t), a(e), o, i, r, s);
                    return s.delete(t), d;
                case Ir:
                    if (Dr)return Dr.call(t) == Dr.call(e)
            }
            return !1
        }, jr = 1, Vr = Object.prototype.hasOwnProperty;
        var Fr = function (t, e, n, o, i, r) {
            var s = n & jr, a = $e(t), c = a.length;
            if (c != $e(e).length && !s)return !1;
            for (var l = c; l--;) {
                var d = a[l];
                if (!(s ? d in e : Vr.call(e, d)))return !1
            }
            var u = r.get(t);
        ...
        }, zr = 1, Br = "[object Arguments]", Ur = "[object Array]", Hr = "[object Object]", qr = Object.prototype.hasOwnProperty;
        var Wr = function (t, e, n, o, i, r) {
            var s = ce(t), a = ce(e), c = s ? Ur : an(t), l = a ? Ur : an(e), d = (c = c == Br ? Hr : c) == Hr, u = (l = l == Br ? Hr : l) == Hr, h = c == l;
            if (h && Object(le.a)(t)) {
                if (!Object(le.a)(e))return !1;
                s = !0, d = !1
            }
            if (h && !d)return r || (r = new $t), s || ke(t) ? wr(t, e, n, o, i, r) : Lr(t, e, c, n, o, i, r);
            if (!(n & zr)) {
                var f = d && qr.call(t, "__wrapped__"), m = u && qr.call(e, "__wrapped__");
                if (f || m) {
                    var p = f ? t.value() : t, g = m ? e.value() : e;
                    return r || (r = new $t), i(p, g, n, o, r)
                }
            }
            return !!h && (r || (r = new $t), Fr(t, e, n, o, i, r))
        };
        var Yr = function t(e, n, o, i, r) {
            return e === n || (null == e || null == n || !w(e) && !w(n) ? e != e && n != n : Wr(e, n, o, i, t, r))
        };
        var Gr = function (t, e, n) {
            var o = (n = "function" == typeof n ? n : void 0) ? n(t, e) : void 0;
            return void 0 === o ? Yr(t, e, void 0, n) : !!o
        };
        class $r extends cr {
            constructor(t) {
            ...
            _onMutations(t) {
                ...
                for (const i of t) {
                    ...
                    if ((!t || !t.is("uiElement")) && "characterData" === i.type) {
                        ...
                        t && !o.has(t.parent) ? n.set(t, {
                            ...
                            newText: ji(i.target),
                            node: t
                        }) : !t && Di(i.target) && o.add(e.mapDomToView(i.target.parentNode))
                    }
                }
                const i = [];
                for (const t of n.values())this.renderer.markToSync("text", t.node), i.push(t);
                for (const t of o) {
                    const n = e.mapViewToDom(t), o = Array.from(t.getChildren()), r = Array.from(e.domChildrenToView(n, {withChildren: !1}));
                    Gr(o, r, a) || (this.renderer.markToSync("children", t), i.push({
                        type: "children",
                        oldChildren: o,
                        newChildren: r,
                        node: t
                ...
                let s = null;
                if (r && r.anchorNode) {
                    const t = e.domPositionToView(r.anchorNode, r.anchorOffset), n = e.domPositionToView(r.focusNode, r.focusOffset);
                    t && n && (s = new Zo(t)).setFocus(n)
                }
                function a(t, e) {
        ...
        class Qr {
            constructor(t, e, n) {
                this.view = t, this.document = t.document, this.domEvent = e, this.domTarget = e.target, No(this, n)
            }
        ...
        class Jr extends cr {
            ...
            fire(t, e, n) {
                this.isEnabled && this.document.fire(t, new Qr(this.view, e, n))
            }
        }
        class Kr extends Jr {
            constructor(t) {
        ...
        var ts = function (t) {
            return "symbol" == typeof t || w(t) && p(t) == Xr
        }, es = NaN, ns = /^\s+|\s+$/g, os = /^[-+]0x[0-9a-f]+$/i, is = /^0b[01]+$/i, rs = /^0o[0-7]+$/i, ss = parseInt;
        var as = function (t) {
            ...
            t = t.replace(ns, "");
            var n = is.test(t);
            return n || rs.test(t) ? ss(t.slice(2), n ? 2 : 8) : os.test(t) ? es : +t
        }, cs = "Expected a function", ls = Math.max, ds = Math.min;
        var us = function (t, e, n) {
            var o, i, r, s, a, c, l = 0, d = !1, u = !1, h = !0;
            if ("function" != typeof t)throw new TypeError(cs);
            function f(e) {
                var n = o, r = i;
            ...
            return e = as(e) || 0, ot(n) && (d = !!n.leading, r = (u = "maxWait" in n) ? ls(as(n.maxWait) || 0, e) : r, h = "trailing" in n ? !!n.trailing : h), b.cancel = function () {
                void 0 !== a && clearTimeout(a), l = 0, o = c = i = a = void 0
            }, b.flush = function () {
                return void 0 === a ? s : g(Zr())
            }, b
        };
        class hs extends cr {
            constructor(t) {
                super(t), this._fireSelectionChangeDoneDebounced = us(t=>this.document.fire("selectionChangeDone", t), 200)
            }
            ...
            observe() {
                ...
                t.on("keydown", (e, n)=> {
                    t.selection.isFake && function (t) {
                        return t == hi.arrowright || t == hi.arrowleft || t == hi.arrowup || t == hi.arrowdown
            ...
            _handleSelectionMove(t) {
                const e = this.document.selection, n = new Zo(e.getRanges(), {backward: e.isBackward, fake: !1});
                t != hi.arrowleft && t != hi.arrowup || n.setTo(n.getFirstPosition()), t != hi.arrowright && t != hi.arrowdown || n.setTo(n.getLastPosition());
        ...
        class ms extends cr {
            constructor(t) {
                super(t), this.mutationObserver = t.getObserver($r), this.selection = this.document.selection, this.domConverter = t.domConverter, this._documents = new WeakSet, this._fireSelectionChangeDoneDebounced = us(t=>this.document.fire("selectionChangeDone", t), 200), this._clearInfiniteLoopInterval = setInterval(()=>this._clearInfiniteLoop(), 1e3), this._loopbackCounter = 0
            }
            ...
            _handleSelectionChange(t) {
                ...
                if (!this.selection.isEqual(n) || !this.domConverter.isDomSelectionCorrect(e))if (++this._loopbackCounter > 60)fs.a.warn("selectionchange-infinite-loop: Selection change observer detected an infinite rendering loop."); else if (this.selection.isSimilar(n))this.view.render(); else {
        ...
        const _s = ["top", "right", "bottom", "left", "width", "height"];
        class ks {
            constructor(t) {
                const e = bs(t);
                if (Object.defineProperty(this, "_source", {
                    ...
                    n.ownerDocument && n.ownerDocument.body.contains(n) || fs.a.warn("rect-source-not-in-dom: The source of this rect does not belong to any rendered DOM tree.", {source: t}), vs(this, e ? ks.getDomRangeRects(t)[0] : t.getBoundingClientRect())
                } else if (ir(t)) {
                    const {innerWidth:e, innerHeight:n}=t;
                    vs(this, {top: 0, right: e, bottom: n, left: 0, width: e, height: n})
                } else vs(this, t)
            }
            ...
            getIntersection(t) {
                ...
                return e.width = e.right - e.left, e.height = e.bottom - e.top, e.width < 0 || e.height < 0 ? null : new ks(e)
            }
            ...
            getVisible() {
                ...
                if (!ys(t)) {
                    ...
                    for (; n && !ys(n);) {
                        const t = new ks(n), o = e.getIntersection(t);
                        if (!o)return null;
            ...
            isEqual(t) {
                for (const e of _s)if (this[e] !== t[e])return !1;
                return !0
            }
            ...
            excludeScrollbarsAndBorders() {
                const t = this._source;
                let e, n;
                if (ir(t))e = t.innerWidth - t.document.documentElement.clientWidth, n = t.innerHeight - t.document.documentElement.clientHeight; else {
                    const o = ws(this._source);
            ...
            static getDomRangeRects(t) {
                ...
                if (n.length)for (const t of n)e.push(new ks(t)); else {
                    let n = t.startContainer;
                    Ei(n) && (n = n.parentNode);
                    const o = new ks(n.getBoundingClientRect());
        ...
        function vs(t, e) {
            for (const n of _s)t[n] = e[n]
        }

        function ys(t) {
            return !!tr(t) && t === t.ownerDocument.body
        }

        function xs({target:t, viewportOffset:e = 0}) {
            const n = Es(t);
            let o = n, i = null;
            for (; o;) {
                let r;
                Cs(r = Is(o == n ? t : i), ()=>Ns(t, o));
                const s = Ns(t, o);
                if (As(o, s, e), o.parent != o) {
        ...
        function As(t, e, n) {
            const o = e.clone().moveBy(0, n), i = e.clone().moveBy(0, -n), r = new ks(t).excludeScrollbarsAndBorders();
            if (![i, o].every(t=>r.contains(t))) {
                let {scrollX:s, scrollY:a}=t;
                Ms(i, r) ? a -= r.top - e.top + n : Ts(o, r) && (a += e.bottom - r.bottom + n), Ps(e, r) ? s -= r.left - e.left + n : Ss(e, r) && (s += e.right - r.right + n), t.scrollTo(s, a)
            }
        }
        ...
        function Cs(t, e) {
            const n = Es(t);
            let o, i;
            for (; t != n.document.body;)i = e(), (o = new ks(t).excludeScrollbarsAndBorders()).contains(i) || (Ms(i, o) ? t.scrollTop -= o.top - i.top : Ts(i, o) && (t.scrollTop += i.bottom - o.bottom), Ps(i, o) ? t.scrollLeft -= o.left - i.left : Ss(i, o) && (t.scrollLeft += i.right - o.right)), t = t.parentNode
        }
        ...
        function Is(t) {
            if (bs(t)) {
                ...
                return Ei(e) && (e = e.parentNode), e
            }
            return t.parentNode
        }

        function Ns(t, e) {
            const n = Es(t), o = new ks(t);
            if (n === e)return o;
            {
                let t = n;
                for (; t != e;) {
                    const e = t.frameElement, n = new ks(e).excludeScrollbarsAndBorders();
        ...
        class Os {
            ...
            scrollToTheSelection() {
                ...
                t && xs({target: this.domConverter.viewRangeToDom(t), viewportOffset: 20})
            }

            focus() {
                if (!this.document.isFocused) {
                    const t = this.document.selection.editableElement;
                    t ? (this.domConverter.focus(t), this.render()) : fs.a.warn("view-focus-no-selection: There is no selection in any editable to focus.")
                }
            }
            ...
            change(t) {
                ...
                this._ongoingChange ? t(this._writer) : (this._ongoingChange = !0, t(this._writer), this._ongoingChange = !1, this._renderingDisabled || (this._postFixersInProgress = !0, this.document._callPostFixers(this._writer), this._postFixersInProgress = !1, this.fire("render")))
            }
        ...
        function Rs(t) {
            return C(t) ? uo(t) : new Map(t)
        }

        B(Os, jo);
        class Ds {
            constructor(t) {
                this.parent = null, this._attrs = Rs(t)
            }
        ...
        class Ls extends Ds {
            ...
            _clone() {
                return new Ls(this.data, this.getAttributes())
            }

            static fromJSON(t) {
                return new Ls(t.data, t.attributes)
            }
        }
        class js {
            constructor(t, e, n) {
        ...
        class Vs {
            ...
            _insertNodes(t, e) {
                for (const t of e)if (!(t instanceof Ds))throw new M.b("model-nodelist-insertNodes-not-node: Trying to insert an object which is not a Node instance.");
        ...
        class Fs extends Ds {
            constructor(t, e, n) {
                super(e), this.name = t, this._children = new Vs, n && this._insertChild(0, n)
            }
            ...
            _clone(t = !1) {
                ...
                return new Fs(this.name, this.getAttributes(), e)
            }
            ...
            _insertChild(t, e) {
                const n = function (t) {
                    if ("string" == typeof t)return [new Ls(t)];
                    ho(t) || (t = [t]);
                    return Array.from(t).map(t=>"string" == typeof t ? new Ls(t) : t instanceof js ? new Ls(t.data, t.getAttributes()) : t)
                }(e);
            ...
            static fromJSON(t) {
                ...
                if (t.children) {
                    e = [];
                    for (const n of t.children)n.name ? e.push(Fs.fromJSON(n)) : e.push(Ls.fromJSON(n))
                }
                return new Fs(t.name, t.attributes, e)
            }
        }
        class zs {
            constructor(t = {}) {
            ...
            _next() {
                const t = this.position, e = Hs.createFromPosition(this.position), n = this._visitedParent;
                ...
                if (o instanceof Fs)return this.shallow ? e.offset++ : (e.path.push(0), this._visitedParent = o), this.position = e, Bs("elementStart", o, t, e, 1);
                if (o instanceof Ls) {
                    let i;
                    ...
                    const r = e.offset - o.startOffset, s = new js(o, r, i);
            ...
            _previous() {
                ...
                if (o instanceof Fs)return e.offset--, this.shallow ? (this.position = e, Bs("elementStart", o, t, e, 1)) : (e.path.push(o.maxOffset), this.position = e, this._visitedParent = o, this.ignoreElementEnd ? this._previous() : Bs("elementEnd", o, t, e));
                if (o instanceof Ls) {
                    let i;
                    if (this.singleCharacters)i = 1; else {
                        let t = o.startOffset;
                    ...
                    const r = e.offset - o.startOffset, s = new js(o, r - i, i);
                    return e.offset -= i, this.position = e, Bs("text", s, t, e, i)
                }
        ...
        class Hs {
            ...
            get textNode() {
                ...
                return t instanceof Ls && t.startOffset < this.offset ? t : null
            }
            ...
            getCommonPath(t) {
                ...
                const e = U(this.path, t.path), n = "string" == typeof e ? Math.min(this.path.length, t.path.length) : e;
            ...
            getShiftedBy(t) {
                const e = Hs.createFromPosition(this), n = e.offset + t;
                return e.offset = n < 0 ? 0 : n, e
            }
            ...
            isTouching(t) {
                ...
                switch (this.compareWith(t)) {
                    case"same":
                        return !0;
                    case"before":
                        e = Hs.createFromPosition(this), n = Hs.createFromPosition(t);
                        break;
                    case"after":
                        e = Hs.createFromPosition(t), n = Hs.createFromPosition(this);
                        break;
                    default:
                        return !1
                }
            ...
            hasSameParentAs(t) {
                if (this.root !== t.root)return !1;
                return "same" == U(this.getParentPath(), t.getParentPath())
            }
            ...
            _getTransformedByMergeOperation(t) {
                const e = t.movedRange;
                let n;
                return e.containsPosition(this) || e.start.isEqual(this) ? (n = this._getCombined(t.sourcePosition, t.targetPosition), t.sourcePosition.isBefore(t.targetPosition) && (n = n._getTransformedByDeletion(t.deletionPosition, 1))) : n = this.isEqual(t.deletionPosition) ? Hs.createFromPosition(t.deletionPosition) : this._getTransformedByMove(t.deletionPosition, t.graveyardPosition, 1), n
            }

            _getTransformedByDeletion(t, e) {
                const n = Hs.createFromPosition(this);
                if (this.root != t.root)return n;
                if ("same" == U(t.getParentPath(), this.getParentPath())) {
                    if (t.offset < this.offset) {
                        if (t.offset + e > this.offset)return null;
                        n.offset -= e
                    }
                } else if ("prefix" == U(t.getParentPath(), this.getParentPath())) {
            ...
            _getTransformedByInsertion(t, e) {
                const n = Hs.createFromPosition(this);
                if (this.root != t.root)return n;
                if ("same" == U(t.getParentPath(), this.getParentPath()))(t.offset < this.offset || t.offset == this.offset && "toPrevious" != this.stickiness) && (n.offset += e); else if ("prefix" == U(t.getParentPath(), this.getParentPath())) {
                    const o = t.path.length - 1;
            ...
            _getTransformedByMove(t, e, n) {
                if (e = e._getTransformedByDeletion(t, n), t.isEqual(e))return Hs.createFromPosition(this);
            ...
            _getCombined(t, e) {
                const n = t.path.length - 1, o = Hs.createFromPosition(e);
            ...
            static createAt(t, e) {
                if (t instanceof Hs)return this.createFromPosition(t);
                {
                    const n = t;
            ...
            static createFromPosition(t) {
                const e = new this(t.root, t.path.slice());
                return e.stickiness = t.stickiness, e
            }

            static fromJSON(t, e) {
                if ("$graveyard" === t.root) {
                    const n = new Hs(e.graveyard, t.path);
                ...
                const n = new Hs(e.getRoot(t.root), t.path);
                return n.stickiness = t.stickiness, n
            }
        }
        class qs {
            constructor(t, e = null) {
                this.start = Hs.createFromPosition(t), this.end = e ? Hs.createFromPosition(e) : Hs.createFromPosition(t), this.start.stickiness = this.isCollapsed ? "toNone" : "toNext", this.end.stickiness = this.isCollapsed ? "toNone" : "toPrevious"
            }

            *[Symbol.iterator]() {
                yield*new zs({boundaries: this, ignoreElementEnd: !0})
            }
            ...
            get isFlat() {
                return "same" == U(this.start.getParentPath(), this.end.getParentPath())
            }
            ...
            getDifference(t) {
                const e = [];
                return this.isIntersecting(t) ? (this.containsPosition(t.start) && e.push(new qs(this.start, t.start)), this.containsPosition(t.end) && e.push(new qs(t.end, this.end))) : e.push(qs.createFromRange(this)), e
            }

            getIntersection(t) {
                if (this.isIntersecting(t)) {
                    let e = this.start, n = this.end;
                    return this.containsPosition(t.start) && (e = t.start), this.containsPosition(t.end) && (n = t.end), new qs(e, n)
                }
                return null
            }

            getMinimalFlatRanges() {
                const t = [], e = this.start.getCommonPath(this.end).length, n = Hs.createFromPosition(this.start);
                let o = n.parent;
                for (; n.path.length > e + 1;) {
                    const e = o.maxOffset - n.offset;
                    0 !== e && t.push(new qs(n, n.getShiftedBy(e))), n.path = n.path.slice(0, -1), n.offset++, o = o.parent
                }
                for (; n.path.length <= this.end.path.length;) {
                    const e = this.end.path[n.path.length - 1], o = e - n.offset;
                    0 !== o && t.push(new qs(n, n.getShiftedBy(o))), n.offset = e, n.path.push(0)
                }
                return t
            }

            getWalker(t = {}) {
                return t.boundaries = this, new zs(t)
            }
            ...
            *getPositions(t = {}) {
            ...
            getTransformedByOperation(t) {
                ...
                return [qs.createFromRange(this)]
            }

            getTransformedByOperations(t) {
                const e = [qs.createFromRange(this)];
            ...
            _getTransformedByMoveOperation(t, e = !1) {
                const n = t.sourcePosition, o = t.howMany, i = t.targetPosition;
            ...
            _getTransformedBySplitOperation(t) {
                ...
                let n;
                return n = this.end.isEqual(t.insertionPosition) ? this.end.getShiftedBy(1) : this.end._getTransformedBySplitOperation(t), new qs(e, n)
            }

            _getTransformedByMergeOperation(t) {
                let e = this.start._getTransformedByMergeOperation(t), n = this.end._getTransformedByMergeOperation(t);
                return e.root != n.root && (n = this.end.getShiftedBy(-1)), e.isAfter(n) ? (t.sourcePosition.isBefore(t.targetPosition) ? (e = Hs.createFromPosition(n)).offset = 0 : (t.deletionPosition.isEqual(e) || (n = t.deletionPosition), e = t.targetPosition), new qs(e, n)) : new qs(e, n)
            }
            ...
            _getTransformedByInsertion(t, e, n = !1) {
                ...
                {
                    const n = qs.createFromRange(this);
            ...
            _getTransformedByMove(t, e, n, o = !1) {
                ...
                const i = qs.createFromPositionAndShift(t, n), r = e._getTransformedByDeletion(t, n);
                if (this.containsPosition(e) && !o && (i.containsPosition(this.start) || i.containsPosition(this.end))) {
                    const o = this.start._getTransformedByMove(t, e, n), i = this.end._getTransformedByMove(t, e, n);
                    return [new qs(o, i)]
                }
                let s;
                ...
                if (1 == a.length ? c = new qs(a[0].start._getTransformedByDeletion(t, n), a[0].end._getTransformedByDeletion(t, n)) : 2 == a.length && (c = new qs(this.start, this.end._getTransformedByDeletion(t, n))), s = c ? c._getTransformedByInsertion(r, n, null !== l || o) : [], l) {
                    const t = new qs(l.start._getCombined(i.start, r), l.end._getCombined(i.start, r));
            ...
            _getTransformedByDeletion(t, e) {
                let n = this.start._getTransformedByDeletion(t, e), o = this.end._getTransformedByDeletion(t, e);
                return null == n && null == o ? null : (null == n && (n = t), null == o && (o = t), new qs(n, o))
            }
            ...
            static createFromParentsAndOffsets(t, e, n, o) {
                return new this(Hs.createFromParentAndOffset(t, e), Hs.createFromParentAndOffset(n, o))
            }
            ...
            static createOn(t) {
                return this.createFromPositionAndShift(Hs.createBefore(t), t.offsetSize)
            }

            static createCollapsedAt(t, e) {
                const n = Hs.createAt(t, e), o = Hs.createFromPosition(n);
                return new qs(n, o)
            }
            ...
            static createFromRanges(t) {
                ...
                if (n > 0)for (let e = n - 1; t[e].end.isEqual(o.start); e++)o.start = Hs.createFromPosition(t[e].start);
                for (let e = n + 1; e < t.length && t[e].start.isEqual(o.end); e++)o.end = Hs.createFromPosition(t[e].end);
                return o
            }

            static fromJSON(t, e) {
                return new this(Hs.fromJSON(t.start, e), Hs.fromJSON(t.end, e))
            }
        }
        class Ws {
            constructor() {
                this._modelToViewMapping = new WeakMap, this._viewToModelMapping = new WeakMap, this._viewToModelLengthCallbacks = new Map, this._markerNameToElements = new Map, this.on("modelToViewPosition", (t, e)=> {
                    ...
                    e.modelPosition = Hs.createFromParentAndOffset(o, i)
                }, {priority: "low"})
            }
            ...
            toViewRange(t) {
                return new Qo(this.toViewPosition(t.start), this.toViewPosition(t.end))
            }
            ...
            _findPositionIn(t, e) {
                let n, o = 0, i = 0, r = 0;
                if (t.is("text"))return new $o(t, e);
                for (; i < e;)n = t.getChild(r), i += o = this.getModelLength(n), r++;
                return i == e ? this._moveViewPositionToTextNode(new $o(t, r)) : this._findPositionIn(n, e - (i - o))
            }

            _moveViewPositionToTextNode(t) {
                const e = t.nodeBefore, n = t.nodeAfter;
                return e instanceof co ? new $o(e, e.data.length) : n instanceof co ? new $o(n, 0) : t
            }
        }
        B(Ws, R);
        class Ys {
            ...
            add(t, e) {
                e = Gs(e), t instanceof js && (t = this._getSymbolForTextProxy(t)), this._consumable.has(t) || this._consumable.set(t, new Map), this._consumable.get(t).set(e, !0)
            }

            consume(t, e) {
                return e = Gs(e), t instanceof js && (t = this._getSymbolForTextProxy(t)), !!this.test(t, e) && (this._consumable.get(t).set(e, !1), !0)
            }

            test(t, e) {
                e = Gs(e), t instanceof js && (t = this._getSymbolForTextProxy(t));
        ...
        class $s {
            constructor(t = {}) {
                this.conversionApi = No({dispatcher: this}, t)
            }

            convertChanges(t, e) {
                for (const n of t.getMarkersToRemove())this.convertMarkerRemove(n.name, n.range, e);
                for (const n of t.getChanges())"insert" == n.type ? this.convertInsert(qs.createFromPositionAndShift(n.position, n.length), e) : "remove" == n.type ? this.convertRemove(n.position, n.length, n.name, e) : this.convertAttribute(n.range, n.attributeKey, n.attributeOldValue, n.attributeNewValue, e);
            ...
            convertInsert(t, e) {
                ...
                for (const e of t) {
                    const t = e.item, n = {item: t, range: qs.createFromPositionAndShift(e.previousPosition, e.length)};
            ...
            convertAttribute(t, e, n, o, i) {
                ...
                for (const i of t) {
                    const t = {
                        item: i.item,
                        range: qs.createFromPositionAndShift(i.previousPosition, i.length),
                        attributeKey: e,
                        attributeOldValue: n,
                        attributeNewValue: o
                    };
            ...
            convertSelection(t, e, n) {
                ...
                if (this.conversionApi.writer = n, this.conversionApi.consumable = this._createSelectionConsumable(t, o), this.fire("selection", {selection: t}, this.conversionApi), t.isCollapsed) {
                    for (const e of o) {
                        const n = e.getRange();
                        if (!Qs(t.getFirstPosition(), e, this.conversionApi.mapper))continue;
            ...
            convertMarkerAdd(t, e, n) {
                ...
                for (const n of e.getItems()) {
                    ...
                    const i = {item: n, range: qs.createOn(n), markerName: t, markerRange: e};
        ...
        class Js {
            ...
            *getRanges() {
                for (const t of this._ranges)yield qs.createFromRange(t)
            }

            getFirstRange() {
                let t = null;
                for (const e of this._ranges)t && !e.start.isBefore(t.start) || (t = e);
                return t ? qs.createFromRange(t) : null
            }
            ...
            getFirstPosition() {
                const t = this.getFirstRange();
                return t ? Hs.createFromPosition(t.start) : null
            }

            getLastPosition() {
                const t = this.getLastRange();
                return t ? Hs.createFromPosition(t.end) : null
            }

            setTo(t, e, n) {
                if (null === t)this._setRanges([]); else if (t instanceof Js)this._setRanges(t.getRanges(), t.isBackward); else if (t && "function" == typeof t.getRanges)this._setRanges(t.getRanges(), t.isBackward); else if (t instanceof qs)this._setRanges([t], !!e && !!e.backward); else if (t instanceof Hs)this._setRanges([new qs(t)]); else if (t instanceof Ds) {
                    const o = !!n && !!n.backward;
                    let i;
                    if ("in" == e)i = qs.createIn(t); else if ("on" == e)i = qs.createOn(t); else {
                        ...
                        i = qs.createCollapsedAt(t, e)
                    }
                    this._setRanges([i], o)
                } else {
                    if (!ho(t))throw new M.b("model-selection-setTo-not-selectable: Cannot set selection to given place.");
            ...
            _setRanges(t, e = !1) {
                const n = (t = Array.from(t)).some(t=> {
                    if (!(t instanceof qs))throw new M.b("model-selection-set-ranges-not-range: Selection range set to an object that is not an instance of model.Range.");
            ...
            setFocus(t, e) {
                ...
                const n = Hs.createAt(t, e);
                if ("same" == n.compareWith(this.focus))return;
                const o = this.anchor;
                this._ranges.length && this._popRange(), "before" == n.compareWith(o) ? (this._pushRange(new qs(n, o)), this._lastRangeBackward = !0) : (this._pushRange(new qs(o, n)), this._lastRangeBackward = !1), this.fire("change:range", {directChange: !0})
            }
            ...
            getSelectedElement() {
                if (1 !== this.rangeCount)return null;
                const t = this.getFirstRange(), e = t.start.nodeAfter, n = t.end.nodeBefore;
                return e instanceof Fs && e == n ? e : null
            }

            *getSelectedBlocks() {
                const t = new WeakSet;
                for (const e of this.getRanges()) {
                    const n = Zs(e.start, t);
                    n && (yield n);
                    for (const n of e.getWalker())"elementEnd" == n.type && Ks(n.item, t) && (yield n.item);
                    const o = Zs(e.end, t);
                    o && !e.end.isTouching(Hs.createAt(o)) && (yield o)
                }
            }

            containsEntireContent(t = this.anchor.root) {
                const e = Hs.createAt(t), n = Hs.createAt(t, "end");
                return e.isTouching(this.getFirstPosition()) && n.isTouching(this.getLastPosition())
            }

            _pushRange(t) {
                this._checkRange(t), this._ranges.push(qs.createFromRange(t))
            }

            _checkRange(t) {
                for (let e = 0; e < this._ranges.length; e++)if (t.isIntersecting(this._ranges[e]))throw new M.b("model-selection-range-intersects: Trying to add a range that intersects with another range in the selection.", {
                    addedRange: t,
        ...
        function Zs(t, e) {
            const n = t.parent.getAncestors({parentFirst: !0, includeSelf: !0}), o = n.find(t=>Ks(t, e));
                ...
                super(t, e), function () {
                    this.listenTo(this.root.document.model, "applyOperation", (t, e)=> {
                        ...
                        n.isDocumentOperation && function (t) {
                            const e = this.getTransformedByOperation(t), n = qs.createFromRanges(e), o = !n.isEqual(this), i = function (t, e) {
                                switch (e.type) {
                                    case"insert":
                            ...
                            } else i && this.fire("change:content", qs.createFromRange(this), {deletionPosition: r})
                        }.call(this, n)
                    }, {priority: "low"})
                }.call(this)
            }
        ...
        class ea {
            constructor(t) {
                this._selection = new na(t), this._selection.delegate("change:range").to(this), this._selection.delegate("change:attribute").to(this)
            }
        ...
        class na extends Js {
                    ...
                    this._updateAttributes(!1), function (t, e) {
                        ...
                        for (const o of n.getChanges()) {
                            ...
                            i && t.enqueueChange(e, t=> {
                                const e = Array.from(n.getAttributeKeys()).filter(t=>t.startsWith(ta));
            ...
            *getRanges() {
            ...
            _prepareRange(t) {
                if (this._checkRange(t), t.root == this._document.graveyard)return void fs.a.warn("model-selection-range-in-graveyard: Trying to add a Range that is in the graveyard root. Range rejected.");
                const e = Xs.createFromRange(t);
            ...
            _updateAttributes(t) {
                const e = Rs(this._getSurroundingAttributes()), n = Rs(this.getAttributes());
            ...
            *_getStoredAttributes() {
                ...
                if (this.isCollapsed && t.isEmpty)for (const e of t.getAttributeKeys())if (e.startsWith(ta)) {
                    yield[e.substr(ta.length), t.getAttribute(e)]
                }
            }
            ...
            _getSurroundingAttributes() {
                ...
                if (this.isCollapsed) {
                    ...
                    if (this.isGravityOverridden || (n = oa(e)), n || (n = oa(o)), !this.isGravityOverridden && !n) {
                        let t = e;
                        for (; t && !n;)n = oa(t = t.previousSibling)
                    }
                    if (!n) {
                        let t = o;
                        for (; t && !n;)n = oa(t = t.nextSibling)
                    }
            ...
            _fixGraveyardSelection(t, e) {
                const n = Hs.createFromPosition(e), o = this._model.schema.getNearestSelectionRange(n), i = this._ranges.indexOf(t);
        ...
        function oa(t) {
            return t instanceof js || t instanceof Ls ? t.getAttributes() : null
        }
        ...
        function aa(t) {
            return (t = sa(t)).view = da(t.view, "container"), e=> {
        ...
        function ca(t) {
            let e = "attribute:" + ((t = sa(t)).model.key ? t.model.key : t.model);
            if (t.model.name && (e += ":" + t.model.name), t.model.values)for (const e of t.model.values)t.view[e] = da(t.view[e], "attribute"); else t.view = da(t.view, "attribute");
            const n = ua(t);
            return o=> {
                o.on(e, function (t) {
                    return (e, n, o)=> {
                        ...
                        if (n.item instanceof Js || n.item instanceof ea)s.wrap(a.getFirstRange(), r); else {
        ...
        function la(t) {
            let e = "attribute:" + ((t = sa(t)).model.key ? t.model.key : t.model);
            if (t.model.name && (e += ":" + t.model.name), t.model.values)for (const e of t.model.values)t.view[e] = ha(t.view[e]); else t.view = ha(t.view);
            const n = ua(t);
            return o=> {
                o.on(e, function (t) {
        ...
        function da(t, e) {
            return "function" == typeof t ? t : (n, o)=>(function (t, e, n) {
                ...
                if ("container" == n)o = e.createContainerElement(t.name, i); else if ("attribute" == n) {
                    const n = {priority: t.priority || oi.DEFAULT_PRIORITY};
        ...
        class fa {
            constructor(t) {
                this.model = t, this.view = new Os, this.mapper = new Ws, this.downcastDispatcher = new $s({mapper: this.mapper});
                const e = this.model.document, n = e.selection, o = this.model.markers;
                this.listenTo(this.model, "_beforeChanges", ()=> {
                    this.view._renderingDisabled = !0
                }, {priority: "highest"}), this.listenTo(this.model, "_afterChanges", ()=> {
                    this.view._renderingDisabled = !1, this.view.render()
                    ...
                    return (n, o)=> {
                        const i = o.newSelection, r = new Js, s = [];
                    ...
                    const o = n.mapper.toViewPosition(e.position), i = e.position.getShiftedBy(e.length), r = n.mapper.toViewPosition(i, {isPhantom: !0}), s = new Qo(o, r), a = n.writer.remove(s.getTrimmed());
                    for (const t of Qo.createIn(a).getItems())n.mapper.unbindViewElement(t)
            ...
            *[Symbol.iterator]() {
            ...
            load(t, e = []) {
                ...
                if (c) {
                    ...
                    return fs.a.error(t, {plugins: c}), Promise.reject(new M.b(t, {plugins: c}))
                }
                ...
                function l(t) {
                    if (!a.includes(t) && !n.get(t) && !i.has(t))return function (t) {
                        ...
                        throw fs.a.error("plugincollection-load: It was not possible to load the plugin.", {plugin: t}), e
                    })
                }
            ...
            _add(t, e) {
                ...
                n && (this._plugins.has(n) ? fs.a.warn("plugincollection-plugin-name-conflict: Two plugins with the same name were loaded.", {
                    pluginName: n,
        ...
        class wa {
            ...
            add(t, e) {
                let n;
                t.is("text") || t.is("documentFragment") ? this._consumables.set(t, !0) : (this._consumables.has(t) ? n = this._consumables.get(t) : (n = new _a, this._consumables.set(t, n)), n.add(e))
            }
            ...
            static createFrom(t, e) {
                if (e || (e = new wa), t.is("text"))return e.add(t), e;
                t.is("element") && e.add(t, wa.consumablesFromElement(t)), t.is("documentFragment") && e.add(t);
                for (const n of t.getChildren())e = wa.createFrom(n, e);
                return e
            }
        }
        class _a {
            ...
            _add(t, e) {
                const n = ce(e) ? e : [e], o = this._consumables[t];
                for (const e of n) {
        ...
        class ka {
            constructor() {
                this._sourceDefinitions = {}, this.decorate("checkChild"), this.decorate("checkAttribute"), this.on("checkAttribute", (t, e)=> {
                    ...
                    e[0] = new va(e[0]), e[1] = this.getDefinition(e[1])
                }, {priority: "highest"})
            }
            ...
            checkMerge(t, e = null) {
                if (t instanceof Hs) {
                    const e = t.nodeBefore, n = t.nodeAfter;
                    if (!(e instanceof Fs))throw new M.b("schema-check-merge-no-element-before: The node before the merge position must be an element.");
                    if (!(n instanceof Fs))throw new M.b("schema-check-merge-no-element-after: The node after the merge position must be an element.");
            ...
            getLimitElement(t) {
                let e;
                if (t instanceof Hs)e = t.parent; else {
                    e = (t instanceof qs ? [t] : Array.from(t.getRanges())).reduce((t, e)=> {
            ...
            checkAttributeInSelection(t, e) {
                if (t.isCollapsed) {
                    const n = [...t.getFirstPosition().getAncestors(), new Ls("", t.getAttributes())];
            ...
            *_getValidRangesForRange(t, e) {
                let n = t.start, o = t.start;
                for (const i of t.getItems({shallow: !0}))i.is("element") && (yield*this._getValidRangesForRange(qs.createIn(i), e)), this.checkAttribute(i, e) || (n.isEqual(o) || (yield new qs(n, o)), n = Hs.createAfter(i)), o = Hs.createAfter(i);
                n.isEqual(o) || (yield new qs(n, o))
            }

            getNearestSelectionRange(t, e = "both") {
                if (this.checkChild(t, "$text"))return new qs(t);
                let n, o;
                "both" != e && "backward" != e || (n = new zs({
                    startPosition: t,
                    direction: "backward"
                })), "both" != e && "forward" != e || (o = new zs({startPosition: t}));
                for (const t of function*(t, e) {
                    ...
                    if (o.type == e && this.isObject(o.item))return qs.createOn(o.item);
                    if (this.checkChild(o.nextPosition, "$text"))return new qs(o.nextPosition)
                }
                return null
            }
            ...
            _compile() {
                ...
                for (const o of n)t[o] = ya(e[o], o);
                for (const e of n)xa(t, e);
                for (const e of n)Aa(t, e);
                for (const e of n)Ca(t, e), Ta(t, e);
                for (const e of n)Ma(t, e), Pa(t, e);
        ...
        class va {
            constructor(t) {
                ...
                "string" == typeof t ? t = [t] : Array.isArray(t) || (t = t.getAncestors({includeSelf: !0})), t[0] && "string" != typeof t[0] && t[0].is("documentFragment") && t.shift(), this._items = t.map(Ia)
            }
        ...
        function ya(t, e) {
            ...
            }(t, n), Sa(t, n, "allowIn"), Sa(t, n, "allowContentOf"), Sa(t, n, "allowWhere"), Sa(t, n, "allowAttributes"), Sa(t, n, "allowAttributesOf"), Sa(t, n, "inheritTypesFrom"), function (t, e) {
                for (const n of t) {
        ...
        class Na {
            ...
            convert(t, e, n = ["$root"]) {
                this.fire("viewCleanup", t), this._modelCursor = function (t, e) {
                    let n;
                    for (const o of new va(t)) {
                        const t = {};
                        for (const e of o.getAttributeKeys())t[e] = o.getAttribute(e);
                        const i = e.createElement(o.name, t);
                        n && e.append(i, n), n = Hs.createAt(i)
                    }
                    return n
                }(n, e), this.conversionApi.writer = e, this.conversionApi.consumable = wa.createFrom(t), this.conversionApi.store = {};
                ...
                if (o) {
                    ...
                    i.markers = function (t, e) {
                        const n = new Set, o = new Map, i = qs.createIn(t).getItems();
                        for (const t of i)"$marker" == t.name && n.add(t);
                        for (const t of n) {
                            const n = t.getAttribute("data-name"), i = Hs.createBefore(t);
                            o.has(n) ? o.get(n).end = Hs.createFromPosition(i) : o.set(n, new qs(Hs.createFromPosition(i))), e.remove(t)
                        }
                        return o
                    }(i, e)
                }
            ...
            _convertItem(t, e) {
                ...
                if (t.is("element") ? this.fire("element:" + t.name, n, this.conversionApi) : t.is("text") ? this.fire("text", n, this.conversionApi) : this.fire("documentFragment", n, this.conversionApi), n.modelRange && !(n.modelRange instanceof qs))throw new M.b("view-conversion-dispatcher-incorrect-result: Incorrect conversion result was dropped.");
            ...
            _convertChildren(t, e) {
                ...
                for (const e of Array.from(t.getChildren())) {
                    ...
                    t.modelRange instanceof qs && (n.end = t.modelRange.end, o = t.modelCursor)
                }
        ...
        function Oa(t) {
            const e = function (t) {
                ...
                return (n, o, i)=> {
                    ...
                    const c = i.convertChildren(o.viewItem, Hs.createAt(s));
                    i.consumable.consume(o.viewItem, r.match), o.modelRange = new qs(Hs.createBefore(s), Hs.createAfter(c.modelCursor.parent)), a.cursorParent ? o.modelCursor = Hs.createAt(a.cursorParent) : o.modelCursor = o.modelRange.end
                }
            }(t = sa(t)), n = La(t), o = n ? "element:" + n : "element";
            return n=> {
        ...
        function Ra(t) {
            ja(t = sa(t));
            const e = Va(t, !1), n = La(t), o = n ? "element:" + n : "element";
            return n=> {
                n.on(o, e, {priority: t.converterPriority || "normal"})
            }
        }
        ...
        function Da(t) {
            let e = null;
            ("string" == typeof(t = sa(t)).view || t.view.key) && (e = function (t) {
        ...
        function ja(t, e = null) {
            const n = null === e || (t=>t.getAttribute(e)), o = "object" != typeof t.model ? t.model : t.model.key, i = "object" != typeof t.model || void 0 === t.model.value ? n : t.model.value;
            t.model = {key: o, value: i}
        }

        function Va(t, e) {
            const n = new fo(t.view);
            return (o, i, r)=> {
                const s = n.match(i.viewItem);
                if (!s)return;
                const a = t.model.key, c = "function" == typeof t.model.value ? t.model.value(i.viewItem) : t.model.value;
                null !== c && (!function (t) {
                    if ("object" == typeof t.view && !La(t))return !1;
        ...
        class Fa {
            constructor(t, e) {
                this.model = t, this.processor = e, this.mapper = new Ws, this.downcastDispatcher = new $s({mapper: this.mapper}), this.downcastDispatcher.on("insert:$text", (t, e, n)=> {
                    if (!n.consumable.consume(e.item, "insert"))return;
                    const o = n.writer, i = n.mapper.toViewPosition(e.range.start), r = o.createText(e.item.data);
                    o.insert(i, r)
                }, {priority: "lowest"}), this.upcastDispatcher = new Na({schema: t.schema}), this.upcastDispatcher.on("text", (t, e, n)=> {
                    if (n.schema.checkChild(e.modelCursor, "$text") && n.consumable.consume(e.viewItem)) {
                        const t = n.writer.createText(e.viewItem.data);
                        n.writer.insert(t, e.modelCursor), e.modelRange = qs.createFromPositionAndShift(e.modelCursor, t.offsetSize), e.modelCursor = e.modelRange.end
                    }
            ...
            set(t, e = "main") {
                ...
                this.model.enqueueChange("transparent", e=> {
                    e.setSelection(null), e.removeSelectionAttribute(this.model.document.selection.getAttributeKeys()), e.remove(qs.createIn(n)), e.insert(this.parse(t, n), n)
                })
            }
        ...
        class za {
            ...
            elementToElement(t) {
                this.for("downcast").add(aa(t));
                for (const {model:e, view:n}of Ba(t))this.for("upcast").add(Oa({
                    model: e,
                    view: n,
            ...
            attributeToElement(t) {
                this.for("downcast").add(ca(t));
                for (const {model:e, view:n}of Ba(t))this.for("upcast").add(Ra({
                    view: n,
                    model: e,
                    priority: t.priority
                }))
            ...
            attributeToAttribute(t) {
                this.for("downcast").add(la(t));
                for (const {model:e, view:n}of Ba(t))this.for("upcast").add(Da({view: n, model: e}))
            }
        ...
        function*Ba(t) {
            if (t.model.values)for (const e of t.model.values) {
                yield*Ua({key: t.model.key, value: e}, t.view[e], t.upcastAlso ? t.upcastAlso[e] : void 0)
            } else yield*Ua(t.model, t.view, t.upcastAlso)
        }
        ...
        class Wa {
            constructor(t) {
                this.markers = new Map, this._children = new Vs, t && this._insertChild(0, t)
            }
            ...
            static fromJSON(t) {
                const e = [];
                for (const n of t)n.name ? e.push(Fs.fromJSON(n)) : e.push(Ls.fromJSON(n));
                return new Wa(e)
            }
        ...
        function Ya(t, e) {
            const n = (e = Qa(e)).reduce((t, e)=>t + e.offsetSize, 0), o = t.parent;
            Ka(t);
            const i = t.index;
            return o._insertChild(i, e), Ja(o, i + e.length), Ja(o, i), new qs(t, t.getShiftedBy(n))
        }
        ...
        function $a(t, e) {
            ...
            const n = Ga(t);
            return Ya(e = e._getTransformedByDeletion(t.start, t.end.offset - t.start.offset), n)
        }

        function Qa(t) {
            const e = [];
            t instanceof Array || (t = [t]);
            for (let n = 0; n < t.length; n++)if ("string" == typeof t[n])e.push(new Ls(t[n])); else if (t[n] instanceof js)e.push(new Ls(t[n].data, t[n].getAttributes())); else if (t[n] instanceof Wa || t[n] instanceof Vs)for (const o of t[n])e.push(o); else t[n] instanceof Ds && e.push(t[n]);
            for (let t = 1; t < e.length; t++) {
                const n = e[t], o = e[t - 1];
                n instanceof Ls && o instanceof Ls && Za(n, o) && (e.splice(t - 1, 2, new Ls(o.data + n.data, o.getAttributes())), t--)
            }
            return e
        }
        ...
        function Ja(t, e) {
            ...
            if (n && o && n.is("text") && o.is("text") && Za(n, o)) {
                const i = new Ls(n.data + o.data, n.getAttributes());
        ...
        function Ka(t) {
            ...
            if (e) {
                ...
                const r = new Ls(e.data.substr(0, o), e.getAttributes()), s = new Ls(e.data.substr(o), e.getAttributes());
        ...
        class tc extends qa {
            constructor(t, e, n, o, i) {
                super(i), this.range = qs.createFromRange(t), this.key = e, this.oldValue = void 0 === n ? null : n, this.newValue = void 0 === o ? null : o
            }
            ...
            clone() {
                return new tc(this.range, this.key, this.oldValue, this.newValue, this.baseVersion)
            }

            getReversed() {
                return new tc(this.range, this.key, this.newValue, this.oldValue, this.baseVersion + 1)
            }
            ...
            _validate() {
                if (!this.range.isFlat)throw new M.b("attribute-operation-range-not-flat: The range to change is not flat.");
                for (const t of this.range.getItems({shallow: !0})) {
                    if (null !== this.oldValue && !Xa(t.getAttribute(this.key), this.oldValue))throw new M.b("attribute-operation-wrong-old-value: Changed node has different attribute value than operation's old attribute value.", {
                        item: t,
                        key: this.key,
                        value: this.oldValue
                    });
            ...
            _execute() {
                Xa(this.oldValue, this.newValue) || function (t, e, n) {
                    Ka(t.start), Ka(t.end);
                    for (const o of t.getItems({shallow: !0})) {
                        const t = o.is("textProxy") ? o.textNode : o;
                        null !== n ? t._setAttribute(e, n) : t._removeAttribute(e), Ja(t.parent, t.index)
                    }
                    Ja(t.end.parent, t.end.index)
            ...
            static fromJSON(t, e) {
                return new tc(qs.fromJSON(t.range, e), t.key, t.oldValue, t.newValue, t.baseVersion)
            }
        }
        class ec extends qa {
            constructor(t, e) {
                super(null), this.sourcePosition = Hs.createFromPosition(t), this.howMany = e
            }
            ...
            _execute() {
                Ga(qs.createFromPositionAndShift(this.sourcePosition, this.howMany))
            }
        ...
        class nc extends qa {
            constructor(t, e, n, o) {
                super(o), this.sourcePosition = Hs.createFromPosition(t), this.sourcePosition.stickiness = "toNext", this.howMany = e, this.targetPosition = Hs.createFromPosition(n), this.targetPosition.stickiness = "toNone"
            }
            ...
            _validate() {
                const t = this.sourcePosition.parent, e = this.targetPosition.parent, n = this.sourcePosition.offset, o = this.targetPosition.offset;
                ...
                if (this.sourcePosition.root == this.targetPosition.root && "prefix" == U(this.sourcePosition.getParentPath(), this.targetPosition.getParentPath())) {
            ...
            _execute() {
                $a(qs.createFromPositionAndShift(this.sourcePosition, this.howMany), this.targetPosition)
            }
            ...
            static fromJSON(t, e) {
                const n = Hs.fromJSON(t.sourcePosition, e), o = Hs.fromJSON(t.targetPosition, e);
                return new this(n, t.howMany, o, t.baseVersion)
            }
        }
        class oc extends qa {
            constructor(t, e, n) {
                super(n), this.position = Hs.createFromPosition(t), this.position.stickiness = "toNone", this.nodes = new Vs(Qa(e)), this.shouldReceiveAttributes = !1
            }
            ...
            clone() {
                const t = new Vs([...this.nodes].map(t=>t._clone(!0))), e = new oc(this.position, t, this.baseVersion);
                return e.shouldReceiveAttributes = this.shouldReceiveAttributes, e
            }

            getReversed() {
                const t = this.position.root.document.graveyard, e = new Hs(t, [0]);
            ...
            _execute() {
                const t = this.nodes;
                this.nodes = new Vs([...t].map(t=>t._clone(!0))), Ya(this.position, t)
            }
            ...
            static fromJSON(t, e) {
                const n = [];
                for (const e of t.nodes)e.name ? n.push(Fs.fromJSON(e)) : n.push(Ls.fromJSON(e));
                const o = new oc(Hs.fromJSON(t.position, e), n, t.baseVersion);
                return o.shouldReceiveAttributes = t.shouldReceiveAttributes, o
            }
        }
        class ic extends qa {
            constructor(t, e, n, o, i, r) {
                super(r), this.name = t, this.oldRange = e ? qs.createFromRange(e) : null, this.newRange = n ? qs.createFromRange(n) : null, this.affectsData = i, this._markers = o
            }
            ...
            static fromJSON(t, e) {
                return new ic(t.name, t.oldRange ? qs.fromJSON(t.oldRange, e) : null, t.newRange ? qs.fromJSON(t.newRange, e) : null, e.model.markers, t.affectsData, t.baseVersion)
            }
        }
        class rc extends qa {
            constructor(t, e, n, o) {
            ...
            clone() {
                return new rc(Hs.createFromPosition(this.position), this.oldName, this.newName, this.baseVersion)
            }

            getReversed() {
                return new rc(Hs.createFromPosition(this.position), this.newName, this.oldName, this.baseVersion + 1)
            }

            _validate() {
                const t = this.position.nodeAfter;
                if (!(t instanceof Fs))throw new M.b("rename-operation-wrong-position: Given position is invalid or node after it is not an instance of Element.");
            ...
            static fromJSON(t, e) {
                return new rc(Hs.fromJSON(t.position, e), t.oldName, t.newName, t.baseVersion)
            }
        }
        class sc extends qa {
            constructor(t, e, n, o, i) {
            ...
            static fromJSON(t, e) {
                if (!e.getRoot(t.root))throw new M.b("rootattribute-operation-fromjson-no-root: Cannot create RootAttributeOperation. Root with specified name does not exist.", {rootName: t.root});
                return new sc(e.getRoot(t.root), t.key, t.oldValue, t.newValue, t.baseVersion)
            }
        }
        class ac extends qa {
            constructor(t, e, n, o, i) {
                super(i), this.sourcePosition = Hs.createFromPosition(t), this.sourcePosition.stickiness = "toPrevious", this.howMany = e, this.targetPosition = Hs.createFromPosition(n), this.targetPosition.stickiness = "toNext", this.graveyardPosition = Hs.createFromPosition(o)
            }
            ...
            get deletionPosition() {
                return new Hs(this.sourcePosition.root, this.sourcePosition.path.slice(0, -1))
            }
            ...
            getReversed() {
                const t = this.targetPosition._getTransformedByMergeOperation(this), e = this.sourcePosition.path.slice(0, -1), n = new Hs(this.sourcePosition.root, e)._getTransformedByMergeOperation(this), o = new cc(t, this.howMany, this.graveyardPosition, this.baseVersion + 1);
                return o.insertionPosition = n, o
            }

            _validate() {
                const t = this.sourcePosition.parent, e = this.targetPosition.parent;
                if (!(t && t.is("element") && t.parent))throw new M.b("merge-operation-source-position-invalid: Merge source position is invalid.");
                if (!(e && e.is("element") && e.parent))throw new M.b("merge-operation-target-position-invalid: Merge target position is invalid.");
                if (this.howMany != t.maxOffset)throw new M.b("merge-operation-how-many-invalid: Merge operation specifies wrong number of nodes to move.")
            }

            _execute() {
                const t = this.sourcePosition.parent;
                $a(qs.createIn(t), this.targetPosition), $a(qs.createOn(t), this.graveyardPosition)
            }
            ...
            static fromJSON(t, e) {
                const n = Hs.fromJSON(t.sourcePosition, e), o = Hs.fromJSON(t.targetPosition, e), i = Hs.fromJSON(t.graveyardPosition, e);
                return new this(n, t.howMany, o, i, t.baseVersion)
            }
        }
        class cc extends qa {
            constructor(t, e, n, o) {
                super(o), this.splitPosition = Hs.createFromPosition(t), this.splitPosition.stickiness = "toNext", this.howMany = e, this.insertionPosition = cc.getInsertionPosition(t), this.insertionPosition.stickiness = "toNone", this.graveyardPosition = n ? Hs.createFromPosition(n) : null, this.graveyardPosition && (this.graveyardPosition.stickiness = "toNext")
            }
            ...
            get moveTargetPosition() {
                ...
                return t.push(0), new Hs(this.insertionPosition.root, t)
            }
            ...
            getReversed() {
                const t = this.splitPosition.root.document.graveyard, e = new Hs(t, [0]);
                return new ac(this.moveTargetPosition, this.howMany, this.splitPosition, e, this.baseVersion + 1)
            }

            _validate() {
                const t = this.splitPosition.parent, e = this.splitPosition.offset;
                if (!t || t.maxOffset < e)throw new M.b("split-operation-position-invalid: Split position is invalid.");
                if (!t.parent)throw new M.b("split-operation-split-in-root: Cannot split root element.");
                if (this.howMany != t.maxOffset - this.splitPosition.offset)throw new M.b("split-operation-how-many-invalid: Split operation specifies wrong number of nodes to move.");
                if (this.graveyardPosition && !this.graveyardPosition.nodeAfter)throw new M.b("split-operation-graveyard-position-invalid: Graveyard position invalid.")
            }

            _execute() {
                const t = this.splitPosition.parent;
                if (this.graveyardPosition)$a(qs.createFromPositionAndShift(this.graveyardPosition, 1), this.insertionPosition); else {
                    const e = t._clone();
                    Ya(this.insertionPosition, e)
                }
                $a(qs.createFromParentsAndOffsets(t, this.splitPosition.offset, t, t.maxOffset), this.moveTargetPosition)
            }
            ...
            static getInsertionPosition(t) {
                ...
                return e[e.length - 1]++, new Hs(t.root, e)
            }

            static fromJSON(t, e) {
                const n = Hs.fromJSON(t.splitPosition, e), o = Hs.fromJSON(t.insertionPosition, e), i = t.graveyardPosition ? Hs.fromJSON(t.graveyardPosition, e) : null, r = new this(n, t.howMany, i, t.baseVersion);
        ...
        class dc {
            ...
            insert(t, e, n) {
                ...
                const o = Hs.createAt(e, n);
                if (t.parent) {
                    if (pc(t.root, o.root))return void this.move(qs.createOn(t), o);
                ...
                const i = o.root.document ? o.root.document.version : null, r = new oc(o, t, i);
                if (t instanceof Ls && (r.shouldReceiveAttributes = !0), this.batch.addOperation(r), this.model.applyOperation(r), t instanceof Wa)for (const [e,n]of t.markers) {
                    const t = Hs.createAt(n.root), i = new qs(n.start._getCombined(t, o), n.end._getCombined(t, o));
                    this.addMarker(e, {range: i, usingOperation: !0})
                }
            }

            insertText(t, e, n, o) {
                e instanceof Wa || e instanceof Fs || e instanceof Hs ? this.insert(this.createText(t), e, n) : this.insert(this.createText(t, e), n, o)
            }

            insertElement(t, e, n, o) {
                e instanceof Wa || e instanceof Fs || e instanceof Hs ? this.insert(this.createElement(t), e, n) : this.insert(this.createElement(t, e), n, o)
            }
            ...
            appendText(t, e, n) {
                e instanceof Wa || e instanceof Fs ? this.insert(this.createText(t), e, "end") : this.insert(this.createText(t, e), n, "end")
            }

            appendElement(t, e, n) {
                e instanceof Wa || e instanceof Fs ? this.insert(this.createElement(t), e, "end") : this.insert(this.createElement(t, e), n, "end")
            }

            setAttribute(t, e, n) {
                if (this._assertWriterUsedCorrectly(), n instanceof qs) {
                    const o = n.getMinimalFlatRanges();
                    for (const n of o)uc(this, t, e, n)
                } else hc(this, t, e, n)
            }

            setAttributes(t, e) {
                for (const [n,o]of Rs(t))this.setAttribute(n, o, e)
            }

            removeAttribute(t, e) {
                if (this._assertWriterUsedCorrectly(), e instanceof qs) {
                    const n = e.getMinimalFlatRanges();
                    for (const e of n)uc(this, t, null, e)
                } else hc(this, t, null, e)
            }
            ...
            clearAttributes(t) {
                ...
                if (t instanceof qs)for (const n of t.getItems())e(n); else e(t)
            }

            move(t, e, n) {
                if (this._assertWriterUsedCorrectly(), !(t instanceof qs))throw new M.b("writer-move-invalid-range: Invalid range to move.");
                if (!t.isFlat)throw new M.b("writer-move-range-not-flat: Range to move is not flat.");
                const o = Hs.createAt(e, n);
                if (!pc(t.root, o.root))throw new M.b("writer-move-different-document: Range is going to be moved between different documents.");
                const i = t.root.document ? t.root.document.version : null, r = new nc(t.start, t.end.offset - t.start.offset, o, i);
                this.batch.addOperation(r), this.model.applyOperation(r)
            }

            remove(t) {
                if (this._assertWriterUsedCorrectly(), t instanceof qs) {
                    const e = t.getMinimalFlatRanges().reverse();
                    for (const t of e)mc(t.start, t.end.offset - t.start.offset, this.batch, this.model)
                } else {
                    const e = t.is("text") ? t.offsetSize : 1;
                    mc(Hs.createBefore(t), e, this.batch, this.model)
                }
            }
            ...
            merge(t) {
                this._assertWriterUsedCorrectly();
                const e = t.nodeBefore, n = t.nodeAfter;
                if (!(e instanceof Fs))throw new M.b("writer-merge-no-element-before: Node before merge position must be an element.");
                if (!(n instanceof Fs))throw new M.b("writer-merge-no-element-after: Node after merge position must be an element.");
                t.root.document ? this._merge(t) : this._mergeDetached(t)
            }

            _mergeDetached(t) {
                const e = t.nodeBefore, n = t.nodeAfter;
                this.move(qs.createIn(n), Hs.createAt(e, "end")), this.remove(n)
            }

            _merge(t) {
                const e = Hs.createAt(t.nodeBefore, "end"), n = Hs.createAt(t.nodeAfter, 0), o = t.root.document.graveyard, i = new Hs(o, [0]), r = t.root.document.version, s = new ac(n, t.nodeAfter.maxOffset, e, i, r);
                this.batch.addOperation(s), this.model.applyOperation(s)
            }

            rename(t, e) {
                if (this._assertWriterUsedCorrectly(), !(t instanceof Fs))throw new M.b("writer-rename-not-element-instance: Trying to rename an object which is not an instance of Element.");
                const n = t.root.document ? t.root.document.version : null, o = new rc(Hs.createBefore(t), t.name, e, n);
            ...
            split(t, e) {
                ...
                do {
                    const e = i.root.document ? i.root.document.version : null, r = i.maxOffset - t.offset, s = new cc(t, r, null, e);
                    this.batch.addOperation(s), this.model.applyOperation(s), n || o || (n = i, o = t.parent.nextSibling), i = (t = Hs.createAfter(t.parent)).parent
                } while (i !== e);
                return {position: t, range: new qs(Hs.createAt(n, "end"), Hs.createAt(o))}
            }

            wrap(t, e) {
                if (this._assertWriterUsedCorrectly(), !t.isFlat)throw new M.b("writer-wrap-range-not-flat: Range to wrap is not flat.");
                const n = e instanceof Fs ? e : new Fs(e);
                ...
                const o = t.root.document ? t.root.document.version : null, i = new oc(t.start, n, o);
                this.batch.addOperation(i), this.model.applyOperation(i);
                const r = new nc(t.start.getShiftedBy(1), t.end.offset - t.start.offset, Hs.createAt(n, 0), null === o ? null : o + 1);
                this.batch.addOperation(r), this.model.applyOperation(r)
            }
            ...
            unwrap(t) {
                ...
                this.move(qs.createIn(t), Hs.createAfter(t)), this.remove(t)
            }
            ...
            addMarker(t, e) {
                ...
                return n ? (fc(this, t, null, o, i), this.model.markers.get(t)) : this.model.markers._set(t, o, n, i)
            }
            ...
            updateMarker(t, e = {}) {
                ...
                const i = "boolean" == typeof e.usingOperation, r = "boolean" == typeof e.affectsData, s = r ? e.affectsData : o.affectsData;
                ...
                i && e.usingOperation !== o.managedUsingOperations ? e.usingOperation ? fc(this, n, null, c, s) : (fc(this, n, a, null, s), this.model.markers._set(n, c, void 0, s)) : o.managedUsingOperations ? fc(this, n, a, c, s) : this.model.markers._set(n, c, void 0, s)
            }
            ...
            removeMarker(t) {
                ...
                n.managedUsingOperations ? fc(this, e, n.getRange(), null, n.affectsData) : this.model.markers._remove(e)
            }
            ...
            setSelectionAttribute(t, e) {
                if (this._assertWriterUsedCorrectly(), "string" == typeof t)this._setSelectionAttribute(t, e); else for (const [e,n]of Rs(t))this._setSelectionAttribute(e, n)
            }
            ...
            _setSelectionAttribute(t, e) {
                ...
                if (n.isCollapsed && n.anchor.parent.isEmpty) {
                    const o = ea._getStoreAttributeKey(t);
            ...
            _removeSelectionAttribute(t) {
                ...
                if (e.isCollapsed && e.anchor.parent.isEmpty) {
                    const n = ea._getStoreAttributeKey(t);
        ...
        function uc(t, e, n, o) {
            const i = t.model, r = i.document;
            let s, a, c, l = o.start;
            for (const t of o.getWalker({shallow: !0}))c = t.item.getAttribute(e), s && a != c && (a != n && d(), l = s), s = t.nextPosition, a = c;
            function d() {
                const o = new qs(l, s), c = o.root.document ? r.version : null, d = new tc(o, e, a, n, c);
                t.batch.addOperation(d), i.applyOperation(d)
            }

            s instanceof Hs && s != l && a != n && d()
        }
        ...
        function hc(t, e, n, o) {
            ...
            if (s != n) {
                if (o.root === o) {
                    ...
                    const t = (a = new qs(Hs.createBefore(o), Hs.createAfter(o))).root.document ? r.version : null;
                    c = new tc(a, e, s, n, t)
                }
        ...
        function fc(t, e, n, o, i) {
            const r = t.model, s = r.document, a = new ic(e, n, o, r.markers, i, s.version);
        ...
        function mc(t, e, n, o) {
            let i;
            if (t.root.document) {
                const n = o.document, r = new Hs(n.graveyard, [0]);
                i = new nc(t, e, r, n.version)
            } else i = new ec(t, e);
            n.addOperation(i), o.applyOperation(i)
        }

        function pc(t, e) {
            return t === e || t instanceof lc && e instanceof lc
        }
        ...
        class gc {
            ...
            bufferOperation(t) {
                switch (t.type) {
                    ...
                    case"rename": {
                        ...
                        const e = qs.createFromPositionAndShift(t.position, 1);
            ...
            getChanges(t = {includeChangesInGraveyard: !1}) {
                ...
                for (const t of this._changesInElement.keys()) {
                    const n = this._changesInElement.get(t).sort((t, e)=>t.offset === e.offset ? t.type != e.type ? "remove" == t.type ? -1 : 1 : 0 : t.offset < e.offset ? -1 : 1), o = this._elementSnapshots.get(t), i = bc(t.getChildren()), r = wc(o.length, n);
                    let s = 0, a = 0;
                    for (const n of r)if ("i" === n)e.push(this._getInsertDiff(t, s, i[s].name)), s++; else if ("r" === n)e.push(this._getRemoveDiff(t, s, o[a].name)), a++; else if ("a" === n) {
                        ...
                        let c;
                        if ("$text" == i[s].name)c = qs.createFromParentsAndOffsets(t, s, t, s + 1); else {
                            const e = t.offsetToIndex(s);
                            c = qs.createFromParentsAndOffsets(t, s, t.getChild(e), 0)
                        }
                ...
                for (let t = 1; t < e.length; t++) {
                    const n = e[t - 1], o = e[t], i = "remove" == n.type && "remove" == o.type && "$text" == n.name && "$text" == o.name && n.position.isEqual(o.position), r = "insert" == n.type && "insert" == o.type && "$text" == n.name && "$text" == o.name && n.position.parent == o.position.parent && n.position.offset + n.length == o.position.offset, s = "attribute" == n.type && "attribute" == o.type && n.position.parent == o.position.parent && n.range.isFlat && o.range.isFlat && n.position.offset + n.length == o.position.offset && n.attributeKey == o.attributeKey && n.attributeOldValue == o.attributeOldValue && n.attributeNewValue == o.attributeNewValue;
                ...
                return this._changeCount = 0, this._cachedChangesWithGraveyard = e.slice(), this._cachedChanges = e.slice().filter(_c), t.includeChangesInGraveyard ? this._cachedChangesWithGraveyard : this._cachedChanges
            }
            ...
            _makeSnapshot(t) {
                this._elementSnapshots.has(t) || this._elementSnapshots.set(t, bc(t.getChildren()))
            }
            ...
            _getInsertDiff(t, e, n) {
                return {
                    type: "insert",
                    position: Hs.createFromParentAndOffset(t, e),
                    name: n,
                    length: 1,
            ...
            _removeAllNestedChanges(t, e, n) {
                const o = qs.createFromParentsAndOffsets(t, e, t, e + n);
        ...
        function _c(t) {
            const e = t.position && "$graveyard" == t.position.root.rootName, n = t.range && "$graveyard" == t.range.root.rootName;
            return !e && !n
        }
        ...
        class Ac {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new kc(this), this.selection = new ea(this), this.roots = new ti({idProperty: "rootName"}), this.differ = new gc(t.markers), this._postFixers = new Set, this.createRoot("$root", xc), this.listenTo(t, "applyOperation", (t, e)=> {
                    const n = e[0];
            ...
            getRootNames() {
                return Array.from(this.roots, t=>t.rootName).filter(t=>t != xc)
            }
            ...
            _getDefaultRange() {
                const t = this._getDefaultRoot(), e = this.model.schema, n = new Hs(t, [0]);
                return e.getNearestSelectionRange(n) || new qs(n)
            }

            _validateSelectionRange(t) {
                return Cc(t.start) && Cc(t.end)
            }
        ...
        class Tc {
            ...
            _set(t, e, n = !1, o = !1) {
                const i = t instanceof Mc ? t.name : t, r = this._markers.get(i);
                if (r) {
                    const t = r.getRange();
                    let s = !1;
                    return t.isEqual(e) || (r._attachLiveRange(Xs.createFromRange(e)), s = !0), n != r.managedUsingOperations && (r._managedUsingOperations = n, s = !0), "boolean" == typeof o && o != r.affectsData && (r._affectsData = o, s = !0), s && this.fire("update:" + i, r, t, e), r
                }
                const s = Xs.createFromRange(e), a = new Mc(i, s, n, o);
                return this._markers.set(i, a), this.fire("update:" + i, a, null, e), a
            }

            _remove(t) {
                const e = t instanceof Mc ? t.name : t, n = this._markers.get(e);
        ...
        class Mc {
            ...
            getStart() {
                if (!this._liveRange)throw new M.b("marker-destroyed: Cannot use a destroyed marker instance.");
                return Hs.createFromPosition(this._liveRange.start)
            }

            getEnd() {
                if (!this._liveRange)throw new M.b("marker-destroyed: Cannot use a destroyed marker instance.");
                return Hs.createFromPosition(this._liveRange.end)
            }

            getRange() {
                if (!this._liveRange)throw new M.b("marker-destroyed: Cannot use a destroyed marker instance.");
                return qs.createFromRange(this._liveRange)
            }
        ...
        class Pc extends Hs {
            constructor(t, e, n = "toNone") {
                if (super(t, e, n), !this.root.is("rootElement"))throw new M.b("model-liveposition-root-not-rootelement: LivePosition's root has to be an instance of RootElement.");
                (function () {
                    this.listenTo(this.root.document.model, "applyOperation", (t, e)=> {
                        const n = e[0];
                        n.isDocumentOperation && function (t) {
                            ...
                            if (!this.isEqual(e)) {
                                const t = Hs.createFromPosition(this);
        ...
        class Sc {
            ...
            getSelectionRange() {
                return this.nodeToSelect ? qs.createOn(this.nodeToSelect) : this.model.schema.getNearestSelectionRange(this.position)
            }
            ...
            _insert(t) {
                if (!this.schema.checkChild(this.position, t))return void fs.a.error("insertcontent-wrong-position: The node cannot be inserted on the given position.", {
                    node: t,
                    position: this.position
                });
                const e = Pc.createFromPosition(this.position);
                e.stickiness = "toNext", this.writer.insert(t, this.position), this.position = Hs.createFromPosition(e), e.detach(), this.schema.isObject(t) && !this.schema.checkChild(this.position, "$text") ? this.nodeToSelect = t : this.nodeToSelect = null, this._filterAttributesOf.push(t)
            }

            _mergeSiblingsOf(t, e) {
                if (!(t instanceof Fs))return;
                const n = this._canMergeLeft(t, e), o = this._canMergeRight(t, e), i = Pc.createBefore(t);
                i.stickiness = "toNext";
                const r = Pc.createAfter(t);
                if (r.stickiness = "toNext", n) {
                    const t = Pc.createFromPosition(this.position);
                    t.stickiness = "toNext", this.writer.merge(i), this.position = Hs.createFromPosition(t), t.detach()
                }
                if (o) {
                    this.position.isEqual(r) || fs.a.error("insertcontent-wrong-position-on-merge: The insertion position should equal the merge position"), this.position = Hs.createAt(r.nodeBefore, "end");
                    const t = new Pc(this.position.root, this.position.path, "toPrevious");
                    this.writer.merge(r), this.position = Hs.createFromPosition(t), t.detach()
                }
            ...
            _canMergeLeft(t, e) {
                const n = t.previousSibling;
                return e.isFirst && n instanceof Fs && this.canMergeWith.has(n) && this.model.schema.checkMerge(n, t)
            }

            _canMergeRight(t, e) {
                const n = t.nextSibling;
                return e.isLast && n instanceof Fs && this.canMergeWith.has(n) && this.model.schema.checkMerge(t, n)
            }
            ...
            _checkAndSplitToAllowedPosition(t) {
                ...
                for (; e != this.position.parent;) {
                    ...
                    if (this.position.isAtStart) {
                        const t = this.position.parent;
                        this.position = Hs.createBefore(t), t.isEmpty && this.writer.remove(t)
                    } else if (this.position.isAtEnd)this.position = Hs.createAfter(this.position.parent); else {
                        const t = Hs.createAfter(this.position.parent);
        ...
        function Ec(t, e, n = {}) {
            ...
            t.change(t=> {
                if (!n.doNotResetEntireContent && function (t, e) {
                    ...
                    t.remove(qs.createIn(n)), Ic(t, Hs.createAt(n), e)
                }(t, e);
                const i = e.getFirstRange(), r = i.start, s = Pc.createFromPosition(i.end);
                s.stickiness = "toNext", i.start.isTouching(i.end) || t.remove(i), n.leaveUnmerged || (!function t(e, n, o) {
                    const i = n.parent;
                    const r = o.parent;
                    if (i == r)return;
                    ...
                    for (; o.parent.isEmpty;) {
                        const t = o.parent;
                        o = Hs.createBefore(t), e.remove(t)
                    }
                    t(e, n, o)
                }(t, r, s), o.removeDisallowedAttributes(r.parent.getChildren(), t)), e instanceof ea ? t.setSelection(r) : e.setTo(r), function (t, e) {
                    const n = t.checkChild(e, "$text"), o = t.checkChild(e, "paragraph");
                    return !n && o
                }(o, r) && Ic(t, r, e), s.detach()
            })
        }

        function Ic(t, e, n) {
            const o = t.createElement("paragraph");
            t.insert(o, e), n instanceof ea ? t.setSelection(o, 0) : n.setTo(o, 0)
        }

        const Nc = ' ,.?!:;"-()';

        function Oc(t, e, n = {}) {
            const o = t.schema, i = "backward" != n.direction, r = n.unit ? n.unit : "character", s = e.focus, a = new zs({
                boundaries: function (t, e) {
                    const n = t.root, o = Hs.createAt(n, e ? "end" : 0);
                    return e ? new qs(t, o) : new qs(o, t)
                }(s, i), singleCharacters: !0, direction: i ? "forward" : "backward"
            }), c = {walker: a, schema: o, isForward: i, unit: r};
            let l;
            for (; l = a.next();) {
                if (l.done)return;
                const n = Rc(c, l.value);
                if (n)return void(e instanceof ea ? t.change(t=> {
        ...
        function Rc(t, e) {
            if ("text" == e.type)return "word" === t.unit ? function (t, e) {
                ...
                if (n) {
                    ...
                    for (; vc(o, i) || "character" == e && yc(o, i);)t.next(), i = t.position.offset - n.startOffset
                }
                return t.position
            }(t.walker, t.unit, t.isForward);
            if (e.type == (t.isForward ? "elementStart" : "elementEnd")) {
                if (t.schema.isObject(e.item))return Hs.createAt(e.item, t.isForward ? "after" : "before");
        ...
        function jc(t, e) {
            const n = [];
            Array.from(t.getItems({direction: "backward"})).map(t=>qs.createOn(t)).filter(e=> {
        ...
        function Fc(t, e) {
            return t.isCollapsed ? function (t, e) {
                ...
                if (i.nodeAfter && e.isLimit(i.nodeAfter))return new qs(i, Hs.createAfter(i.nodeAfter));
                return new qs(i)
            }(t, e) : function (t, e) {
                const n = t.start, o = t.end, i = e.checkChild(n, "$text"), r = e.checkChild(o, "$text"), s = e.getLimitElement(n), a = e.getLimitElement(o);
                if (s === a) {
                    if (i && r)return null;
                    if (function (t, e, n) {
                            const o = t.nodeAfter && !n.isLimit(t.nodeAfter) || n.checkChild(t, "$text"), i = e.nodeBefore && !n.isLimit(e.nodeBefore) || n.checkChild(e, "$text");
                            return o && i
                        }(n, o, e)) {
                        const t = e.getNearestSelectionRange(n, "forward"), i = e.getNearestSelectionRange(o, "backward");
                        return new qs(t ? t.start : n, i ? i.start : o)
                    }
                }
                const c = s && !s.is("rootElement"), l = a && !a.is("rootElement");
                if (c || l) {
                    const t = c ? zc(Hs.createAt(s), e, "start") : n, i = l ? zc(Hs.createAt(a), e, "end") : o;
                    return new qs(t, i)
                }
                return null
            }(t, e)
        ...
        function zc(t, e, n) {
            ...
            return "start" === n ? Hs.createBefore(o) : Hs.createAfter(o)
        }

        class Bc {
            constructor() {
                this.markers = new Tc, this.document = new Ac(this), this.schema = new ka, this._pendingChanges = [], this._currentWriter = null, ["insertContent", "deleteContent", "modifySelection", "getSelectedContent", "applyOperation"].forEach(t=>this.decorate(t)), this.on("applyOperation", (t, e)=> {
                    e[0]._validate()
                    ...
                    allowContentOf: "$root",
                    isLimit: !0
                }), this.schema.extend("$text", {allowIn: "$clipboardHolder"}), this.schema.register("$marker", {allowIn: ["$root", "$block"]}), Vc(this)
            }
            ...
            enqueueChange(t, e) {
                "string" == typeof t ? t = new Ha(t) : "function" == typeof t && (e = t, t = new Ha), this._pendingChanges.push({
                    batch: t,
                    callback: e
            ...
            insertContent(t, e) {
                !function (t, e, n) {
                    t.change(o=> {
                        let i;
                        (i = n ? n instanceof Js || n instanceof ea ? n : new Js(n) : t.document.selection).isCollapsed || t.deleteContent(i);
                        const r = new Sc(t, o, i.anchor);
                        let s;
                        s = e.is("documentFragment") ? e.getChildren() : [e], r.handleNodes(s, {
                            isFirst: !0,
                            isLast: !0
                        });
                        const a = r.getSelectionRange();
                        a ? i instanceof ea ? o.setSelection(a) : i.setTo(a) : fs.a.warn("insertcontent-no-range: Cannot determine a proper selection range after insertion.")
                    })
                }(this, t, e)
            }
            ...
            getSelectedContent(t) {
                return function (t, e) {
                    return t.change(t=> {
                        ...
                        let a;
                        const c = (a = o.start.parent == o.end.parent ? o : qs.createFromParentsAndOffsets(s, o.start.path[r.length], s, o.end.path[r.length] + 1)).end.offset - a.start.offset;
                        for (const e of a.getItems({shallow: !0}))e.is("textProxy") ? t.appendText(e.data, e.getAttributes(), n) : t.append(e._clone(!0), n);
                        if (a != o) {
                            const e = o._getTransformedByMove(a.start, Hs.createAt(n, 0), c)[0], i = new qs(Hs.createAt(n), e.start);
                            jc(new qs(e.end, Hs.createAt(n, "end")), t), jc(i, t)
                        }
                        return n
                    })
                }(this, t)
            ...
            hasContent(t) {
                if (t instanceof Fs && (t = qs.createIn(t)), t.isCollapsed)return !1;
            ...
            _runPendingChanges() {
                ...
                for (this.fire("_beforeChanges"); this._pendingChanges.length;) {
                    ...
                    this._currentWriter = new dc(this, e);
        ...
        class Uc {
            constructor() {
                this._listener = Object.create(rr)
            }
        ...
        class $c {
            constructor() {
                this._domParser = new DOMParser, this._domConverter = new er({blockFiller: Ni}), this._htmlWriter = new Gc
            }
            ...
            _toDom(t) {
                const e = this._domParser.parseFromString(t, "text/html"), n = e.createDocumentFragment(), o = e.body.childNodes;
        ...
        class Qc {
            ...
            *names() {
            ...
            add(t, e) {
                ...
                this._components.set(Jc(t), {callback: e, originalName: t})
            }

            create(t) {
                if (!this.has(t))throw new M.b("componentfactory-item-missing: The required component is not registered in the factory.", {name: t});
                return this._components.get(Jc(t)).callback(this.editor.locale)
            }

            has(t) {
                return this._components.has(Jc(t))
            }
        }
        function Jc(t) {
        ...
        class Zc {
            constructor(t, e) {
                this.editor = t, this.view = e, this.componentFactory = new Qc(t), this.focusTracker = new Kc, this.listenTo(t.editing.view.document, "layoutChanged", ()=>this.update())
            }
        ...
        class tl extends ti {
            ...
            delegate(...t) {
                if (!t.length || !function (t) {
                        return t.every(t=>"string" == typeof t)
                    }(t))throw new M.b("ui-viewcollection-delegate-wrong-event: All event names must be strings.");
                return {
                    to: e=> {
        ...
        var el = 1, nl = 4;
        var ol = function (t, e) {
            return io(t, el | nl, e = "function" == typeof e ? e : void 0)
        };
        const il = "http://www.w3.org/1999/xhtml";
        class rl {
            constructor(t) {
                Object.assign(this, ml(fl(t))), this._isRendered = !1, this._revertData = null
            }
            ...
            *getViews() {
                yield*function*t(e) {
                    if (e.children)for (const n of e.children)_l(n) ? yield n : kl(n) && (yield*t(n))
                }(this)
            }
            ...
            static bind(t, e) {
                return {
                    to: (n, o)=>new al({
                        ...
                        emitter: e,
                        callback: o
                    }), if: (n, o, i)=>new cl({observable: t, emitter: e, attribute: n, valueIfTrue: o, callback: i})
                }
            }

            static extend(t, e) {
                t._isRendered && fs.a.warn("template-extend-render: Attempting to extend a template which has already been rendered."), function t(e, n) {
                    n.attributes && (e.attributes || (e.attributes = {}), bl(e.attributes, n.attributes));
                    n.eventListeners && (e.eventListeners || (e.eventListeners = {}), bl(e.eventListeners, n.eventListeners));
            ...
            _renderText(t) {
                let e = t.node;
                return e ? t.revertData.text = e.textContent : e = t.node = document.createTextNode(""), ll(this.text) ? this._bindToObservable({
                    schema: this.text,
                    updater: function (t) {
                        return {
                            set(e){
            ...
            _renderAttributes(t) {
                ...
                for (e in this.attributes)if (o = r.getAttribute(e), n = this.attributes[e], s && (s.attributes[e] = o), i = ot(n[0]) && n[0].ns ? n[0].ns : null, ll(n)) {
                    const a = i ? n[0].value : n;
                    s && yl(e) && a.unshift(o), this._bindToObservable({schema: a, updater: ul(r, e, i), data: t})
                } else"style" == e && "string" != typeof n[0] ? this._renderStyleAttribute(n[0], t) : (s && o && yl(e) && n.unshift(o), wl(n = n.map(t=>t && t.value || t).reduce((t, e)=>t.concat(e), []).reduce(gl, "")) || r.setAttributeNS(i, e, n))
            }
            ...
            _renderStyleAttribute(t, e) {
                ...
                for (const o in t) {
                    const i = t[o];
                    ll(i) ? this._bindToObservable({schema: [i], updater: hl(n, o), data: e}) : n.style[o] = i
                }
            }
            ...
            _renderElementChildren(t) {
                ...
                let i = 0;
                for (const r of this.children)if (vl(r)) {
                    if (!o) {
                        r.setParent(e);
                        for (const t of r)n.appendChild(t.element)
                    }
                } else if (_l(r))o || (r.isRendered || r.render(), n.appendChild(r.element)); else if (qi(r))n.appendChild(r); else if (o) {
            ...
            _bindToObservable({schema:t, updater:e, data:n}) {
                ...
                dl(t, e, n);
                const i = t.filter(t=>!wl(t)).filter(t=>t.observable).map(o=>o.activateAttributeListener(t, e, n));
                o && o.bindings.push(i)
            }
        ...
        class cl extends sl {
            getValue(t) {
                return !wl(super.getValue(t)) && (this.valueIfTrue || !0)
            }
        }
        function ll(t) {
            return !!t && (t.value && (t = t.value), Array.isArray(t) ? t.some(ll) : t instanceof sl)
        }

        function dl(t, e, {node:n}) {
            let o = function (t, e) {
                return t.map(t=>t instanceof sl ? t.getValue(e) : t)
            }(t, n);
            wl(o = 1 == t.length && t[0] instanceof cl ? o[0] : o.reduce(gl, "")) ? e.remove() : e.set(o)
        }
        ...
        function fl(t) {
            return ol(t, t=> {
                if (t && (t instanceof sl || kl(t) || _l(t) || vl(t)))return t
            })
        }
        ...
        function ml(t) {
            if ("string" == typeof t ? t = function (t) {
                ...
                const e = [];
                if (t.children)if (vl(t.children))e.push(t.children); else for (const n of t.children)kl(n) || _l(n) || qi(n) ? e.push(n) : e.push(new rl(n));
                t.children = e
            }
            return t
        }
        ...
        class xl {
            constructor(t) {
                this.element = null, this.isRendered = !1, this.locale = t, this.t = t && t.t, this._viewCollections = new ti, this._unboundChildren = this.createCollection(), this._viewCollections.on("add", (e, n)=> {
                    n.locale = t
            ...
            setTemplate(t) {
                this.template = new rl(t)
            }

            extendTemplate(t) {
                rl.extend(this.template, t)
            }
        ...
        class Al extends xl {
            ...
            _renderBodyCollection() {
                const t = this._bodyCollectionContainer = new rl({
                    tag: "div",
        ...
        class Tl extends Al {
            ...
            _createVoiceLabel(t) {
                const e = this.t, n = new Cl;
                return n.text = e("av"), n.extendTemplate({
                    attributes: {
        ...
        class Il extends xl {
            constructor(t) {
                super(t);
                const e = this.bindTemplate;
                this.set("isActive", !1), this.set("isSticky", !1), this.set("limiterElement", null), this.set("limiterBottomOffset", 50), this.set("viewportTopOffset", 0), this.set("_marginLeft", null), this.set("_isStickyToTheLimiter", !1), this.set("_hasViewportTopOffset", !1), this.content = this.createCollection(), this._contentPanelPlaceholder = new rl({
                    tag: "div",
                    attributes: {
                ...
                }).render(), this._contentPanel = new rl({
                    tag: "div",
                    attributes: {
            ...
            render() {
                super.render(), this._checkIfShouldBeSticky(), this.listenTo(Ki.window, "scroll", ()=> {
        ...
        class Nl {
            ...
            get first() {
                return this.focusables.find(Ol) || null
            }

            get last() {
                return this.focusables.filter(Ol).slice(-1)[0] || null
            }
        ...
        function Ol(t) {
            return !(!t.focus || "none" == Ki.window.getComputedStyle(t.element).display)
        }
        ...
        class Dl extends xl {
            constructor(t) {
                super(t);
                const e = this.bindTemplate;
                this.items = this.createCollection(), this.focusTracker = new Kc, this.keystrokes = new Uc, this.set("isVertical", !1), this.set("className"), this._focusCycler = new Nl({
            ...
            fillFromConfig(t, e) {
                t.map(t=> {
                    "|" == t ? this.items.add(new Rl) : e.has(t) ? this.items.add(e.create(t)) : fs.a.warn("toolbarview-item-unavailable: The requested toolbar item is unavailable.", {name: t})
                })
            }
        }
        n(53);
        class Ll extends Tl {
            constructor(t) {
                super(t), this.stickyPanel = new Il(t), this.toolbar = new Dl(t), this.editable = new Pl(t)
            }
        ...
        class Vl extends qc {
            constructor(t, e) {
                super(e), tr(t) && (this.sourceElement = t), this._elementReplacer = new jl, this.data.processor = new $c, this.model.document.createRoot(), this.ui = new Xc(this, new Ll(this.locale)), function (t) {
                    if (!ct(t.updateSourceElement))throw new M.b("attachtoform-missing-elementapi-interface: Editor passed to attachToForm() must implement ElementApi.");
                    const e = t.sourceElement;
                    if (e && "textarea" === e.tagName.toLowerCase() && e.form) {
                        let n;
                        const o = e.form, i = ()=>t.updateSourceElement();
                        ct(o.submit) && (n = o.submit, o.submit = (()=> {
                            i(), n.apply(o)
            ...
            static create(t, e) {
                return new Promise(n=> {
                    ...
                    n(o.initPlugins().then(()=>o.ui.init()).then(()=> {
                        tr(t) && o._elementReplacer.replace(t, o.element), o.fire("uiReady")
                    }).then(()=>o.editing.view.attachDomRoot(o.ui.view.editableElement)).then(()=> {
                        const e = tr(t) ? function (t) {
        ...
        class Bl extends Jr {
            ...
            onDomEvent(t) {
                const e = {dataTransfer: new zl(t.clipboardData ? t.clipboardData : t.dataTransfer)};
        ...
        class Hl extends Fl {
            ...
            init() {
                ...
                this._htmlDataProcessor = new $c, n.addObserver(Bl), this.listenTo(o, "clipboardInput", e=> {
                    t.isReadOnly && e.stop()
                    ...
                    if (!e.content.isEmpty) {
                        const t = this.editor.data, n = this.editor.model, o = t.toModel(e.content, "$clipboardHolder");
                    ...
                    o.content.isEmpty || (o.dataTransfer.setData("text/html", this._htmlDataProcessor.toData(o.content)), o.dataTransfer.setData("text/plain", function t(e) {
                        ...
                        if (e.is("text") || e.is("textProxy"))n = e.data; else if (e.is("img") && e.hasAttribute("alt"))n = e.getAttribute("alt"); else {
                            ...
                            for (const i of e.getChildren()) {
                                const e = t(i);
                                o && (o.is("containerElement") || i.is("containerElement")) && (Ul.includes(o.name) || Ul.includes(i.name) ? n += "\n" : n += "\n\n"), n += e, o = i
                            }
                        }
                        return n
        ...
        class ql {
            constructor(t) {
                this.editor = t, this.set("value", void 0), this.set("isEnabled", !1), this.decorate("execute"), this.listenTo(this.editor.model.document, "change", ()=> {
                    ...
                    n ? (this.on("set:isEnabled", Wl, {priority: "highest"}), this.isEnabled = !1) : (this.off("set:isEnabled", Wl), this.refresh())
                })
            }
            ...
            execute() {
                ...
                t.change(n=> {
                    !function (t, e, n, o) {
                        ...
                        if (i)Gl(e, n, r.start); else {
                            const o = !(r.start.isAtStart && r.end.isAtEnd), i = s == a;
                            t.deleteContent(n, {leaveUnmerged: o}), o && (i ? Gl(e, n, n.focus) : e.setSelection(a, 0))
                        }
        ...
        class $l extends cr {
            constructor(t) {
                ...
                const e = this.document;
                e.on("keydown", (t, n)=> {
                    if (this.isEnabled && n.keyCode == hi.enter) {
                        let o;
                        e.once("enter", t=>o = t, {priority: "highest"}), e.fire("enter", new Qr(e, n.domEvent, {isSoft: n.shiftKey})), o && o.stop.called && t.stop()
                    }
                })
            }
        ...
        class Ql extends Fl {
            ...
            init() {
                ...
                e.addObserver($l), t.commands.add("enter", new Yl(t)), this.listenTo(n, "enter", (n, o)=> {
        ...
        class Jl extends ql {
            execute() {
                ...
                t.change(n=> {
                    !function (t, e, n) {
                        const o = n.isCollapsed, i = n.getFirstRange(), r = i.start.parent, s = i.end.parent, a = r == s;
                        if (o)Kl(e, i.end); else {
                            const o = !(i.start.isAtStart && i.end.isAtEnd);
                            t.deleteContent(n, {leaveUnmerged: o}), a ? Kl(e, n.focus) : o && e.setSelection(s, 0)
                        }
        ...
        function Zl(t, e) {
            return !t.is("rootElement") && (e.isLimit(t) || Zl(t.parent, e))
        }
        ...
        class Xl extends Fl {
            ...
            init() {
                ...
                e.register("softBreak", {allowWhere: "$text"}), n.for("upcast").add(Oa({
                    model: "softBreak",
                    view: "br"
                })), n.for("downcast").add(aa({
                    model: "softBreak",
                    view: (t, e)=>e.createEmptyElement("br")
                })), o.addObserver($l), t.commands.add("shiftEnter", new Jl(t)), this.listenTo(i, "enter", (e, n)=> {
        ...
        class td {
            ...
            get batch() {
                return this._batch || (this._batch = new Ha), this._batch
            }
        ...
        class ed extends ql {
            constructor(t, e) {
                super(t), this._buffer = new td(t.model, e)
            }
            ...
            execute(t = {}) {
                const e = this.editor.model, n = e.document, o = t.text || "", i = o.length, r = t.range || n.selection.getFirstRange(), s = t.resultRange;
        ...
        function nd(t) {
            ...
            o.document.on("keydown", (t, s)=>(function (t) {
                ...
                e = new Js(n.document.selection)
            }, {priority: "lowest"})
        }

        const od = [fi("arrowUp"), fi("arrowRight"), fi("arrowDown"), fi("arrowLeft"), 9, 16, 17, 18, 20, 27, 33, 34, 35, 36];
        for (let t = 112; t <= 135; t++)od.push(t);
        function id(t) {
            if (0 == t.length)return !1;
            for (const e of t)if ("children" === e.type && !rd(e))return !0;
            return !1
        }
        ...
        function rd(t) {
            ...
            }(Bi(t.oldChildren, t.newChildren, sd), t.newChildren);
            if (e.length > 1)return;
            const n = e[0];
            return n.values[0] instanceof co ? n : void 0
        }

        function sd(t, e) {
            return t instanceof co && e instanceof co ? t.data === e.data : t === e
        }
        ...
        class ad {
            ...
            handle(t, e) {
                if (id(t))this._handleContainerChildrenMutations(t, e); else for (const n of t)this._handleTextMutation(n, e), this._handleTextNodeInsertion(n)
            }
            ...
            _handleContainerChildrenMutations(t, e) {
                ...
                if (!n)return;
                const o = this.editor.editing.view.domConverter.mapViewToDom(n), i = new er, r = this.editor.data.toModel(i.domToView(o)).getChild(0), s = this.editor.editing.mapper.toModelElement(n);
                if (!s)return;
                const a = Array.from(r.getChildren()), c = Array.from(s.getChildren()), l = a[a.length - 1], d = c[c.length - 1];
                if (l && l.is("softBreak") && d && !d.is("softBreak") && a.pop(), !cd(a) || !cd(c))return;
                const u = a.map(t=>t.is("text") ? t.data : "@").join("").replace(/\u00A0/g, " "), h = c.map(t=>t.is("text") ? t.data : "@").join("").replace(/\u00A0/g, " ");
                if (h === u)return;
                const f = Bi(h, u), {firstChangeAt:m, insertions:p, deletions:g}=ld(f);
                let b = null;
                e && (b = this.editing.mapper.toModelRange(e.getFirstRange()));
                const w = u.substr(m, p), _ = qs.createFromParentsAndOffsets(s, m, s, m + g);
                this.editor.execute("input", {text: w, range: _, resultRange: b})
            }

            _handleTextMutation(t, e) {
                if ("text" != t.type)return;
                const n = t.newText.replace(/\u00A0/g, " "), o = Bi(t.oldText.replace(/\u00A0/g, " "), n), {firstChangeAt:i, insertions:r, deletions:s}=ld(o);
                let a = null;
                e && (a = this.editing.mapper.toModelRange(e.getFirstRange()));
                const c = new $o(t.node, i), l = this.editing.mapper.toModelPosition(c), d = qs.createFromPositionAndShift(l, s), u = n.substr(i, r);
                this.editor.execute("input", {text: u, range: d, resultRange: a})
            }

            _handleTextNodeInsertion(t) {
                if ("children" != t.type)return;
                const e = rd(t), n = new $o(t.node, e.index), o = this.editing.mapper.toModelPosition(n), i = e.values[0].data;
                this.editor.execute("input", {text: i.replace(/\u00A0/g, " "), range: new qs(o)})
            }
        }
        function cd(t) {
        ...
        class dd extends Fl {
            ...
            init() {
                const t = this.editor, e = new ed(t, t.config.get("typing.undoStep") || 20);
                t.commands.add("input", e), nd(t), function (t) {
        ...
        class ud extends ql {
            constructor(t, e) {
                super(t), this.direction = e, this._buffer = new td(t.model, t.config.get("typing.undoStep"))
            }
            ...
            execute(t = {}) {
                ...
                e.enqueueChange(this._buffer.batch, o=> {
                    this._buffer.lock();
                    const i = new Js(n.selection), r = i.isCollapsed;
                    ...
                    i.getFirstRange().getMinimalFlatRanges().forEach(t=> {
                        s += Ko(t.getWalker({singleCharacters: !0, ignoreElementEnd: !0, shallow: !0}))
            ...
            _replaceEntireContentWithParagraph(t) {
                const e = this.editor.model, n = e.document.selection, o = e.schema.getLimitElement(n), i = new Fs("paragraph");
                t.remove(qs.createIn(o)), t.insert(i, o), t.setSelection(i, 0)
            }
        }
        class hd extends cr {
            constructor(t) {
                ...
                let n = 0;
                e.on("keyup", (t, e)=> {
                    e.keyCode != hi.delete && e.keyCode != hi.backspace || (n = 0)
                }), e.on("keydown", (t, o)=> {
                    const i = {};
                    if (o.keyCode == hi.delete)i.direction = "forward", i.unit = "character"; else {
                        if (o.keyCode != hi.backspace)return;
                        i.direction = "backward", i.unit = "codePoint"
                    }
                    const r = li.isMac ? o.altKey : o.ctrlKey;
                    let s;
                    i.unit = r ? "word" : i.unit, i.sequence = ++n, e.once("delete", t=>s = t, {priority: "highest"}), e.fire("delete", new Qr(e, o.domEvent, i)), s && s.stop.called && t.stop()
                })
            }
        ...
        function fd(t) {
            ...
            let i = null, r = new Js(e.document.selection), s = Date.now();
            e.document.selection.on("change", function (t) {
                const e = new Js(t.source);
                ...
                id(a) && function (t) {
                    for (const e of t) {
                        ...
                        if (!md(t))continue;
                        const o = Bi(t, n), i = o.some(t=>"delete" === t), r = o.some(t=>"insert" === t);
                        if (i && !r)return !0
                    }
                    return !1
                }(a) && (!function () {
        ...
        class pd extends Fl {
            ...
            init() {
                const t = this.editor, e = t.editing.view, n = e.document;
                e.addObserver(hd), t.commands.add("forwardDelete", new ud(t, "forward")), t.commands.add("delete", new ud(t, "backward")), this.listenTo(n, "delete", (n, o)=> {
        ...
        function yd(t, e, n) {
            if (t = t.slice(), e = e.slice(), 0 == t.length || 0 == e.length)return {operationsA: t, operationsB: e};
            const o = new WeakMap;
            ...
            }, r = new xd(n.document, n.useRelations);
            r.setOriginalOperations(t), r.setOriginalOperations(e);
            let s = 0;
            for (; s < t.length;) {
                const n = t[s], i = o.get(n);
                if (i == e.length) {
                    s++;
                    continue
                }
                const a = e[i], c = vd(n, a, r.getContext(n, a, !0)), l = vd(a, n, r.getContext(a, n, !1));
            ...
            if (n.padWithNoOps) {
                const n = t.length - i.originalOperationsACount, o = e.length - i.originalOperationsBCount;
                Cd(t, o - n), Cd(e, n - o)
            }
            return Ad(t, i.nextBaseVersionB), Ad(e, i.nextBaseVersionA), {operationsA: t, operationsB: e}
        }

        class xd {
            constructor(t, e) {
                this._history = t.history, this._useRelations = e, this._originalOperations = new Map, this._relations = new Map
            }
            ...
            _getRelation(t, e) {
                const n = this._originalOperations.get(e), o = this._history.getUndoneOperation(n);
                if (!o)return null;
                const i = this._originalOperations.get(t), r = this._relations.get(i);
                return r && r.get(o) || null
            }

            _setRelation(t, e, n) {
                const o = this._originalOperations.get(t), i = this._originalOperations.get(e);
        ...
        function Cd(t, e) {
            for (let n = 0; n < e; n++)t.push(new bd(0))
        }

        function Td(t, e, n) {
            const o = t.nodes.getNode(0).getAttribute(e);
            if (o == n)return null;
            const i = new qs(t.position, t.position.getShiftedBy(t.howMany));
            return new tc(i, e, o, n, 0)
        }
        ...
        function Pd(t, e) {
            const n = [];
            for (let o = 0; o < t.length; o++) {
                const i = t[o], r = new nc(i.start, i.end.offset - i.start.offset, e, 0);
                n.push(r);
        ...
        _d(tc, tc, (t, e, n)=> {
            if (t.key === e.key) {
                const o = t.range.getDifference(e.range).map(e=>new tc(e, t.key, t.oldValue, t.newValue, 0)), i = t.range.getIntersection(e.range);
                return i && n.aIsStrong && o.push(new tc(i, e.key, e.newValue, t.newValue, 0)), 0 == o.length ? [new bd(0)] : o
            }
            return [t]
        }), _d(tc, oc, (t, e)=> {
            if (t.range.start.hasSameParentAs(e.position) && t.range.containsPosition(e.position)) {
                const n = t.range._getTransformedByInsertion(e.position, e.howMany, !e.shouldReceiveAttributes).map(e=>new tc(e, t.key, t.oldValue, t.newValue, t.baseVersion));
                if (e.shouldReceiveAttributes) {
                    const o = Td(e, t.key, t.oldValue);
                    o && n.unshift(o)
                }
                return n
            }
            ...
            const n = [];
            t.range.start.hasSameParentAs(e.deletionPosition) && (t.range.containsPosition(e.deletionPosition) || t.range.start.isEqual(e.deletionPosition)) && n.push(qs.createFromPositionAndShift(e.graveyardPosition, 1));
            const o = t.range._getTransformedByMergeOperation(e);
            return o.isCollapsed || n.push(o), n.map(e=>new tc(e, t.key, t.oldValue, t.newValue, t.baseVersion))
        }), _d(tc, nc, (t, e)=> {
            return function (t, e) {
                const n = qs.createFromPositionAndShift(e.sourcePosition, e.howMany);
                let o = null, i = [];
                ...
                for (let t of i) {
                    ...
                    const n = e.getMovedRangeStart(), o = t.start.hasSameParentAs(n);
                ...
                return r
            }(t.range, e).map(e=>new tc(e, t.key, t.oldValue, t.newValue, t.baseVersion))
        }), _d(tc, cc, (t, e)=> {
            ...
            if (t.range.start.hasSameParentAs(e.splitPosition) && t.range.containsPosition(e.splitPosition)) {
                const n = t.clone();
                return n.range = new qs(Hs.createFromPosition(e.moveTargetPosition), t.range.end._getCombined(e.splitPosition, e.moveTargetPosition)), t.range.end = Hs.createFromPosition(e.splitPosition), t.range.end.stickiness = "toPrevious", [t, n]
            }
            ...
            if (t.shouldReceiveAttributes && t.position.hasSameParentAs(e.range.start) && e.range.containsPosition(t.position)) {
                const o = Td(t, e.key, e.newValue);
                o && n.push(o)
            }
            return n
        }), _d(oc, oc, (t, e, n)=>t.position.isEqual(e.position) && n.aIsStrong ? [t] : (t.position = t.position._getTransformedByInsertOperation(e), [t])), _d(oc, nc, (t, e)=>(t.position = t.position._getTransformedByMoveOperation(e), [t])), _d(oc, cc, (t, e)=>(t.position = t.position._getTransformedBySplitOperation(e), [t])), _d(oc, ac, (t, e)=>(t.position = t.position._getTransformedByMergeOperation(e), [t])), _d(ic, oc, (t, e)=>(t.oldRange && (t.oldRange = t.oldRange._getTransformedByInsertOperation(e)[0]), t.newRange && (t.newRange = t.newRange._getTransformedByInsertOperation(e)[0]), [t])), _d(ic, ic, (t, e, n)=> {
            if (t.name == e.name) {
                if (!n.aIsStrong)return [new bd(0)];
                t.oldRange = e.newRange ? qs.createFromRange(e.newRange) : null
            }
            return [t]
        }), _d(ic, ac, (t, e)=>(t.oldRange && (t.oldRange = t.oldRange._getTransformedByMergeOperation(e)), t.newRange && (t.newRange = t.newRange._getTransformedByMergeOperation(e)), [t])), _d(ic, nc, (t, e)=>(t.oldRange && (t.oldRange = qs.createFromRanges(t.oldRange._getTransformedByMoveOperation(e))), t.newRange && (t.newRange = qs.createFromRanges(t.newRange._getTransformedByMoveOperation(e))), [t])), _d(ic, cc, (t, e)=>(t.oldRange && (t.oldRange = t.oldRange._getTransformedBySplitOperation(e)), t.newRange && (t.newRange = t.newRange._getTransformedBySplitOperation(e)), [t])), _d(ac, oc, (t, e)=>(t.sourcePosition.hasSameParentAs(e.position) && (t.howMany += e.howMany), t.sourcePosition = t.sourcePosition._getTransformedByInsertOperation(e), t.targetPosition = t.targetPosition._getTransformedByInsertOperation(e), [t])), _d(ac, ac, (t, e, n)=> {
            if (t.sourcePosition.isEqual(e.sourcePosition) && t.targetPosition.isEqual(e.targetPosition)) {
                if (n.bWasUndone) {
                    ...
                    return n.push(0), t.sourcePosition = new Hs(e.graveyardPosition.root, n), t.howMany = 0, [t]
                }
                return [new bd(0)]
            }
            if (t.sourcePosition.isEqual(e.sourcePosition) && !t.targetPosition.isEqual(e.targetPosition) && !n.bWasUndone) {
                const o = "$graveyard" == t.targetPosition.root.rootName, i = "$graveyard" == e.targetPosition.root.rootName;
                if (i && !o || !(o && !i) && n.aIsStrong) {
                    const n = e.targetPosition._getTransformedByMergeOperation(e), o = t.targetPosition._getTransformedByMergeOperation(e);
            ...
            const o = qs.createFromPositionAndShift(e.sourcePosition, e.howMany);
            return "remove" == e.type && !n.bWasUndone && t.deletionPosition.hasSameParentAs(e.sourcePosition) && o.containsPosition(t.sourcePosition) ? [new bd(0)] : (t.sourcePosition.hasSameParentAs(e.targetPosition) && (t.howMany += e.howMany), t.sourcePosition.hasSameParentAs(e.sourcePosition) && (t.howMany -= e.howMany), t.sourcePosition = t.sourcePosition._getTransformedByMoveOperation(e), t.targetPosition = t.targetPosition._getTransformedByMoveOperation(e), t.graveyardPosition.isEqual(e.targetPosition) || (t.graveyardPosition = t.graveyardPosition._getTransformedByMoveOperation(e)), [t])
        }), _d(ac, cc, (t, e, n)=> {
            if (e.graveyardPosition && (t.graveyardPosition = t.graveyardPosition._getTransformedByDeletion(e.graveyardPosition, 1), t.deletionPosition.isEqual(e.graveyardPosition) && (t.howMany = e.howMany)), t.targetPosition.isEqual(e.splitPosition)) {
                const o = 0 != e.howMany, i = e.graveyardPosition && t.deletionPosition.isEqual(e.graveyardPosition);
                if (o || i || "mergeTargetNotMoved" == n.abRelation)return t.sourcePosition = t.sourcePosition._getTransformedBySplitOperation(e), [t]
            }
            return t.sourcePosition.isEqual(e.splitPosition) && "mergeSameElement" == n.abRelation ? (t.sourcePosition = Hs.createFromPosition(e.moveTargetPosition), t.targetPosition = t.targetPosition._getTransformedBySplitOperation(e), [t]) : (t.sourcePosition.hasSameParentAs(e.splitPosition) && (t.howMany = e.splitPosition.offset), t.sourcePosition = t.sourcePosition._getTransformedBySplitOperation(e), t.targetPosition = t.targetPosition._getTransformedBySplitOperation(e), [t])
        }), _d(nc, oc, (t, e)=> {
            const n = qs.createFromPositionAndShift(t.sourcePosition, t.howMany)._getTransformedByInsertOperation(e, !1)[0];
            ...
            const o = qs.createFromPositionAndShift(t.sourcePosition, t.howMany), i = qs.createFromPositionAndShift(e.sourcePosition, e.howMany);
            let r, s = n.aIsStrong, a = !n.aIsStrong;
            if ("insertBefore" == n.abRelation ? a = !0 : "insertAfter" == n.abRelation && (a = !1), r = t.targetPosition.isEqual(e.targetPosition) && a ? t.targetPosition._getTransformedByDeletion(e.sourcePosition, e.howMany) : t.targetPosition._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), Md(t, e) && Md(e, t))return [e.getReversed()];
            if (o.containsPosition(e.targetPosition) && o.containsRange(i, !0))return o.start = o.start._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), o.end = o.end._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), Pd([o], r);
            if (i.containsPosition(t.targetPosition) && i.containsRange(o, !0))return o.start = o.start._getCombined(e.sourcePosition, e.getMovedRangeStart()), o.end = o.end._getCombined(e.sourcePosition, e.getMovedRangeStart()), Pd([o], r);
            const c = U(t.sourcePosition.getParentPath(), e.sourcePosition.getParentPath());
            if ("prefix" == c || "extension" == c)return o.start = o.start._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), o.end = o.end._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), Pd([o], r);
            "remove" != t.type || "remove" == e.type || n.aWasUndone ? "remove" == t.type || "remove" != e.type || n.bWasUndone || (s = !1) : s = !0;
            const l = [], d = o.getDifference(i);
            for (const t of d) {
                ...
                const n = "same" == U(t.start.getParentPath(), e.getMovedRangeStart().getParentPath()), o = t._getTransformedByInsertion(e.getMovedRangeStart(), e.howMany, n);
                l.push(...o)
            }
            const u = o.getIntersection(i);
            return null !== u && s && (u.start = u.start._getCombined(e.sourcePosition, e.getMovedRangeStart()), u.end = u.end._getCombined(e.sourcePosition, e.getMovedRangeStart()), 0 === l.length ? l.push(u) : 1 == l.length ? i.start.isBefore(o.start) || i.start.isEqual(o.start) ? l.unshift(u) : l.push(u) : l.splice(1, 0, u)), 0 === l.length ? [new bd(t.baseVersion)] : Pd(l, r)
        }), _d(nc, cc, (t, e, n)=> {
            let o = Hs.createFromPosition(t.targetPosition);
            t.targetPosition.isEqual(e.insertionPosition) && e.graveyardPosition || (o = t.targetPosition._getTransformedBySplitOperation(e));
            const i = qs.createFromPositionAndShift(t.sourcePosition, t.howMany);
            ...
            if (i.start.hasSameParentAs(e.splitPosition) && i.containsPosition(e.splitPosition)) {
                let t = new qs(e.splitPosition, i.end);
                return t = t._getTransformedBySplitOperation(e), Pd([new qs(i.start, e.splitPosition), t], o)
            }
            ...
            return t.sourcePosition = r.start, t.howMany = r.end.offset - r.start.offset, t.targetPosition = o, [t]
        }), _d(nc, ac, (t, e, n)=> {
            const o = qs.createFromPositionAndShift(t.sourcePosition, t.howMany);
            if (e.deletionPosition.hasSameParentAs(t.sourcePosition) && o.containsPosition(e.sourcePosition))if ("remove" == t.type) {
                if (!n.aWasUndone)return [e.getReversed(), t]
            } else if (1 == t.howMany)return n.bWasUndone ? (t.sourcePosition = Hs.createFromPosition(e.graveyardPosition), t.targetPosition = t.targetPosition._getTransformedByMergeOperation(e), [t]) : [new bd(0)];
            const i = qs.createFromPositionAndShift(t.sourcePosition, t.howMany)._getTransformedByMergeOperation(e);
            ...
            if ("same" == U(t.position.path, e.splitPosition.getParentPath()) && !e.graveyardPosition) {
                return [t, new rc(t.position.getShiftedBy(1), t.oldName, t.newName, 0)]
            }
            ...
            return [t]
        }), _d(cc, oc, (t, e)=>(t.splitPosition.hasSameParentAs(e.position) && t.splitPosition.offset < e.position.offset && (t.howMany += e.howMany), t.splitPosition = t.splitPosition._getTransformedByInsertOperation(e), t.insertionPosition = cc.getInsertionPosition(t.splitPosition), [t])), _d(cc, ac, (t, e, n)=> {
            if (!t.graveyardPosition && !n.bWasUndone && t.splitPosition.hasSameParentAs(e.sourcePosition)) {
                const n = e.graveyardPosition.path.slice();
                n.push(0);
                const o = new Hs(e.graveyardPosition.root, n), i = cc.getInsertionPosition(new Hs(e.graveyardPosition.root, n)), r = new cc(o, 0, null, 0);
                return r.insertionPosition = i, t.splitPosition = t.splitPosition._getTransformedByMergeOperation(e), t.insertionPosition = cc.getInsertionPosition(t.splitPosition), t.graveyardPosition = Hs.createFromPosition(r.insertionPosition), t.graveyardPosition.stickiness = "toNext", [r, t]
            }
            return t.splitPosition.hasSameParentAs(e.deletionPosition) && !t.splitPosition.isAfter(e.deletionPosition) && t.howMany--, t.splitPosition.hasSameParentAs(e.targetPosition) && (t.howMany += e.howMany), t.splitPosition = t.splitPosition._getTransformedByMergeOperation(e), t.insertionPosition = cc.getInsertionPosition(t.splitPosition), t.graveyardPosition && (t.graveyardPosition = t.graveyardPosition._getTransformedByMergeOperation(e)), [t]
        }), _d(cc, nc, (t, e, n)=> {
            t.graveyardPosition && (t.graveyardPosition = t.graveyardPosition._getTransformedByMoveOperation(e));
            const o = qs.createFromPositionAndShift(e.sourcePosition, e.howMany);
            if (t.splitPosition.hasSameParentAs(e.sourcePosition) && o.containsPosition(t.splitPosition)) {
                ...
                return t.howMany -= n, t.splitPosition.hasSameParentAs(e.targetPosition) && t.splitPosition.offset < e.targetPosition.offset && (t.howMany += e.howMany), t.splitPosition = Hs.createFromPosition(e.sourcePosition), t.insertionPosition = cc.getInsertionPosition(t.splitPosition), [t]
            }
            return !t.splitPosition.isEqual(e.targetPosition) || "insertAtSource" != n.baRelation && "splitBefore" != n.abRelation ? (t.splitPosition.hasSameParentAs(e.sourcePosition) && t.splitPosition.offset <= e.sourcePosition.offset && (t.howMany -= e.howMany), t.splitPosition.hasSameParentAs(e.targetPosition) && t.splitPosition.offset < e.targetPosition.offset && (t.howMany += e.howMany), t.splitPosition.stickiness = "toNone", t.splitPosition = t.splitPosition._getTransformedByMoveOperation(e), t.splitPosition.stickiness = "toNext", t.graveyardPosition ? t.insertionPosition = t.insertionPosition._getTransformedByMoveOperation(e) : t.insertionPosition = cc.getInsertionPosition(t.splitPosition), [t]) : (t.howMany += e.howMany, t.splitPosition = t.splitPosition._getTransformedByDeletion(e.sourcePosition, e.howMany), t.insertionPosition = cc.getInsertionPosition(t.splitPosition), [t])
        }), _d(cc, cc, (t, e, n)=> {
            ...
            if (t.graveyardPosition && e.graveyardPosition && t.graveyardPosition.isEqual(e.graveyardPosition)) {
                const o = "$graveyard" == t.splitPosition.root.rootName, i = "$graveyard" == e.splitPosition.root.rootName;
                if (i && !o || !(o && !i) && n.aIsStrong) {
                    const n = [];
                    return e.howMany && n.push(new nc(e.moveTargetPosition, e.howMany, e.splitPosition, 0)), t.howMany && n.push(new nc(t.splitPosition, t.howMany, t.moveTargetPosition, 0)), n
                }
                return [new bd(0)]
            }
            ...
            if (e.splitPosition.isEqual(t.insertionPosition) && "splitBefore" == n.baRelation) {
                ...
                n.push(0);
                const o = new Hs(e.insertionPosition.root, n);
                return [t, new nc(t.insertionPosition, 1, o, 0)]
            }
            return t.splitPosition.hasSameParentAs(e.splitPosition) && t.splitPosition.offset < e.splitPosition.offset && (t.howMany -= e.howMany), t.splitPosition = t.splitPosition._getTransformedBySplitOperation(e), t.insertionPosition = cc.getInsertionPosition(t.splitPosition), [t]
        });
        class Sd extends ql {
            constructor(t) {
            ...
            _restoreSelection(t, e, n) {
                ...
                for (const e of t) {
                    const t = Ed(e, n).find(t=>t.start.root != i.graveyard);
                    t && r.push(t)
                }
                r.length && o.change(t=> {
            ...
            _undo(t, e) {
                ...
                i.reverse();
                for (const t of i) {
                    const i = t.baseVersion + 1, r = Array.from(o.history.getOperations(i)), s = yd([t.getReversed()], r, {
                        useRelations: !0,
        ...
        class Id extends Sd {
            execute(t = null) {
                const e = t ? this._stack.findIndex(e=>e.batch == t) : this._stack.length - 1, n = this._stack.splice(e, 1)[0], o = new Ha;
        ...
        class Nd extends Sd {
            execute() {
                const t = this._stack.pop(), e = new Ha;
                this.editor.model.enqueueChange(e, ()=> {
                    const n = t.batch.operations[t.batch.operations.length - 1].baseVersion + 1, o = this.editor.model.document.history.getOperations(n);
        ...
        class Od extends Fl {
            ...
            init() {
                const t = this.editor;
                this._undoCommand = new Id(t), this._redoCommand = new Nd(t), t.commands.add("undo", this._undoCommand), t.commands.add("redo", this._redoCommand), this.listenTo(t.model, "applyOperation", (t, e)=> {
                    const n = e[0];
        ...
        class Rd extends xl {
            ...
            _updateXMLContent() {
                if (this.content) {
                    const t = (new DOMParser).parseFromString(this.content.trim(), "image/svg+xml").querySelector("svg"), e = t.getAttribute("viewBox");
        ...
        class Ld extends xl {
            ...
            _createLabelView(t) {
                const e = new xl, n = this.bindTemplate;
            ...
            _getTooltipString(t, e, n) {
                return t ? "string" == typeof t ? t : (n && (n = function (t) {
                    return li.isMac ? pi(t).map(t=>ui[t.toLowerCase()] || t).reduce((t, e)=>t.slice(-1) in di ? t + e : t + "+" + e) : t
                }(n)), t instanceof Function ? t(e, n) : `${e}${n ? ` (${n})` : ""}`) : ""
            }
        }
        var jd = n(20), Vd = n.n(jd), Fd = n(21), zd = n.n(Fd);
        class Bd extends Fl {
            init() {
                const t = this.editor.t;
                this._addButton("undo", t("az"), "CTRL+Z", Vd.a), this._addButton("redo", t("ba"), "CTRL+Y", zd.a)
            }

            _addButton(t, e, n, o) {
                const i = this.editor;
                i.ui.componentFactory.add(t, r=> {
                    const s = i.commands.get(t), a = new Ld(r);
                    return a.set({
                        label: e,
                        icon: o,
                        keystroke: n,
        ...
        class Hd extends Fl {
            ...
            init() {
                this.set("hasAny", !1), this._actions = new ti({idProperty: "_id"}), this._actions.delegate("add", "remove").to(this)
            }
        ...
        class Wd extends Fl {
            ...
            init() {
                this.loaders = new ti, this.loaders.on("add", ()=>this._updatePendingAction()), this.loaders.on("remove", ()=>this._updatePendingAction()), this._pendingAction = null, this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (t, e)=>e ? t / e * 100 : 0)
            }
            ...
            createLoader(t) {
                if (!this.createUploadAdapter)return fs.a.error("filerepository-no-upload-adapter: Upload adapter is not defined."), null;
                const e = new Yd(t);
            ...
            destroyLoader(t) {
                const e = t instanceof Yd ? t : this.getLoader(t);
                e._destroy(), this.loaders.remove(e)
            }

            _updatePendingAction() {
                const t = this.editor.plugins.get(Hd);
                if (this.loaders.length) {
                    if (!this._pendingAction) {
                        const e = this.editor.t, n = t=>`${e("ao")} ${parseInt(t)}%.`;
        ...
        class Yd {
            constructor(t, e) {
                this.id = E(), this.file = t, this._adapter = e, this._reader = new qd, this.set("status", "idle"), this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (t, e)=>e ? t / e * 100 : 0), this.set("uploadResponse", null)
            }
        ...
        B(Yd, jo);
        const Gd = "ckCsrfToken", $d = 40, Qd = "abcdefghijklmnopqrstuvwxyz0123456789";
        ...
        function Jd() {
            ...
            return t && t.length == $d || (t = function (t) {
                let e = "";
                const n = new Uint8Array(t);
                window.crypto.getRandomValues(n);
                for (let t = 0; t < n.length; t++) {
                    const o = Qd.charAt(n[t] % Qd.length);
        ...
        class Kd {
            ...
            _sendRequest() {
                ...
                t.append("upload", this.loader.file), t.append("ckCsrfToken", Jd()), this.xhr.send(t)
            }
        }
        class Zd {
            constructor(t, e, n) {
                ...
                t.model.document.on("change", (n, i)=> {
                    ...
                    c && t.model.enqueueChange(t=> {
                        const e = qs.createFromParentsAndOffsets(a.parent, 0, a.parent, c[0].length);
            ...
            constructor(t, e, n) {
                ...
                e instanceof RegExp ? o = e : r = e, "string" == typeof n ? i = n : s = n, r = r || (t=> {
                        ...
                        for (; null !== (e = o.exec(t)) && !(e && e.length < 4);) {
                            ...
                            const a = o + r + s, c = [t += e[0].length - a.length, t + o.length], l = [t + o.length + r.length, t + o.length + r.length + s.length];
                    ...
                    }(l).slice(0, o.focus.offset), u = r(d), h = tu(l, u.format), f = tu(l, u.remove);
        ...
        function tu(t, e) {
            return e.filter(t=>void 0 !== t[0] && void 0 !== t[1]).map(e=>qs.createFromParentsAndOffsets(t, e[0], t, e[1]))
        }
        ...
        class eu extends ql {
            ...
            execute(t = {}) {
                const e = this.editor.model, n = e.document.selection, o = void 0 === t.forceValue ? !this.value : t.forceValue;
                e.change(t=> {
        ...
        class ou extends Fl {
            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: nu}), t.conversion.attributeToElement({
                    model: nu,
                    view: "strong",
                    upcastAlso: ["b", {styles: {"font-weight": "bold"}}]
                }), t.commands.add(nu, new eu(t, nu)), t.keystrokes.set("CTRL+B", nu)
            }
        }
        var iu = n(22), ru = n.n(iu);
        const su = "bold";
        class au extends Fl {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add(su, n=> {
                    const o = t.commands.get(su), i = new Ld(n);
                    return i.set({
                        label: e("b"),
                        icon: ru.a,
                        keystroke: "CTRL+B",
                        tooltip: !0
                    }), i.bind("isOn", "isEnabled").to(o, "value", "isEnabled"), this.listenTo(i, "execute", ()=>t.execute(su)), i
                })
            }
        }
        const cu = "italic";
        class lu extends Fl {
            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: cu}), t.conversion.attributeToElement({
                    model: cu,
                    view: "i",
                    upcastAlso: ["em", {styles: {"font-style": "italic"}}]
                }), t.commands.add(cu, new eu(t, cu)), t.keystrokes.set("CTRL+I", cu)
            }
        }
        var du = n(23), uu = n.n(du);
        const hu = "italic";
        class fu extends Fl {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add(hu, n=> {
                    const o = t.commands.get(hu), i = new Ld(n);
                    return i.set({
                        label: e("d"),
                        icon: uu.a,
                        keystroke: "CTRL+I",
                        tooltip: !0
                    }), i.bind("isOn", "isEnabled").to(o, "value", "isEnabled"), this.listenTo(i, "execute", ()=>t.execute(hu)), i
                })
            }
        }
        function mu(t) {
        ...
        class pu extends ql {
            ...
            execute() {
                const t = this.editor.model, e = t.document, n = t.schema, o = Array.from(e.selection.getSelectedBlocks());
                t.change(t=> {
                    if (this.value)this._removeQuote(t, o.filter(gu)); else {
                        const e = o.filter(t=>gu(t) || wu(n, t));
            ...
            _getValue() {
                const t = mu(this.editor.model.document.selection.getSelectedBlocks());
                return !(!t || !gu(t))
            }

            _checkEnabled() {
                if (this.value)return !0;
                const t = this.editor.model.document.selection, e = this.editor.model.schema, n = mu(t.getSelectedBlocks());
                return !!n && wu(e, n)
            }

            _removeQuote(t, e) {
                bu(e).reverse().forEach(e=> {
                    if (e.start.isAtStart && e.end.isAtEnd)return void t.unwrap(e.start.parent);
                    if (e.start.isAtStart) {
                        const n = Hs.createBefore(e.start.parent);
                        return void t.move(e, n)
                    }
                    e.end.isAtEnd || t.split(e.end);
                    const n = Hs.createAfter(e.end.parent);
                    t.move(e, n)
                })
            }
            ...
            _applyQuote(t, e) {
                ...
                bu(e).reverse().forEach(e=> {
                    let o = gu(e.start);
                    o || (o = new Fs("blockQuote"), t.wrap(e, o)), n.push(o)
                }), n.reverse().reduce((e, n)=>e.nextSibling == n ? (t.merge(Hs.createAfter(e)), e) : n)
            }
        }
        function gu(t) {
        ...
        function bu(t) {
            ...
            for (; n < t.length;) {
                const i = t[n], r = t[n + 1];
                e || (e = Hs.createBefore(i)), r && i.nextSibling == r || (o.push(new qs(e, Hs.createAfter(i))), e = null), n++
            }
            return o
        }
        ...
        class _u extends Fl {
            init() {
                ...
                t.commands.add("blockQuote", new pu(t)), e.register("blockQuote", {
                    allowWhere: "$block",
                    allowContentOf: "$root"
                }), e.addChildCheck((t, e)=> {
                    ...
                    for (const t of o)if ("insert" == t.type) {
                        ...
                        if (o.is("element")) {
                            const t = qs.createIn(o);
                            for (const o of t.getItems())if (o.is("blockQuote") && !e.checkChild(Hs.createBefore(o), o))return n.unwrap(o), !0
                        }
        ...
        var ku = n(24), vu = n.n(ku);
        n(61);
        class yu extends Fl {
            init() {
                const t = this.editor, e = t.t;
                t.ui.componentFactory.add("blockQuote", n=> {
                    const o = t.commands.get("blockQuote"), i = new Ld(n);
                    return i.set({
                        label: e("c"),
                        icon: vu.a,
                        tooltip: !0
        ...
        class Au {
            constructor(t, e, n) {
                ...
                this.file = function (t) {
                    ...
                    try {
                        const n = t.match(xu)[1], o = atob(t.replace(xu, "")), i = [];
        ...
        B(Au, R);
        var Cu = Au;
        const Tu = {refreshInterval: 36e5, autoRefresh: !0};
        class Mu {
            constructor(t, e = Tu) {
                if (!t)throw new Error("`tokenUrl` must be provided");
                this.set("value", e.initValue), this._tokenUrl = t, this._options = Object.assign({}, Tu, e)
            }
            ...
            static create(t, e = Tu) {
                return new Mu(t, e).init()
            }
        }
        B(Mu, jo);
        var Pu = Mu;
        class Su extends Fl {
            ...
            init() {
                ...
                if (this.tokenUrl)return this.token = new Su.Token(this.tokenUrl), this.token.init();
                this.token = null
            }
        }
        Su.Token = Pu;
        class Eu extends Fl {
            ...
            init() {
                const t = this.editor, e = t.plugins.get(Su), n = e.token, o = e.uploadUrl;
                n && (this._uploadGateway = new Eu._UploadGateway(n, o), t.plugins.get(Wd).createUploadAdapter = (t=>new Iu(this._uploadGateway, t)))
            }
        }
        class Iu {
            constructor(t, e) {
        ...
        Eu._UploadGateway = class {
            ...
            upload(t) {
                return new Cu(t, this._token, this._apiAddress)
            }
        };
        class Nu extends cr {
            constructor(t) {
        ...
        class Ru {
            ...
            add(t, e) {
                ...
                const i = n[0];
                o === i || Du(o, i) || this.fire("change:top", {oldDescriptor: o, newDescriptor: i, writer: e})
            }
        ...
        function Du(t, e) {
            return t && e && t.priority == e.priority && ju(t.classes) == ju(e.classes)
        }

        function Lu(t, e) {
            return t.priority > e.priority || !(t.priority < e.priority) && ju(t.classes) > ju(e.classes)
        }
        ...
        B(Ru, R);
        var Vu = n(25), Fu = n.n(Vu);
        const zu = Symbol("isWidget"), Bu = Symbol("label"), Uu = "ck-widget", Hu = "ck-widget_selected";

        function qu(t) {
            return !!t.getCustomProperty(zu)
        }

        function Wu(t, e, n = {}) {
            return li.isEdge || e.setAttribute("contenteditable", "false", t), e.addClass(Uu, t), e.setCustomProperty(zu, !0, t), t.getFillerOffset = Qu, n.label && function (t, e, n) {
                n.setCustomProperty(Bu, e, t)
                ...
                const n = e.createUIElement("div", {class: "ck ck-widget__selection-handler"}, function (t) {
                    const e = this.toDomElement(t), n = new Rd;
                    return n.set("content", Fu.a), n.render(), e.appendChild(n.element), e
                });
                e.insert($o.createAt(t), n), e.addClass(["ck-widget_selectable"], t)
        ...
        function Yu(t) {
            const e = t.getCustomProperty(Bu);
            return e ? "function" == typeof e ? e() : e : ""
        }

        function Gu(t, e) {
            return e.addClass(["ck-editor__editable", "ck-editor__nested-editable"], t), li.isEdge || (e.setAttribute("contenteditable", t.isReadOnly ? "false" : "true", t), t.on("change:isReadOnly", (n, o, i)=> {
        ...
        function $u(t) {
            ...
            if (e)return Hs.createAfter(e);
            const n = t.getSelectedBlocks().next().value;
            if (n) {
                if (n.isEmpty)return Hs.createAt(n);
                const e = Hs.createAfter(n);
                return t.focus.isTouching(e) ? e : Hs.createBefore(n)
            }
            return t.focus
        }
        ...
        const Ju = Symbol("isImage");

        function Ku(t) {
            const e = t.getSelectedElement();
            return !(!e || !function (t) {
                return !!t.getCustomProperty(Ju) && qu(t)
            }(e))
        }

        function Zu(t) {
            return t instanceof Fs && "image" == t.name
        }

        class Xu extends Fl {
            init() {
                const t = this.editor, e = t.model.schema, n = t.t, o = t.conversion;
                t.editing.view.addObserver(Nu), e.register("image", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    allowAttributes: ["alt", "src", "srcset"]
                }), o.for("dataDowncast").add(aa({
                    model: "image",
                    view: (t, e)=>th(e)
                })), o.for("editingDowncast").add(aa({
                    model: "image", view: (t, e)=>(function (t, e, n) {
                        return e.setCustomProperty(Ju, !0, t), Wu(t, e, {
                            label: function () {
                ...
                })), o.for("downcast").add(Ou("src")).add(Ou("alt")).add(function () {
                    return e=> {
                ...
                })).add(Da({view: {name: "img", key: "alt"}, model: "alt"})).add(Da({
                    ...
                    function t(t, e, n) {
                        ...
                        const i = n.convertItem(o, e.modelCursor), r = mu(i.modelRange.getItems());
                        r && (n.convertChildren(e.viewItem, Hs.createAt(r)), e.modelRange = i.modelRange, e.modelCursor = i.modelCursor)
                    }
                }())
            }
        }
        function th(t) {
            ...
            return t.insert($o.createAt(n), e), n
        }
        ...
        class oh extends Fl {
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n)=> {
                    ...
                    for (const t of i.getRanges())for (const e of t) {
                        const t = e.item;
                        t.is("element") && qu(t) && (o.addClass(Hu, t), this._previouslySelected.add(t), t == r && o.setSelection(i.getRanges(), {
                            fake: !0,
                            label: Yu(r)
                        }))
                    }
                }, {priority: "low"}), t.addObserver(eh), this.listenTo(e, "mousedown", (...t)=>this._onMousedown(...t)), this.listenTo(e, "keydown", (...t)=>this._onKeydown(...t), {priority: "high"}), this.listenTo(e, "delete", (t, e)=> {
            ...
            _onMousedown(t, e) {
                ...
                if (function (t) {
                        for (; t;) {
                            if (t instanceof qo && !(t instanceof Yo))return !0;
                            t = t.parent
                        }
                        return !1
                    }(r))return;
                if (!qu(r) && !(r = r.findAncestor(qu)))return;
            ...
            _onKeydown(t, e) {
                const n = e.keyCode, o = n == hi.delete || n == hi.arrowdown || n == hi.arrowright;
                let i = !1;
                !function (t) {
                    return t == hi.arrowright || t == hi.arrowleft || t == hi.arrowup || t == hi.arrowdown
                }(n) ? !function (t) {
                    return fi(t) == nh
                }(e) ? n === hi.enter && (i = this._handleEnterKey(e.shiftKey)) : i = this._selectAllNestedEditableContent() || this._selectAllContent() : i = this._handleArrowKeys(o), i && (e.preventDefault(), t.stop())
            }
            ...
            _handleArrowKeys(t) {
                ...
                if (i && n.isObject(i)) {
                    const i = t ? o.getLastPosition() : o.getFirstPosition(), r = n.getNearestSelectionRange(i, t ? "forward" : "backward");
                    return r && e.change(t=> {
                        t.setSelection(r)
                    }), !0
                }
                ...
                return r instanceof Fs && n.isObject(r) ? (this._setSelectionOverElement(r), !0) : void 0
            }
            ...
            _selectAllNestedEditableContent() {
                ...
                return e.getFirstRange().root != n && (t.change(t=> {
                        t.setSelection(qs.createIn(n))
                    }), !0)
            }

            _selectAllContent() {
                const t = this.editor.model, e = this.editor.editing, n = e.view.document.selection.getSelectedElement();
                if (n && qu(n)) {
                    const o = e.mapper.toModelElement(n.parent);
                    return t.change(t=> {
                        t.setSelection(qs.createIn(o))
                    }), !0
                }
                return !1
            }
            ...
            _setSelectionOverElement(t) {
                this.editor.model.change(e=> {
                    e.setSelection(qs.createOn(t))
                })
            }

            _getObjectElementNextToSelection(t) {
                const e = this.editor.model, n = e.schema, o = e.document.selection, i = new Js(o);
                e.modifySelection(i, {direction: t ? "forward" : "backward"});
                const r = t ? i.focus.nodeBefore : i.focus.nodeAfter;
                return r instanceof Fs && n.isObject(r) ? r : null
            }

            _clearPreviouslySelectedWidgets(t) {
                for (const e of this._previouslySelected)t.removeClass(Hu, e);
        ...
        class ih extends ql {
            refresh() {
                ...
                this.isEnabled = Zu(t), Zu(t) && t.hasAttribute("alt") ? this.value = t.getAttribute("alt") : this.value = !1
            }
        ...
        class rh extends Fl {
            init() {
                this.editor.commands.add("imageTextAlternative", new ih(this.editor))
            }
        }
        function sh({emitter:t, activator:e, callback:n, contextElements:o}) {
        ...
        class ah extends xl {
            constructor(t, e) {
                super(t);
                const n = `ck-input-${E()}`, o = `ck-error-${E()}`;
                this.set("label"), this.set("value"), this.set("isReadOnly", !1), this.set("errorText", null), this.labelView = this._createLabelView(n), this.inputView = this._createInputView(e, n, o), this.errorView = this._createErrorView(o);
                const i = this.bindTemplate;
                this.setTemplate({
                    tag: "div",
                    attributes: {class: ["ck", "ck-labeled-input", i.if("isReadOnly", "ck-disabled")]},
                    children: [this.labelView, this.inputView, this.errorView]
                })
            }

            _createLabelView(t) {
                const e = new Cl(this.locale);
            ...
            _createErrorView(t) {
                const e = new xl(this.locale), n = this.bindTemplate;
                return e.setTemplate({
                    tag: "div",
                    attributes: {
                        class: ["ck", "ck-labeled-input__error", n.if("errorText", "ck-hidden", t=>!t)],
                        id: t
                    },
                    children: [{text: n.to("errorText")}]
                }), e
            }
        ...
        class mh extends xl {
            ...
            render() {
                super.render(), this.keystrokes.listenTo(this.element), lh({view: this}), [this.labeledInput, this.saveButtonView, this.cancelButtonView].forEach(t=> {
                    this._focusables.add(t), this.focusTracker.add(t.element)
                })
            }

            _createButton(t, e, n, o) {
                const i = new Ld(this.locale);
                return i.set({
                    label: t,
                    icon: e,
                    tooltip: !0
            ...
            _createLabeledInputView() {
                const t = this.locale.t, e = new ah(this.locale, ch);
                return e.label = t("ay"), e.inputView.placeholder = t("ay"), e
            }
        }
        function ph(t, e, n) {
        ...
        function gh({left:t, top:e}) {
            const {scrollX:n, scrollY:o}=Ki.window;
            return {left: t + n, top: e + o}
        }

        n(71);
        const bh = Sl("px"), wh = Ki.document.body;
        class _h extends xl {
            constructor(t) {
                super(t);
                const e = this.bindTemplate;
                this.set("top", 0), this.set("left", 0), this.set("position", "arrow_nw"), this.set("isVisible", !1), this.set("withArrow", !0), this.set("className"), this.content = this.createCollection(), this.setTemplate({
                    ...
                    attributes: {
                        ...
                        style: {top: e.to("top", bh), left: e.to("left", bh)}
                    },
                    children: this.content
                })
            }
            ...
            attachTo(t) {
                this.show();
                const e = _h.defaultPositions, n = Object.assign({}, {
                    ...
                    limiter: wh,
                    fitInViewport: !0
                }, t), {top:o, left:i, name:r}=_h._getOptimalPosition(n);
            ...
            _startPinning(t) {
                this.attachTo(t);
                const e = kh(t.target), n = t.limiter ? kh(t.limiter) : wh;
                this.listenTo(Ki.document, "scroll", (o, i)=> {
                    const r = i.target, s = e && r.contains(e), a = n && r.contains(n);
                    !s && !a && e && n || this.attachTo(t)
                }, {useCapture: !0}), this.listenTo(Ki.window, "resize", ()=> {
                    this.attachTo(t)
                })
            }

            _stopPinning() {
                this.stopListening(Ki.document, "scroll"), this.stopListening(Ki.window, "resize")
            }
        }
        function kh(t) {
            return tr(t) ? t : bs(t) ? t.commonAncestorContainer : "function" == typeof t ? kh(t()) : null
        }

        function vh(t, e) {
            return t.top - e.height - _h.arrowVerticalOffset
        }

        function yh(t) {
            return t.bottom + _h.arrowVerticalOffset
        }

        _h.arrowHorizontalOffset = 25, _h.arrowVerticalOffset = 10, _h._getOptimalPosition = function ({element:t, target:e, positions:n, limiter:o, fitInViewport:i}) {
            ct(e) && (e = e()), ct(o) && (o = o());
            const r = function (t) {
                for (; t && "html" != t.tagName.toLowerCase();) {
                    if ("static" != Ki.window.getComputedStyle(t).position)return t;
                    t = t.parentElement
                }
                return null
            }(t.parentElement), s = new ks(t), a = new ks(e);
            let c, l;
            if (o || i) {
                const t = o && new ks(o).getVisible(), e = i && new ks(Ki.window);
                [l, c] = function (t, e, n, o, i) {
                    ...
                    }(n, a, s, t, e) || ph(n[0], a, s)
            } else[l, c] = ph(n[0], a, s);
            let {left:d, top:u}=gh(c);
            if (r) {
                const t = gh(new ks(r)), e = ws(r);
            ...
            northArrowSouthEast: (t, e)=>({
                top: vh(t, e),
                left: t.left + t.width / 2 - e.width + _h.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northArrowSouthWest: (t, e)=>({
                top: vh(t, e),
                left: t.left + t.width / 2 - _h.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            northWestArrowSouth: (t, e)=>({top: vh(t, e), left: t.left - e.width / 2, name: "arrow_s"}),
            northWestArrowSouthWest: (t, e)=>({
                top: vh(t, e),
                left: t.left - _h.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            northWestArrowSouthEast: (t, e)=>({
                top: vh(t, e),
                left: t.left - e.width + _h.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northEastArrowSouth: (t, e)=>({top: vh(t, e), left: t.right - e.width / 2, name: "arrow_s"}),
            northEastArrowSouthEast: (t, e)=>({
                top: vh(t, e),
                left: t.right - e.width + _h.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northEastArrowSouthWest: (t, e)=>({
                top: vh(t, e),
                left: t.right - _h.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            southArrowNorth: (t, e)=>({top: yh(t), left: t.left + t.width / 2 - e.width / 2, name: "arrow_n"}),
            ...
            southWestArrowNorth: (t, e)=>({top: yh(t), left: t.left - e.width / 2, name: "arrow_n"}),
            southWestArrowNorthWest: (t, e)=>({top: yh(t), left: t.left - _h.arrowHorizontalOffset, name: "arrow_nw"}),
            southWestArrowNorthEast: (t, e)=>({
                top: yh(t),
                left: t.left - e.width + _h.arrowHorizontalOffset,
                name: "arrow_ne"
            }),
            southEastArrowNorth: (t, e)=>({top: yh(t), left: t.right - e.width / 2, name: "arrow_n"}),
            southEastArrowNorthEast: (t, e)=>({
                top: yh(t),
                left: t.right - e.width + _h.arrowHorizontalOffset,
                name: "arrow_ne"
            }),
            southEastArrowNorthWest: (t, e)=>({top: yh(t), left: t.right - _h.arrowHorizontalOffset, name: "arrow_nw"})
        };
        class xh extends Fl {
            static get pluginName() {
            ...
            init() {
                this.view = new _h, this.positionLimiter = (()=> {
        ...
        var Ah = n(26), Ch = n.n(Ah);

        function Th(t) {
            const e = t.editing.view, n = _h.defaultPositions;
            return {
        ...
        class Mh extends Fl {
            ...
            _createButton() {
                ...
                t.ui.componentFactory.add("imageTextAlternative", n=> {
                    const o = t.commands.get("imageTextAlternative"), i = new Ld(n);
                    return i.set({
                        label: e("ap"),
                        icon: Ch.a,
                        tooltip: !0
            ...
            _createForm() {
                ...
                this._balloon = this.editor.plugins.get("ContextualBalloon"), this._form = new mh(t.locale), this._form.render(), this.listenTo(this._form, "submit", ()=> {
                    ...
                    Ku(e.selection) ? this._isVisible && function (t) {
                        const e = t.plugins.get("ContextualBalloon");
                        if (Ku(t.editing.view.document.selection)) {
                            const n = Th(t);
                            e.updatePosition(n)
                        }
                    }(t) : this._hideForm(!0)
        ...
        class Eh extends xl {
            constructor(t) {
                super(t), this.buttonView = new Ld(t), this._fileInputView = new Ih(t), this._fileInputView.bind("acceptedType").to(this), this._fileInputView.bind("allowMultipleFiles").to(this), this._fileInputView.delegate("done").to(this), this.setTemplate({
                    tag: "span",
        ...
        class Dh extends Fl {
            init() {
                ...
                t.ui.componentFactory.add("imageUpload", n=> {
                    const o = new Eh(n), i = t.commands.get("imageUpload");
                    return o.set({acceptedType: "image/*", allowMultipleFiles: !0}), o.buttonView.set({
                        label: e("e"),
                        icon: Oh.a,
                        tooltip: !0
                    }), o.buttonView.bind("isEnabled").to(i), o.on("done", (e, n)=> {
                        const o = Array.from(n).filter(Rh);
                        o.length && t.execute("imageUpload", {files: o})
                    }), o
                })
            }
        }
        var Lh = n(28), jh = n.n(Lh);
        n(75), n(77), n(79);
        class Vh extends Fl {
            constructor(t) {
                super(t), this.placeholder = "data:image/svg+xml;utf8," + encodeURIComponent(jh.a)
            }
            ...
            uploadStatusChange(t, e, n) {
                ...
                if (!n.consumable.consume(e.item, t.name))return;
                const s = o.plugins.get(Wd), a = r ? e.attributeNewValue : null, c = this.placeholder, l = o.editing.mapper.toViewElement(i), d = n.writer;
                if ("reading" == a)return Bh(l, d), void Uh(c, l, d);
                if ("uploading" == a) {
                    const t = s.loaders.get(r);
                    return Bh(l, d), void(t ? (Hh(l, d), function (t, e, n, o) {
                        const i = function (t) {
                            const e = t.createUIElement("div", {class: "ck-progress-bar"});
                            return t.setCustomProperty(Fh, !0, e), e
                        }(e);
                        e.insert($o.createAt(t, "end"), i), n.on("change:uploadedPercent", (t, e, n)=> {
                            o.change(t=> {
                                t.setStyle("width", n + "%", i)
                            })
                        })
                    }(l, d, t, o.editing.view)) : Uh(c, l, d))
                }
                "complete" == a && s.loaders.get(r) && !li.isEdge && function (t, e, n) {
                    const o = new gi("div", {class: "ck-image-upload-complete-icon"});
                    e.insert($o.createAt(t, "end"), o), setTimeout(()=> {
                        n.change(t=>t.remove(Qo.createOn(o)))
                    }, 3e3)
                }(l, d, o.editing.view), function (t, e) {
                    Wh(t, e, Fh)
                }(l, d), Hh(l, d), function (t, e) {
                    e.removeClass("ck-appear", t)
                }(l, d)
            }
        }
        const Fh = Symbol("progress-bar"), zh = Symbol("placeholder");
        ...
        function Uh(t, e, n) {
            ...
            o.getAttribute("src") !== t && n.setAttribute("src", t, o), qh(e, zh) || n.insert($o.createAfter(o), function (t) {
                const e = t.createUIElement("div", {class: "ck-upload-placeholder-loader"});
                return t.setCustomProperty(zh, !0, e), e
            }(n))
        }

        function Hh(t, e) {
            t.hasClass("ck-image-upload-placeholder") && e.removeClass("ck-image-upload-placeholder", t), Wh(t, e, zh)
        }
        ...
        function Wh(t, e, n) {
            const o = qh(t, n);
            o && e.remove(Qo.createOn(o))
        }

        class Yh extends ql {
            refresh() {
                const t = this.editor.model, e = t.document.selection, n = t.schema;
                this.isEnabled = function (t, e) {
                        const n = function (t) {
                            let e = $u(t).parent;
                            e.is("$root") || (e = e.parent);
                            return e
                        }(t);
                        return e.checkChild(n, "image")
                    }(e, n) && function (t, e) {
                        const n = t.getSelectedElement(), o = !!n && e.isObject(n), i = !![...t.focus.getAncestors()].find(t=>e.isObject(t));
                        return !o && !i
                    }(e, n)
            }
            ...
            execute(t) {
                const e = this.editor;
                e.model.change(n=> {
                    const o = Array.isArray(t.files) ? t.files : [t.files];
                    for (const t of o)Gh(n, e, t)
                })
            }
        }
        function Gh(t, e, n) {
            const o = e.model.document, i = e.plugins.get(Wd).createLoader(n);
            if (!i)return;
            const r = t.createElement("image", {uploadId: i.id}), s = $u(o.selection);
            e.model.insertContent(r, s), r.parent && t.setSelection(r, "on")
        }
        ...
        class Qh extends Fl {
            ...
            init() {
                const t = this.editor, e = t.model.document, n = t.model.schema, o = t.plugins.get(Wd);
                n.extend("image", {allowAttributes: ["uploadId", "uploadStatus"]}), t.commands.add("imageUpload", new Yh(t)), this.listenTo(t.editing.view.document, "clipboardInput", (e, n)=> {
                    if (function (t) {
                            return Array.from(t.types).includes("text/html") && "" !== t.getData("text/html")
                        }(n.dataTransfer))return;
                    const o = Array.from(n.dataTransfer.files).filter(Rh), i = new Js(n.targetRanges.map(e=>t.editing.mapper.toModelRange(e)));
                    t.model.change(n=> {
                        n.setSelection(i), o.length && (e.stop(), t.model.enqueueChange("default", ()=> {
                            t.execute("imageUpload", {files: o})
                        }))
                    })
                    ...
                    for (const e of t)if ("insert" == e.type && "image" == e.name) {
                        const t = e.position.nodeAfter, n = "$graveyard" == e.position.root.rootName, i = t.getAttribute("uploadId");
                        if (!i)continue;
            ...
            _readAndUpload(t, e) {
                const n = this.editor, o = n.model, i = n.locale.t, r = n.plugins.get(Wd), s = n.plugins.get($h);
        ...
        class Kh extends ql {
            refresh() {
                const t = this.editor.model, e = mu(t.document.selection.getSelectedBlocks());
                this.value = !!e && e.is("paragraph"), this.isEnabled = !!e && Zh(e, t.schema)
            }
            ...
            execute(t = {}) {
                ...
                e.change(o=> {
                    ...
                    for (const t of i)!t.is("paragraph") && Zh(t, e.schema) && o.rename(t, "paragraph")
                })
            }
        }
        function Zh(t, e) {
        ...
        class Xh extends Fl {
            ...
            init() {
                ...
                t.commands.add("paragraph", new Kh(t)), e.schema.register("paragraph", {inheritAllFrom: "$block"}), t.conversion.elementToElement({
                    model: "paragraph",
                    view: "p"
                }), n.upcastDispatcher.on("element", (t, e, n)=> {
                    if (n.consumable.test(e.viewItem, {name: e.viewItem.name}))if (Xh.paragraphLikeElements.has(e.viewItem.name)) {
                        ...
                        const {modelRange:i}=n.convertChildren(e.viewItem, Hs.createAt(t));
                        e.modelRange = new qs(Hs.createBefore(t), i.end), e.modelCursor = e.modelRange.end
                    } else ef(e.viewItem, e.modelCursor, n.schema) && (e = Object.assign(e, tf(e.viewItem, e.modelCursor, n)))
                }, {priority: "low"}), n.upcastDispatcher.on("text", (t, e, n)=> {
                    e.modelRange || ef(e.viewItem, e.modelCursor, n.schema) && (e = Object.assign(e, tf(e.viewItem, e.modelCursor, n)))
        ...
        function tf(t, e, n) {
            ...
            return n.writer.insert(o, e), n.convertItem(t, Hs.createAt(o))
        }
        ...
        Xh.paragraphLikeElements = new Set(["blockquote", "dd", "div", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "li", "p", "td"]);
        class nf extends ql {
            constructor(t, e) {
            ...
            refresh() {
                const t = mu(this.editor.model.document.selection.getSelectedBlocks());
                this.value = !!t && this.modelElements.includes(t.name) && t.name, this.isEnabled = !!t && this.modelElements.some(e=>of(t, e, this.editor.model.schema))
            }

            execute(t) {
                const e = this.editor.model, n = e.document, o = t.value;
                e.change(t=> {
                    const i = Array.from(n.selection.getSelectedBlocks()).filter(t=>of(t, o, e.schema));
        ...
        class sf extends Fl {
            ...
            init() {
                ...
                for (const o of e)o.model !== rf && (t.model.schema.register(o.model, {inheritAllFrom: "$block"}), t.conversion.elementToElement(o), n.push(o.model));
                t.commands.add("heading", new nf(t, n))
            }
            ...
            afterInit() {
                ...
                e && this.listenTo(e, "afterExecute", (e, o)=> {
                    ...
                    n.some(t=>i.is(t.model)) && !i.is(rf) && 0 === i.childCount && o.writer.rename(i, rf)
                })
            }
        }
        class af {
            constructor(t, e) {
                e && No(this, e), t && this.set(t)
            }
        }
        B(af, jo);
        class cf extends xl {
        ...
        class lf extends xl {
            constructor(t, e, n) {
                ...
                this.buttonView = e, this.panelView = n, this.set("isOpen", !1), this.set("isEnabled", !0), this.focusTracker = new Kc, this.keystrokes = new Uc, this.setTemplate({
                    tag: "div",
        ...
        class hf extends Ld {
            ...
            _createArrowView() {
                const t = new Rd;
                return t.content = uf.a, t.extendTemplate({attributes: {class: "ck-dropdown__arrow"}}), t
            }
        }
        n(83);
        class ff extends xl {
            constructor() {
                super(), this.items = this.createCollection(), this.focusTracker = new Kc, this.keystrokes = new Uc, this._focusCycler = new Nl({
                    focusables: this.items,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
        ...
        n(87), n(89);
        function bf(t, e = hf) {
            const n = new e(t), o = new cf(t), i = new lf(t, n, o);
            return n.bind("isEnabled").to(i), n instanceof hf ? n.bind("isOn").to(i, "isOpen") : n.arrowView.bind("isOn").to(i, "isOpen"), function (t) {
                (function (t) {
                    t.on("render", ()=> {
                        sh({
                    ...
                    t.on("execute", e=> {
                        e.source instanceof gf || (t.isOpen = !1)
                    })
                }(t), function (t) {
        ...
        function wf(t, e) {
            const n = t.locale, o = t.listView = new ff(n);
            o.items.bindTo(e).using(({type:t, model:e})=> {
                if ("separator" === t)return new pf(n);
                if ("button" === t || "switchbutton" === t) {
                    const o = new mf(n);
                    let i;
                    return (i = "button" === t ? new Ld(n) : new gf(n)).bind(...Object.keys(e)).to(e), i.delegate("execute").to(o), o.children.add(i), o
                }
        ...
        class _f extends Fl {
            init() {
                ...
                t.ui.componentFactory.add("heading", e=> {
                    const r = {}, s = new ti, a = t.commands.get("heading"), c = t.commands.get("paragraph"), l = [a];
                    for (const t of n) {
                        const e = {type: "button", model: new af({label: t.title, class: t.class, withText: !0})};
                    ...
                    const d = bf(e);
                    return wf(d, s), d.buttonView.set({
                        isOn: !1,
                        withText: !0,
                        tooltip: i
        ...
        function vf(t, e, n, o) {
            const i = t.document;
            kf.has(i) || (kf.set(i, new Map), i.registerPostFixer(t=>(function (t, e) {
                const n = kf.get(t);
                let o = !1;
                for (const [t,i]of n)yf(e, t, i) && (o = !0);
                return o
            })(i, t))), kf.get(i).set(e, {placeholderText: n, checkFunction: o}), t.render()
        }
        ...
        const xf = Symbol("imageCaption");

        function Af(t) {
            for (const e of t.getChildren())if (e instanceof Fs && "caption" == e.name)return e;
            return null
        }
        ...
        class Tf extends Fl {
            init() {
                ...
                n.register("caption", {
                    ...
                    isLimit: !0
                }), t.model.document.registerPostFixer(t=>this._insertMissingModelCaptionElement(t)), t.conversion.for("upcast").add(Oa({
                    view: Cf,
                    model: "caption"
                }));
                o.downcastDispatcher.on("insert:caption", Mf(t=>t.createContainerElement("figcaption"), !1));
                const s = function (t, e) {
                    return n=> {
                        const o = n.createEditableElement("figcaption");
                        return n.setCustomProperty(xf, !0, o), vf(t, o, e), Gu(o, n)
                    }
                }(e, r("f"));
                i.downcastDispatcher.on("insert:caption", Mf(s)), i.downcastDispatcher.on("insert", this._fixCaptionVisibility(t=>t.item), {priority: "high"}), i.downcastDispatcher.on("remove", this._fixCaptionVisibility(t=>t.position.parent), {priority: "high"}), e.document.registerPostFixer(t=>this._updateCaptionVisibility(t))
            }
            ...
            _updateCaptionVisibility(t) {
                ...
                const s = Pf(i.getFirstPosition().parent);
                if (s && (o = e.toViewElement(s)), o)return n ? n === o ? Ef(o, t) : (Sf(n, t), this._lastSelectedCaption = o, Ef(o, t)) : (this._lastSelectedCaption = o, Ef(o, t));
                if (n) {
                    const e = Sf(n, t);
            ...
            _fixCaptionVisibility(t) {
                return (e, n, o)=> {
                    const i = Pf(t(n)), r = this.editor.editing.mapper, s = o.writer;
                    if (i) {
            ...
            _insertMissingModelCaptionElement(t) {
                ...
                for (const n of e)if ("insert" == n.type && "image" == n.name) {
                    ...
                    if (!Af(e))return t.appendElement("caption", e), !0
                }
            }
        }
        function Mf(t, e = !0) {
        ...
        class If extends ql {
            ...
            refresh() {
                const t = this.editor.model.document.selection.getSelectedElement();
                if (this.isEnabled = Zu(t), t)if (t.hasAttribute("imageStyle")) {
        ...
        var Of = n(13), Rf = n.n(Of), Df = n(14), Lf = n.n(Df), jf = n(15), Vf = n.n(jf), Ff = n(10), zf = n.n(Ff);
        const Bf = {
            full: {name: "full", title: "Full size image", icon: Rf.a, isDefault: !0},
            side: {name: "side", title: "Side image", icon: zf.a, className: "image-style-side"},
            alignLeft: {
                name: "alignLeft",
        ...
        }, Uf = {full: Rf.a, left: Lf.a, right: zf.a, center: Vf.a};

        function Hf(t = []) {
            return t.map(qf).map(t=>Object.assign({}, t))
        }

        function qf(t) {
            if ("string" == typeof t) {
                const e = t;
                Bf[e] ? t = Object.assign({}, Bf[e]) : (fs.a.warn("image-style-not-found: There is no such image style of given name.", {name: e}), t = {name: e})
            } else if (Bf[t.name]) {
                const e = Bf[t.name], n = Object.assign({}, t);
                for (const o in e)t.hasOwnProperty(o) || (n[o] = e[o]);
                t = n
            }
            return "string" == typeof t.icon && Uf[t.icon] && (t.icon = Uf[t.icon]), t
        }
        ...
        class Wf extends Fl {
            ...
            init() {
                ...
                const i = Hf(t.config.get("image.styles"));
                e.extend("image", {allowAttributes: "imageStyle"});
                const r = function (t) {
                    return (e, n, o)=> {
                        if (!o.consumable.consume(n.item, e.name))return;
                        const i = Nf(n.attributeNewValue, t), r = Nf(n.attributeOldValue, t), s = o.mapper.toViewElement(n.item), a = o.writer;
                ...
                o.downcastDispatcher.on("attribute:imageStyle:image", r), n.downcastDispatcher.on("attribute:imageStyle:image", r), n.upcastDispatcher.on("element:figure", function (t) {
                    ...
                    return (t, n, o)=> {
                        ...
                        const i = n.viewItem, r = mu(n.modelRange.getItems());
                ...
                }(i), {priority: "low"}), t.commands.add("imageStyle", new If(t, i))
            }
        }
        n(96);
        class Yf extends Fl {
            ...
            init() {
                const t = function (t, e) {
                    ...
                    return t
                }(Hf(this.editor.config.get("image.styles")), this.localizedDefaultStylesTitles);
            ...
            _createButton(t) {
                ...
                e.ui.componentFactory.add(n, n=> {
                    const o = e.commands.get("imageStyle"), i = new Ld(n);
                    return i.set({
                        label: t.title,
                        icon: t.icon,
                        tooltip: !0
        ...
        class Gf extends Fl {
            ...
            init() {
                ...
                }, {priority: "high"}), this._toolbars = new Map, this._balloon = this.editor.plugins.get("ContextualBalloon"), this.listenTo(t.ui, "update", ()=> {
            ...
            register(t, {items:e, visibleWhen:n, balloonClassName:o = "ck-toolbar-container"}) {
                const i = this.editor, r = new Dl;
                if (this._toolbars.has(t))throw new M.b("widget-toolbar-duplicated: Toolbar with the given id was already added.", {toolbarId: t});
                r.fillFromConfig(e, i.ui.componentFactory), this._toolbars.set(t, {
                    view: r,
                    visibleWhen: n,
                    balloonClassName: o
                })
            ...
            _updateToolbarsVisibility() {
                for (const t of this._toolbars.values())this.editor.ui.focusTracker.isFocused && t.visibleWhen(this.editor.editing.view.document.selection) ? this._showToolbar(t) : this._hideToolbar(t)
            }
            ...
            _showToolbar(t) {
                this._isToolbarVisible(t) ? function (t) {
                    const e = t.plugins.get("ContextualBalloon"), n = $f(t);
                    e.updatePosition(n)
                }(this.editor) : this._balloon.hasView(t.view) || this._balloon.add({
                    view: t.view,
                    position: $f(this.editor),
        ...
        function $f(t) {
            const e = t.editing.view, n = _h.defaultPositions, o = function (t) {
                const e = t.getSelectedElement();
                if (e && qu(e))return e;
                let n = t.getFirstPosition().parent;
                for (; n;) {
                    if (n.is("element") && qu(n))return n;
                    n = n.parent
                }
        ...
        function Qf(t, e) {
            return new qs(Jf(t, e, !0), Jf(t, e, !1))
        }
        ...
        function Jf(t, e, n) {
            ...
            return i ? Hs.createAt(i, n ? "before" : "after") : t
        }
                ...
                e.change(o=> {
                    if (n.isCollapsed) {
                        ...
                        if (n.hasAttribute("linkHref")) {
                            const e = Qf(n.getFirstPosition(), n.getAttribute("linkHref"));
                            o.setAttribute("linkHref", t, e), o.setSelection(e)
                        } else if ("" !== t) {
                            const i = Rs(n.getAttributes());
                            i.set("linkHref", t);
                            const r = o.createText(t, i);
                            o.insert(r, e), o.setSelection(qs.createOn(r))
                        }
                    } else {
        ...
        class Zf extends ql {
            ...
            execute() {
                ...
                t.change(t=> {
                    const n = e.isCollapsed ? [Qf(e.getFirstPosition(), e.getAttribute("linkHref"))] : e.getRanges();
                    for (const e of n)t.removeAttribute("linkHref", e)
                })
            }
        }
        const Xf = Symbol("linkElement"), tm = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g, em = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i;

        function nm(t, e) {
            const n = e.createAttributeElement("a", {href: t}, {priority: 5});
            return e.setCustomProperty(Xf, !0, n), n
        }

        function om(t) {
            return function (t) {
                return t.replace(tm, "").match(em)
            }(t = String(t)) ? t : "#"
        }
        ...
        class im {
            constructor(t, e, n) {
                this.model = t, this.attribute = n, this._modelSelection = t.document.selection, this._overrideUid = null, this._isNextGravityRestorationSkipped = !1, e.listenTo(this._modelSelection, "change:range", (t, e)=> {
                    this._isNextGravityRestorationSkipped ? this._isNextGravityRestorationSkipped = !1 : this._isGravityOverridden && (!e.directChange && rm(this._modelSelection.getFirstPosition(), n) || this._restoreGravity())
                })
            }

            handleForwardMovement(t, e) {
                const n = this.attribute;
                if (!(this._isGravityOverridden || t.isAtStart && this._hasSelectionAttribute))return cm(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._removeSelectionAttribute(), !0) : sm(t, n) ? (this._preventCaretMovement(e), this._overrideGravity(), !0) : am(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._overrideGravity(), !0) : void 0
            }

            handleBackwardMovement(t, e) {
                const n = this.attribute;
                return this._isGravityOverridden ? cm(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._restoreGravity(), this._removeSelectionAttribute(), !0) : (this._preventCaretMovement(e), this._restoreGravity(), t.isAtStart && this._removeSelectionAttribute(), !0) : cm(t, n) && !this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0) : t.isAtEnd && am(t, n) ? this._hasSelectionAttribute ? void(lm(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity())) : (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0) : t.isAtStart ? this._hasSelectionAttribute ? (this._removeSelectionAttribute(), this._preventCaretMovement(e), !0) : void 0 : void(lm(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity()))
            }
        ...
        n(98);
        const dm = "ck-link_selected";
        class um extends Fl {
            init() {
                const t = this.editor;
                t.model.schema.extend("$text", {allowAttributes: "linkHref"}), t.conversion.for("dataDowncast").add(ca({
                    model: "linkHref",
                    view: nm
                })), t.conversion.for("editingDowncast").add(ca({
                    model: "linkHref",
                    view: (t, e)=>nm(om(t), e)
                })), t.conversion.for("upcast").add(Ra({
                    view: {name: "a", attributes: {href: !0}},
                    model: {key: "linkHref", value: t=>t.getAttribute("href")}
                })), t.commands.add("link", new Kf(t)), t.commands.add("unlink", new Zf(t)), function (t, e, n, o) {
                    const i = new im(e, n, o), r = e.document.selection;
                    n.listenTo(t.document, "keydown", (t, e)=> {
                        if (!r.isCollapsed)return;
                        if (e.shiftKey || e.altKey || e.ctrlKey)return;
                        const n = e.keyCode == hi.arrowright, o = e.keyCode == hi.arrowleft;
                        if (!n && !o)return;
                        const s = r.getFirstPosition();
                        let a;
                        (a = n ? i.handleForwardMovement(s, e) : i.handleBackwardMovement(s, e)) && t.stop()
                    }, {priority: I.get("high") + 1})
            ...
            _setupLinkHighlight() {
                ...
                e.document.registerPostFixer(e=> {
                    ...
                    if (o.hasAttribute("linkHref")) {
                        const i = Qf(o.getFirstPosition(), o.getAttribute("linkHref")), r = t.editing.mapper.toViewRange(i);
                        for (const t of r.getItems())t.is("a") && (e.addClass(dm, t), n.add(t))
                    }
                }), t.conversion.for("editingDowncast").add(t=> {
                    function o() {
                        e.change(t=> {
                            for (const e of n.values())t.removeClass(dm, e), n.delete(e)
                        })
                    }
        ...
        class fm extends xl {
            ...
            render() {
                super.render(), lh({view: this}), [this.urlInputView, this.saveButtonView, this.cancelButtonView].forEach(t=> {
                    this._focusables.add(t), this.focusTracker.add(t.element)
                }), this.keystrokes.listenTo(this.element)
            }
        ...
        var mm = n(30), pm = n.n(mm), gm = n(31), bm = n.n(gm);
        n(102);
        class wm extends xl {
            constructor(t) {
                super(t);
                const e = t.t;
                this.focusTracker = new Kc, this.keystrokes = new Uc, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(e("aq"), pm.a, "unlink"), this.editButtonView = this._createButton(e("ar"), bm.a, "edit"), this.set("href"), this._focusables = new tl, this._focusCycler = new Nl({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {focusPrevious: "shift + tab", focusNext: "tab"}
            ...
            _createButton(t, e, n) {
                const o = new Ld(this.locale);
                return o.set({label: t, icon: e, tooltip: !0}), o.delegate("execute").to(this, n), o
            }

            _createPreviewButton() {
                const t = new Ld(this.locale), e = this.bindTemplate, n = this.t;
                return t.set({
                    withText: !0,
                    tooltip: n("as")
                }), t.extendTemplate({
        ...
        class ym extends Fl {
            ...
            init() {
                const t = this.editor;
                t.editing.view.addObserver(hm), this.actionsView = this._createActionsView(), this.formView = this._createFormView(), this._balloon = t.plugins.get(xh), this._createToolbarLinkButton(), this._enableUserBalloonInteractions()
            }

            _createActionsView() {
                const t = this.editor, e = new wm(t.locale), n = t.commands.get("link"), o = t.commands.get("unlink");
                return e.bind("href").to(n, "value"), e.editButtonView.bind("isEnabled").to(n), e.unlinkButtonView.bind("isEnabled").to(o), this.listenTo(e, "edit", ()=> {
                    ...
                    this._hideUI(), e()
                }), e.keystrokes.set(vm, (t, e)=> {
                    this._addFormView(), e()
                }), e
            }

            _createFormView() {
                const t = this.editor, e = new fm(t.locale), n = t.commands.get("link");
            ...
            _createToolbarLinkButton() {
                ...
                t.keystrokes.set(vm, (t, n)=> {
                    n(), e.isEnabled && this._showUI()
                }), t.ui.componentFactory.add("link", t=> {
                    const o = new Ld(t);
                    return o.isEnabled = !0, o.label = n("al"), o.icon = km.a, o.keystroke = vm, o.tooltip = !0, o.bind("isOn", "isEnabled").to(e, "value", "isEnabled"), this.listenTo(o, "execute", ()=>this._showUI()), o
                })
            }
            ...
            _getSelectedLinkElement() {
                ...
                if (t.isCollapsed)return xm(t.getFirstPosition());
                {
                    const e = t.getFirstRange().getTrimmed(), n = xm(e.start), o = xm(e.end);
                    return n && n == o && Qo.createIn(n).getTrimmed().isEqual(e) ? n : null
                }
            }
        }
        function xm(t) {
            return t.getAncestors().find(t=>(function (t) {
                return t.is("attributeElement") && !!t.getCustomProperty(Xf)
            })(t))
        }
        ...
        class Am extends ql {
            ...
            execute() {
                const t = this.editor.model, e = t.document, n = Array.from(e.selection.getSelectedBlocks()).filter(e=>Tm(e, t.schema)), o = !0 === this.value;
                t.change(t=> {
                    if (o) {
        ...
        function Sm(t, e, n) {
            ...
            const i = e.item;
            Hm(i, function (t, e) {
                const n = e.mapper, o = e.writer, i = "numbered" == t.getAttribute("listType") ? "ol" : "ul", r = function (t) {
                    const e = t.createContainerElement("li");
                    return e.getFillerOffset = Pm, e
                }(o), s = o.createContainerElement(i, null);
                return o.insert($o.createAt(s), r), n.bindElements(t, r), r
            }(i, n), n)
        }

        function Em(t, e, n) {
            const o = n.mapper.toViewPosition(e.position).getLastMatchingPosition(t=>!t.item.is("li")).nodeAfter, i = n.writer;
            i.breakContainer($o.createBefore(o)), i.breakContainer($o.createAfter(o));
            const r = o.parent, s = r.previousSibling, a = Qo.createOn(r), c = i.remove(a);
            s && s.nextSibling && Um(i, s, s.nextSibling), qm(n.mapper.toModelElement(o).getAttribute("listIndent") + 1, e.position, a.start, o, n);
            for (const t of Qo.createIn(c).getItems())n.mapper.unbindViewElement(t);
            t.stop()
        }
        ...
        function Im(t, e, n) {
            ...
            Um(i, r = i.rename(s, r), r.nextSibling), Um(i, r.previousSibling, r);
        ...
        function Nm(t, e, n) {
            ...
            const o = n.mapper.toViewElement(e.item), i = n.writer;
            i.breakContainer($o.createBefore(o)), i.breakContainer($o.createAfter(o));
            const r = o.parent, s = r.previousSibling, a = Qo.createOn(r);
            i.remove(a), s && s.nextSibling && Um(i, s, s.nextSibling), qm(e.attributeOldValue + 1, e.range.start, a.start, o, n), Hm(e.item, o, n);
            for (const t of e.item.getChildren())n.consumable.consume(t, "insert")
        }
        ...
        function Om(t, e, n) {
            if ("listItem" != e.item.name) {
                ...
                for (; ("ul" == t.parent.name || "ol" == t.parent.name) && "li" == (t = o.breakContainer(t)).parent.name;) {
                    const e = t, n = $o.createAt(t.parent, "end");
                    if (!e.isEqual(n)) {
                        const t = o.remove(new Qo(e, n));
                        i.push(t)
                    }
                    t = $o.createAfter(t.parent)
                }
                if (i.length > 0) {
                    for (let e = 0; e < i.length; e++) {
                        const n = t.nodeBefore;
                        if (t = o.insert(t, i[e]).end, e > 0) {
                            const e = Um(o, n, n.nextSibling);
                            e && e.parent == n && t.offset--
                        }
                    }
                    Um(o, t.nodeBefore, t.nodeAfter)
                }
            }
        }
        ...
        function Dm(t, e, n) {
            if (n.consumable.consume(e.viewItem, {name: !0})) {
                ...
                let a = Hs.createAfter(i);
                for (const t of e.viewItem.getChildren())"ul" == t.name || "ol" == t.name ? a = n.convertItem(t, a).modelCursor : n.convertItem(t, Hs.createAt(i, "end"));
                o.indent--, e.modelRange = new qs(e.modelCursor, a), s.cursorParent ? e.modelCursor = Hs.createAt(s.cursorParent) : e.modelCursor = e.modelRange.end
            }
        }
        ...
        function Vm(t, e) {
            ...
            if (n && n.is("listItem")) {
                const t = e.mapper.toViewElement(n), o = t.getAncestors().find(t=>t.is("ul") || t.is("ol")), i = new Go({startPosition: $o.createAt(t, 0)});
                for (const t of i) {
        ...
        function Fm(t, e) {
            ...
            if ("ul" == o.name || "ol" == o.name) {
                if (n.isAtEnd) {
                    ...
                    e.modelPosition = Hs.createBefore(t).getShiftedBy(o)
                } else {
                    const t = i.toModelElement(n.nodeAfter);
                    e.modelPosition = Hs.createBefore(t)
                }
                t.stop()
                ...
                e.modelPosition = Hs.createBefore(r).getShiftedBy(s), t.stop()
            }
        }

        function zm(t, [e,n]) {
            let o, i = e.is("documentFragment") ? e.getChild(0) : e;
            if (o = n ? new Js(n) : this.document.selection, i && i.is("listItem")) {
                const t = o.getFirstPosition();
                let e = null;
                if (t.parent.is("listItem") ? e = t.parent : t.nodeBefore && t.nodeBefore.is("listItem") && (e = t.nodeBefore), e) {
                    const t = e.getAttribute("listIndent");
                    if (t > 0)for (; i && i.is("listItem");)i._setAttribute("listIndent", i.getAttribute("listIndent") + t), i = i.nextSibling
                }
            }
        }

        function Bm(t, e) {
            const n = !!e.sameIndent, o = !!e.smallerIndent, i = t instanceof Fs ? t.getAttribute("listIndent") : e.listIndent;
            let r = t instanceof Fs ? t.previousSibling : t.nodeBefore;
        ...
        function Um(t, e, n) {
            return e && n && ("ul" == e.name || "ol" == e.name) && e.name == n.name ? t.mergeContainers($o.createAfter(e)) : null
        }

        function Hm(t, e, n) {
            const o = e.parent, i = n.mapper, r = n.writer;
            let s = i.toViewPosition(Hs.createBefore(t));
            const a = Bm(t, {sameIndent: !0, smallerIndent: !0}), c = t.previousSibling;
            if (a && a.getAttribute("listIndent") == t.getAttribute("listIndent")) {
                const t = i.toViewElement(a);
                s = r.breakContainer($o.createAfter(t))
            } else s = c && "listItem" == c.name ? i.toViewPosition(Hs.createAt(c, "end")) : i.toViewPosition(Hs.createBefore(t));
            if (s = Wm(s), r.insert(s, o), c && "listItem" == c.name) {
                const t = i.toViewElement(c), n = new Go({
                    boundaries: new Qo($o.createAt(t, 0), s),
                    ignoreElementEnd: !0
                });
                for (const t of n)if (t.item.is("li")) {
                    const o = r.breakContainer($o.createBefore(t.item)), i = t.item.parent, s = $o.createAt(e, "end");
                    Um(r, s.nodeBefore, s.nodeAfter), r.move(Qo.createOn(i), s), n.position = o
                }
            } else {
                ...
                if (n && (n.is("ul") || n.is("ol"))) {
                    ...
                    o && (r.breakContainer($o.createAfter(o)), r.move(Qo.createOn(o.parent), $o.createAt(e, "end")))
                }
            }
            Um(r, o, o.nextSibling), Um(r, o.previousSibling, o)
        }
        ...
        function qm(t, e, n, o, i) {
            const r = Bm(e, {
                ...
                smallerIndent: !0,
                listIndent: t
            }), s = i.mapper, a = i.writer, c = r ? r.getAttribute("listIndent") : null;
            let l;
            if (r)if (c == t) {
                const t = s.toViewElement(r).parent;
                l = $o.createAfter(t)
            } else {
                const t = Hs.createAt(r, "end");
                l = s.toViewPosition(t)
            } else l = n;
            l = Wm(l);
            for (const t of[...o.getChildren()])(t.is("ul") || t.is("ol")) && (l = a.move(Qo.createOn(t), l).end, Um(a, t, t.nextSibling), Um(a, t.previousSibling, t))
        }
        ...
        function Gm(t) {
            let e = 1;
            for (const n of t.getChildren())if ("ul" == n.name || "ol" == n.name)for (const t of n.getChildren())e += Gm(t);
            return e
        }

        var $m = n(33), Qm = n.n($m), Jm = n(34), Km = n.n(Jm);
        class Zm extends Fl {
            init() {
                const t = this.editor.t;
                this._addButton("numberedList", t("m"), Qm.a), this._addButton("bulletedList", t("n"), Km.a)
            }

            _addButton(t, e, n) {
                const o = this.editor;
                o.ui.componentFactory.add(t, i=> {
                    const r = o.commands.get(t), s = new Ld(i);
                    return s.set({
                        label: e,
                        icon: n,
                        tooltip: !0
        ...
        function Xm(t, e) {
            ...
            function n(n, o, i) {
                ...
                const r = o.attributeNewValue, s = i.writer, a = i.mapper.toViewElement(o.item);
                s.remove(Qo.createIn(a));
                const c = t.getMediaViewElement(s, r, e);
                s.insert($o.createAt(a), c)
            }
        }

        const tp = Symbol("isMedia");

        function ep(t, e, n, o) {
            const i = t.createContainerElement("figure", {class: "media"});
            return i.getFillerOffset = op, t.insert($o.createAt(i), e.getMediaViewElement(t, n, o)), i
        }
        ...
        class ip extends ql {
            refresh() {
                const t = this.editor.model, e = t.document.selection, n = t.schema, o = e.getFirstPosition(), i = np(e);
                let r = o.parent;
                r != r.root && (r = r.parent), this.value = i ? i.getAttribute("url") : null, this.isEnabled = n.checkChild(r, "media")
            }

            execute(t) {
                const e = this.editor.model, n = e.document.selection, o = np(n);
                if (o)e.change(e=> {
                    e.setAttribute("url", t, o)
                }); else {
                    const o = $u(n);
                    e.change(n=> {
                        const i = n.createElement("media", {url: t});
                        e.insertContent(i, o), n.setSelection(i, "on")
                    })
                }
            }
        }
        var rp = n(35), sp = n.n(rp);
        const ap = "0 0 64 42";
        class cp {
            constructor(t, e) {
                const n = e.providers, o = e.extraProviders || [], i = new Set(e.removeProviders), r = n.concat(o).filter(t=> {
                    const e = t.name;
                    return e ? !i.has(e) : (fs.a.warn("media-embed-no-provider-name: The configured media provider has no name and cannot be used.", {provider: t}), !1)
                });
            ...
            _getMedia(t) {
                if (!t)return new lp(this.locale);
                t = t.trim();
                for (const e of this.providerDefinitions) {
                    ...
                    for (const e of o) {
                        ...
                        if (o)return new lp(this.locale, t, o, n)
                    }
                }
                return null
            }
            ...
            _getUrlMatches(t, e) {
                ...
                return (n = o.match(e)) ? n : (n = (o = o.replace(/^www\./, "")).match(e)) || null
            }
        }
        class lp {
            constructor(t, e, n, o) {
            ...
            _getPlaceholderHtml() {
                const t = new Dd, e = new Rd;
                return t.text = this._t("Open media in new tab"), e.content = sp.a, e.viewBox = ap, new rl({
                    tag: "div",
                    ...
                    children: [{
                        ...
                        tag: "a",
                        attributes: {class: "ck-media__placeholder__url", target: "new", href: this.url},
                        children: [{
                            tag: "span",
        ...
        class dp extends Fl {
            constructor(t) {
                ...
                }), this.registry = new cp(t.locale, t.config.get("mediaEmbed"))
            }

            init() {
                const t = this.editor, e = t.model.schema, n = t.t, o = t.conversion, i = t.config.get("mediaEmbed.previewsInData"), r = this.registry;
                t.commands.add("mediaEmbed", new ip(t)), e.register("media", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    allowAttributes: ["url"]
                    ...
                    model: "media", view: (t, e)=> {
                        ...
                        return ep(e, r, n, {renderMediaPreview: n && i})
                    }
                })), o.for("dataDowncast").add(Xm(r, {renderMediaPreview: i})), o.for("editingDowncast").add(aa({
                    model: "media",
                    view: (t, e)=> {
                        const o = t.getAttribute("url");
                        return function (t, e, n) {
                            return e.setCustomProperty(tp, !0, t), Wu(t, e, {label: n})
                        }(ep(e, r, o, {renderForEditingView: !0}), e, n("o"))
                    }
                })), o.for("editingDowncast").add(Xm(r, {renderForEditingView: !0})), o.for("upcast").add(Oa({
                    view: {
                        name: "oembed",
                        attributes: {url: !0}
                    }, model: (t, e)=> {
        ...
        class hp extends Fl {
            ...
            init() {
                ...
                this.listenTo(t.plugins.get(Hl), "inputTransformation", ()=> {
                    const t = e.selection.getFirstRange(), n = Pc.createFromPosition(t.start);
                    n.stickiness = "toPrevious";
                    const o = Pc.createFromPosition(t.end);
                    ...
                    this._timeoutId && (Ki.window.clearTimeout(this._timeoutId), this._positionToInsert.detach(), this._timeoutId = null, this._positionToInsert = null)
                }, {priority: "high"})
            }

            _embedMediaBetweenPositions(t, e) {
                const n = this.editor, o = n.plugins.get(dp).registry, i = new Xs(t, e), r = new zs({
                    boundaries: i,
                    ignoreElementEnd: !0
                });
                let s = "";
                for (const t of r)t.item.is("textProxy") && (s += t.item.data);
                (s = s.trim()).match(up) && o.hasMedia(s) && (this._positionToInsert = Pc.createFromPosition(t), this._timeoutId = Ki.window.setTimeout(()=> {
                    n.model.change(t=> {
                        this._timeoutId = null, t.remove(i), "$graveyard" !== this._positionToInsert.root.rootName && t.setSelection(this._positionToInsert), n.commands.execute("mediaEmbed", s), this._positionToInsert.detach(), this._positionToInsert = null
                    })
                }, 100))
            }
        }
        ...
        class fp extends xl {
            ...
            resetErrors() {
                this.urlInputView.errorText = !1
            }

            _createUrlInput() {
                const t = this.locale.t, e = new ah(this.locale, ch);
                return e.label = t("bg"), e.inputView.placeholder = "https://example.com", e
            }
        ...
        class gp extends Fl {
            ...
            init() {
                const t = this.editor, e = t.commands.get("mediaEmbed"), n = t.plugins.get(dp).registry;
                t.ui.componentFactory.add("mediaEmbed", o=> {
                    const i = new fp(function (t, e) {
                        return [e=> {
                            if (!e.url.length)return t("q")
                        }, n=> {
                            if (!e.hasMedia(n.url))return t("r")
                        }]
                    }(t.t, n), o), r = bf(o);
                    return this._setUpDropdown(r, i, e, t), this._setUpForm(i, r, e), r
                })
            }

            _setUpDropdown(t, e, n) {
                const o = this.editor, i = o.t, r = t.buttonView;
                ...
                }), t.on("change:isOpen", ()=>e.resetErrors()), t.on("cancel", ()=>s())
            }
        ...
        function kp() {
            return t=> {
                t.on("element:table", (t, e, n)=> {
                    const o = e.viewItem;
                    if (!n.consumable.test(o, {name: !0}))return;
                    const {rows:i, headingRows:r, headingColumns:s}=function (t) {
                        const e = {headingRows: 0, headingColumns: 0}, n = [], o = [];
                        let i;
                        for (const r of Array.from(t.getChildren()))if ("tbody" === r.name || "thead" === r.name || "tfoot" === r.name) {
                            "thead" !== r.name || i || (i = r);
                            for (const t of Array.from(r.getChildren()))if ("thead" === t.parent.name && t.parent === i)e.headingRows++, n.push(t); else {
                                o.push(t);
                                const n = yp(t);
                                n > e.headingColumns && (e.headingColumns = n)
                            }
                        }
                        return e.rows = [...n, ...o], e
                    }(o), a = {};
                    ...
                    if (l) {
                        if (n.writer.insert(c, l.position), n.consumable.consume(o, {name: !0}), i.length)i.forEach(t=>n.convertItem(t, Hs.createAt(c, "end"))); else {
                            const t = n.writer.createElement("tableRow");
                            n.writer.insert(t, Hs.createAt(c, "end")), _p(n.writer, Hs.createAt(t, "end"))
                        }
                        e.modelRange = new qs(Hs.createBefore(c), Hs.createAfter(c)), l.cursorParent ? e.modelCursor = Hs.createAt(l.cursorParent) : e.modelCursor = e.modelRange.end
                    }
                })
            }
        }
        ...
        function vp(t) {
            return e=> {
                e.on(`element:${t}`, (t, e, n)=> {
                    const o = e.viewItem;
                    if (!n.consumable.test(o, {name: !0}))return;
                    const i = n.writer.createElement("tableCell"), r = n.splitToAllowedParent(i, e.modelCursor);
                    if (!r)return;
                    n.writer.insert(i, r.position), n.consumable.consume(o, {name: !0});
                    const s = Hs.createAt(i);
                    n.convertChildren(o, s), i.childCount || n.writer.insertElement("paragraph", s), e.modelRange = new qs(Hs.createBefore(i), Hs.createAfter(i)), e.modelCursor = e.modelRange.end
                })
            }
        }
        ...
        class xp {
            ...
            next() {
                ...
                if (this._isSpanned(this._row, this._column)) {
                    const t = this._column, e = this._formatOutValue(void 0, t);
                ...
                const n = parseInt(e.getAttribute("colspan") || 1), o = parseInt(e.getAttribute("rowspan") || 1);
                (n > 1 || o > 1) && this._recordSpans(this._row, this._column, o, n);
                const i = this._column, r = this._formatOutValue(e, i, o, n);
            ...
            _formatOutValue(t, e, n = 1, o = 1) {
                return {
                    ...
                    value: {cell: t, row: this._row, column: e, rowspan: n, colspan: o, cellIndex: this._cell}
                }
            }
            ...
            _shouldSkipColumn(t, e) {
                ...
                const n = t === this.column, o = t < this.column && t + e > this.column;
                return !n && !o
            }
            ...
            _recordSpans(t, e, n, o) {
                ...
                for (let i = t + 1; i < t + n; i++)for (let t = e; t <= e + o - 1; t++)this._markSpannedCell(i, t)
            }
        ...
        const Ap = Symbol("isTable");

        function Cp(t) {
            return !!t.getCustomProperty(Ap) && qu(t)
        }
        ...
        function Mp(t) {
            const e = bp("table", t.getFirstPosition());
            return !(!e || !Cp(e.parent))
        }
        ...
        function Pp(t = {}) {
            return e=>e.on("insert:table", (e, n, o)=> {
                ...
                const r = t && t.asWidget, s = o.writer.createContainerElement("figure", {class: "table"}), a = o.writer.createContainerElement("table");
                let c;
                o.writer.insert($o.createAt(s), a), r && (c = function (t, e) {
                    return e.setCustomProperty(Ap, !0, t), Wu(t, e, {hasSelectionHandler: !0})
                }(s, o.writer));
                const l = new xp(i), d = {
                ...
                for (const e of l) {
                    const {row:n, cell:r}=e, s = Fp(Vp(n, d), a, o), c = Lp(i.getChild(n), n, s, o);
                    o.consumable.consume(r, "insert"), Dp(e, d, $o.createAt(c, "end"), o, t)
                }
                const u = o.mapper.toViewPosition(n.range.start);
                o.mapper.bindElements(i, r ? c : s), o.writer.insert(u, r ? c : s)
            })
        }
        ...
        function Sp(t = {}) {
            return e=>e.on("insert:tableRow", (e, n, o)=> {
                const i = n.item;
                if (!o.consumable.consume(i, "insert"))return;
                const r = i.parent, s = Hp(o.mapper.toViewElement(r)), a = r.getChildIndex(i), c = new xp(r, {
                    startRow: a,
                    endRow: a
                }), l = {
                ...
                for (const e of c) {
                    const n = Lp(i, a, Fp(Vp(a, l), s, o), o);
                    o.consumable.consume(e.cell, "insert"), Dp(e, l, $o.createAt(n, "end"), o, t)
                }
            })
        }
        ...
        function Ep(t = {}) {
            return e=>e.on("insert:tableCell", (e, n, o)=> {
                const i = n.item;
                if (!o.consumable.consume(i, "insert"))return;
                const r = i.parent, s = r.parent, a = s.getChildIndex(r), c = new xp(s, {
                    startRow: a,
                    endRow: a
                }), l = {
                ...
                for (const e of c)if (e.cell === i) {
                    const n = o.mapper.toViewElement(r);
                    return void Dp(e, l, $o.createAt(n, r.getChildIndex(i)), o, t)
                }
            })
        }
        ...
        function Ip(t = {}) {
            ...
            return t=>t.on("attribute:headingRows:table", (t, n, o)=> {
                ...
                const r = Hp(o.mapper.toViewElement(i)), s = n.attributeOldValue, a = n.attributeNewValue;
                if (a > s) {
                    const t = Array.from(i.getChildren()).filter(({index:t})=>c(t, s - 1, a));
                    Up(t, Fp("thead", r, o), o, "end");
                    for (const n of t)for (const t of n.getChildren())Op(t, "th", o, e);
                    Bp("tbody", r, o)
                } else {
                    Up(Array.from(i.getChildren()).filter(({index:t})=>c(t, a - 1, s)).reverse(), Fp("tbody", r, o), o);
                    const t = new xp(i, {
                        startRow: a ? a - 1 : a,
                        endRow: s - 1
                    }), n = {
        ...
        function Np(t = {}) {
            ...
            return t=>t.on("attribute:headingColumns:table", (t, n, o)=> {
                ...
                for (const t of new xp(i))t.column > c || Rp(t, r, o, e)
            })
        }

        function Op(t, e, n, o) {
            const i = n.mapper.toViewElement(t);
            if (!i)return;
            let r;
            if (o) {
                r = Gu(n.writer.createEditableElement(e, i.getAttributes()), n.writer), n.writer.insert($o.createAfter(i), r), n.writer.move(Qo.createIn(i), $o.createAt(r)), n.writer.remove(Qo.createOn(i))
            } else r = n.writer.rename(e, i);
            n.mapper.bindElements(t, r)
        }

        function Rp(t, e, n, o) {
            const {cell:i}=t, r = jp(t, e), s = n.mapper.toViewElement(i);
            s && s.name !== r && Op(i, r, n, o)
        }

        function Dp(t, e, n, o, i) {
            const r = i && i.asWidget, s = jp(t, e), a = r ? Gu(o.writer.createEditableElement(s), o.writer) : o.writer.createContainerElement(s), c = t.cell, l = 1 === c.childCount && "paragraph" === c.getChild(0).name;
            if (o.writer.insert(n, a), l) {
                const t = c.getChild(0), e = $o.createAt(a, "end");
                if (o.consumable.consume(t, "insert"), i.asWidget) {
                    const n = [...t.getAttributeKeys()].length ? "p" : "span", i = o.writer.createContainerElement(n);
                    o.mapper.bindElements(t, i), o.writer.insert(e, i), o.mapper.bindElements(c, a)
                } else o.mapper.bindElements(c, a), o.mapper.bindElements(t, a)
            } else o.mapper.bindElements(c, a)
        }

        function Lp(t, e, n, o) {
            let i = o.mapper.toViewElement(t);
            if (!i) {
                o.consumable.consume(t, "insert"), i = o.writer.createContainerElement("tr"), o.mapper.bindElements(t, i);
                const r = t.parent.getAttribute("headingRows") || 0, s = r > 0 && e >= r ? e - r : e, a = $o.createAt(n, s);
                o.writer.insert(a, i)
            }
            return i
        }
        ...
        function jp(t, e) {
            const {row:n, column:o}=t, {headingColumns:i, headingRows:r}=e;
        ...
        function Fp(t, e, n) {
            ...
            return o || function (t, e, n) {
                    ...
                    return n.writer.insert($o.createAt(e, "tbody" == t ? "end" : "start"), o), o
                }(t, e, n)
        }
        ...
        function Bp(t, e, n) {
            const o = zp(t, e);
            o && 0 === o.childCount && n.writer.remove(Qo.createOn(o))
        }

        function Up(t, e, n, o) {
            for (const i of t) {
                const t = n.mapper.toViewElement(i);
                t && n.writer.move(Qo.createOn(t), $o.createAt(e, o))
            }
        }
        ...
        class qp extends Fl {
            ...
            getCellLocation(t) {
                const e = t.parent, n = e.parent, o = n.getChildIndex(e), i = new xp(n, {startRow: o, endRow: o});
                for (const {cell:e, row:n, column:o}of i)if (e === t)return {row: n, column: o}
            }

            createTable(t, e, n) {
                const o = t.createElement("table");
                return Wp(t, o, 0, e, n), o
            }

            insertRows(t, e = {}) {
                const n = this.editor.model, o = e.at || 0, i = e.rows || 1;
                n.change(e=> {
                    const n = t.getAttribute("headingRows") || 0;
                    if (n > o && e.setAttribute("headingRows", n + i, t), 0 === o || o === t.childCount)return void Wp(e, t, o, i, this.getColumns(t));
                    const r = new xp(t, {endRow: o});
                    let s = 0;
            ...
            insertColumns(t, e = {}) {
                const n = this.editor.model, o = e.at || 0, i = e.columns || 1;
                n.change(e=> {
                    const n = t.getAttribute("headingColumns");
                    o < n && e.setAttribute("headingColumns", n + i, t);
                    const r = this.getColumns(t);
                    if (0 === o || r === o) {
                        for (const n of t.getChildren())Yp(i, e, Hs.createAt(n, o ? "end" : 0));
                        return
                    }
                    const s = new xp(t, {column: o, includeSpanned: !0});
                    for (const {row:n, column:r, cell:a, colspan:c, rowspan:l, cellIndex:d}of s)if (r !== o) {
                        if (e.setAttribute("colspan", c + i, a), s.skipRow(n), l > 1)for (let t = n + 1; t < n + l; t++)s.skipRow(t)
                    } else {
                        const o = Hs.createFromParentAndOffset(t.getChild(n), d);
                        Yp(i, e, o)
                    }
                })
            }
            ...
            splitCellVertically(t, e = 2) {
                const n = this.editor.model, o = t.parent.parent, i = parseInt(t.getAttribute("rowspan") || 1), r = parseInt(t.getAttribute("colspan") || 1);
                n.change(n=> {
                    if (r > 1) {
                        const {newCellsSpan:o, updatedSpan:s}=Gp(r, e);
                        wp("colspan", s, t, n);
                        const a = {};
                        o > 1 && (a.colspan = o), i > 1 && (a.rowspan = i), Yp(r > e ? e - 1 : r - 1, n, Hs.createAfter(t), a)
                    }
                    if (r < e) {
                        const s = e - r, a = [...new xp(o)], {column:c}=a.find(({cell:e})=>e === t), l = a.filter(({cell:e, colspan:n, column:o})=> {
                            return e !== t && o === c || o < c && o + n > c
                        });
                        for (const {cell:t, colspan:e}of l)n.setAttribute("colspan", e + s, t);
                        const d = {};
                        i > 1 && (d.rowspan = i), Yp(s, n, Hs.createAfter(t), d);
                        const u = o.getAttribute("headingColumns") || 0;
                        u > c && wp("headingColumns", u + s, o, n)
                    }
                })
            }

            splitCellHorizontally(t, e = 2) {
                const n = this.editor.model, o = t.parent, i = o.parent, r = i.getChildIndex(o), s = parseInt(t.getAttribute("rowspan") || 1), a = parseInt(t.getAttribute("colspan") || 1);
                n.change(n=> {
                    if (s > 1) {
                        const o = [...new xp(i, {
                            startRow: r,
                            endRow: r + s - 1,
                            includeSpanned: !0
                        })], {newCellsSpan:c, updatedSpan:l}=Gp(s, e);
                        wp("rowspan", l, t, n);
                        const {column:d}=o.find(({cell:e})=>e === t), u = {};
                        c > 1 && (u.rowspan = c), a > 1 && (u.colspan = a);
                        for (const {column:t, row:e, cellIndex:s}of o) {
                            if (e >= r + l && t === d && (e + r + l) % c == 0) {
                                Yp(1, n, Hs.createFromParentAndOffset(i.getChild(e), s), u)
                            }
                        }
                    }
                    if (s < e) {
                        const o = e - s, c = [...new xp(i, {startRow: 0, endRow: r})];
                        for (const {cell:e, rowspan:i, row:s}of c)if (e !== t && s + i > r) {
                            const t = i + o;
                            n.setAttribute("rowspan", t, e)
                        }
                        const l = {};
                        a > 1 && (l.colspan = a), Wp(n, i, r + 1, o, 1, l);
                        const d = i.getAttribute("headingRows") || 0;
                        d > r && wp("headingRows", d + o, i, n)
                    }
                })
            }
        ...
        function Wp(t, e, n, o, i, r = {}) {
            for (let s = 0; s < o; s++) {
                ...
                t.insert(o, e, n), Yp(i, t, Hs.createAt(o, "end"), r)
            }
        }

        function Yp(t, e, n, o = {}) {
            for (let i = 0; i < t; i++)_p(e, n, o)
        }
        ...
        class $p extends ql {
            refresh() {
                const t = this.editor.model, e = t.document.selection, n = t.schema, o = function (t) {
                    const e = t.parent;
            ...
            execute(t = {}) {
                const e = this.editor.model, n = e.document.selection, o = this.editor.plugins.get(qp), i = parseInt(t.rows) || 2, r = parseInt(t.columns) || 2, s = $u(n);
                e.change(t=> {
                    const n = o.createTable(t, i, r);
                    e.insertContent(n, s), t.setSelection(Hs.createAt(n.getChild(0).getChild(0).getChild(0)))
                })
            }
        }
        class Qp extends ql {
            ...
            refresh() {
                const t = bp("table", this.editor.model.document.selection.getFirstPosition());
                this.isEnabled = !!t
            }

            execute() {
                const t = this.editor, e = t.model.document.selection, n = t.plugins.get(qp), o = bp("tableCell", e.getFirstPosition()).parent, i = o.parent, r = i.getChildIndex(o), s = "below" === this.order ? r + 1 : r;
                n.insertRows(i, {rows: 1, at: s})
            }
        }
        class Jp extends ql {
            constructor(t, e = {}) {
                super(t), this.order = e.order || "after"
            }
            ...
            execute() {
                const t = this.editor, e = t.model.document.selection, n = t.plugins.get(qp), o = bp("tableCell", e.getFirstPosition()), i = o.parent.parent, {column:r}=n.getCellLocation(o), s = "after" === this.order ? r + 1 : r;
                n.insertColumns(i, {columns: 1, at: s})
            }
        }
        class Kp extends ql {
            constructor(t, e = {}) {
            ...
            refresh() {
                const t = bp("tableCell", this.editor.model.document.selection.getFirstPosition());
                this.isEnabled = !!t
            }

            execute() {
                const t = bp("tableCell", this.editor.model.document.selection.getFirstPosition()), e = "horizontally" === this.direction, n = this.editor.plugins.get(qp);
        ...
        class Zp extends ql {
            ...
            execute() {
                const t = this.editor.model, e = bp("tableCell", t.document.selection.getFirstPosition()), n = this.value, o = this.direction;
                t.change(t=> {
                    const i = "right" == o || "down" == o, r = i ? e : n, s = i ? n : e, a = s.parent;
                    !function (t, e, n) {
                        Xp(t) || (Xp(e) && n.remove(qs.createIn(e)), n.move(qs.createIn(t), Hs.createAt(e, "end")));
                        n.remove(t)
                    }(s, r, t);
                    const c = this.isHorizontal ? "colspan" : "rowspan", l = parseInt(e.getAttribute(c) || 1), d = parseInt(n.getAttribute(c) || 1);
                    t.setAttribute(c, l + d, r), t.setSelection(qs.createIn(r)), a.childCount || function (t, e) {
                        const n = t.parent, o = n.getChildIndex(t);
                        for (const {cell:t, row:i, rowspan:r}of new xp(n, {endRow: o})) {
                            const n = i + r - 1 >= o;
                            n && wp("rowspan", r - 1, t, e)
                        }
                        e.remove(t)
                    }(a, t)
                })
            ...
            _getMergeableCell() {
                const t = bp("tableCell", this.editor.model.document.selection.getFirstPosition());
                if (!t)return;
                const e = this.editor.plugins.get(qp), n = this.isHorizontal ? function (t, e, n) {
                    const o = "right" == e ? t.nextSibling : t.previousSibling;
                    if (!o)return;
                    const i = "right" == e ? t : o, r = "right" == e ? o : t, {column:s}=n.getCellLocation(i), {column:a}=n.getCellLocation(r), c = parseInt(i.getAttribute("colspan") || 1);
                    return s + c === a ? o : void 0
                }(t, this.direction, e) : function (t, e) {
                    const n = t.parent, o = n.parent, i = o.getChildIndex(n);
                    if ("down" == e && i === o.childCount - 1 || "up" == e && 0 === i)return;
                    const r = parseInt(t.getAttribute("rowspan") || 1), s = o.getAttribute("headingRows") || 0;
                    if (s && ("down" == e && i + r === s || "up" == e && i === s))return;
                    const a = parseInt(t.getAttribute("rowspan") || 1), c = "down" == e ? i + a : i, l = [...new xp(o, {endRow: c})], d = l.find(e=>e.cell === t).column, u = l.find(({row:t, rowspan:n, column:o})=>o === d && ("down" == e ? t === c : c === t + n));
                    return u && u.cell
                }(t, this.direction);
                if (!n)return;
                const o = this.isHorizontal ? "rowspan" : "colspan", i = parseInt(t.getAttribute(o) || 1);
        ...
        class tg extends ql {
            ...
            execute() {
                const t = this.editor.model, e = bp("tableCell", t.document.selection.getFirstPosition()).parent, n = e.parent, o = n.getChildIndex(e), i = n.getAttribute("headingRows") || 0;
                t.change(t=> {
                    i && o <= i && wp("headingRows", i - 1, n, t, 0);
                    const r = [...new xp(n, {endRow: o})], s = new Map;
                    r.filter(({row:t, rowspan:e})=>t === o && e > 1).forEach(({column:t, cell:e, rowspan:n})=>s.set(t, {
                        cell: e,
                        rowspanToSet: n - 1
                    })), r.filter(({row:t, rowspan:e})=>t <= o - 1 && t + e > o).forEach(({cell:e, rowspan:n})=>wp("rowspan", n - 1, e, t));
                    const a = o + 1, c = new xp(n, {includeSpanned: !0, startRow: a, endRow: a});
                    let l;
                    for (const {row:e, column:o, cell:i}of[...c])if (s.has(o)) {
                        const {cell:i, rowspanToSet:r}=s.get(o), a = l ? Hs.createAfter(l) : Hs.createAt(n.getChild(e));
                        t.move(qs.createOn(i), a), wp("rowspan", r, i, t), l = i
                    } else l = i;
                    t.remove(e)
                })
            }
        ...
        class eg extends ql {
            refresh() {
                const t = this.editor, e = t.model.document.selection, n = t.plugins.get(qp), o = bp("tableCell", e.getFirstPosition());
                this.isEnabled = !!o && n.getColumns(o.parent.parent) > 1
            }

            execute() {
                const t = this.editor.model, e = bp("tableCell", t.document.selection.getFirstPosition()), n = e.parent, o = n.parent, i = o.getAttribute("headingColumns") || 0, r = o.getChildIndex(n), s = [...new xp(o)], a = s.find(t=>t.cell === e).column;
                t.change(t=> {
                    i && r <= i && t.setAttribute("headingColumns", i - 1, o);
                    for (const {cell:e, column:n, colspan:o}of s)n <= a && o > 1 && n + o > a ? wp("colspan", o - 1, e, t) : n === a && t.remove(e)
                })
            }
        }
        class ng extends ql {
            refresh() {
                const t = bp("tableCell", this.editor.model.document.selection.getFirstPosition()), e = !!t;
                this.isEnabled = e, this.value = e && this._isInHeading(t, t.parent.parent)
            }

            execute() {
                const t = this.editor.model, e = bp("tableCell", t.document.selection.getFirstPosition()).parent, n = e.parent, o = n.getAttribute("headingRows") || 0, i = e.index, r = o > i ? i : i + 1;
                t.change(t=> {
                    if (r) {
                        const e = function (t, e, n) {
                            const o = [], i = new xp(t, {startRow: e > n ? n : 0, endRow: e - 1});
                            for (const {row:t, rowspan:n, cell:r}of i)n > 1 && t + n > e && o.push(r);
                            return o
                        }(n, r, o);
                        for (const n of e)og(n, r, t)
                    }
                    wp("headingRows", r, n, t, 0)
                })
            }
        ...
        function og(t, e, n) {
            const o = t.parent, i = o.parent, r = e - o.index, s = {}, a = parseInt(t.getAttribute("rowspan")) - r;
            a > 1 && (s.rowspan = a);
            const c = i.getChildIndex(o), l = c + r, d = [...new xp(i, {startRow: c, endRow: l, includeSpanned: !0})];
            let u;
            for (const {row:e, column:o, cell:r, colspan:a, cellIndex:c}of d)if (r === t && (u = o, a > 1 && (s.colspan = a)), void 0 !== u && u === o && e === l) {
                const t = i.getChild(e);
                _p(n, Hs.createFromParentAndOffset(t, c), s)
            }
            wp("rowspan", r, t, n)
        }
        ...
        class ig extends ql {
            ...
            execute() {
                const t = this.editor.model, e = t.document.selection, n = this.editor.plugins.get("TableUtils"), o = bp("tableCell", e.getFirstPosition().parent), i = o.parent.parent, r = parseInt(i.getAttribute("headingColumns") || 0), {column:s}=n.getCellLocation(o), a = r > s ? s : s + 1;
                t.change(t=> {
                    wp("headingColumns", a, i, t, 0)
                })
            }

            _isInHeading(t, e) {
                const n = parseInt(e.getAttribute("headingColumns") || 0), o = this.editor.plugins.get("TableUtils"), {column:i}=o.getCellLocation(t);
                return !!n && i < n
            }
        }
        function rg(t) {
            t.document.registerPostFixer(e=>(function (t, e) {
                ...
                for (const e of n) {
                    let n;
                    "table" == e.name && "insert" == e.type && (n = e.position.nodeAfter), "tableRow" != e.name && "tableCell" != e.name || (n = bp("table", e.position)), cg(e) && (n = bp("table", e.range.start)), n && !i.has(n) && (o = sg(n, t) || o, o = ag(n, t) || o, i.add(n))
                }
                return o
            })(e, t))
        }
        ...
        function sg(t, e) {
            let n = !1;
            const o = function (t) {
                const e = parseInt(t.getAttribute("headingRows") || 0), n = t.childCount, o = [];
                for (const {row:i, rowspan:r, cell:s}of new xp(t)) {
                    if (r < 2)continue;
                    const t = i < e, a = t ? e : n;
                    if (i + r > a) {
                        const t = a - i;
                        o.push({cell: s, rowspan: t})
                    }
                }
                return o
            }(t);
            if (o.length) {
                n = !0;
                for (const t of o)wp("rowspan", t.rowspan, t.cell, e, 1)
            }
            return n
        }
        ...
        function ag(t, e) {
            ...
            const o = function (t) {
                const e = {};
                for (const {row:n}of new xp(t, {includeSpanned: !0}))e[n] || (e[n] = 0), e[n] += 1;
                return e
            }(t), i = o[0];
            if (!Object.values(o).every(t=>t === i)) {
                ...
                for (const [r,s]of Object.entries(o)) {
                    const o = i - s;
                    if (o) {
                        for (let n = 0; n < o; n++)_p(e, Hs.createAt(t.getChild(r), "end"));
                        n = !0
                    }
                }
            }
        ...
        function lg(t) {
            t.document.registerPostFixer(e=>(function (t, e) {
                const n = e.document.differ.getChanges();
                let o = !1;
                for (const e of n)"remove" == e.type && e.position.parent.is("tableCell") && (o = hg(e.position.parent, t) || o), "insert" == e.type && ("table" == e.name && (o = dg(e.position.nodeAfter, t) || o), "tableRow" == e.name && (o = ug(e.position.nodeAfter, t) || o), "tableCell" == e.name && (o = hg(e.position.nodeAfter, t) || o));
                return o
            })(e, t))
        }
        ...
        function dg(t, e) {
            let n = !1;
            for (const o of t.getChildren())n = ug(o, e) || n;
            return n
        }
        ...
        function hg(t, e) {
            return 0 == t.childCount && (e.insertElement("paragraph", t), !0)
        }
        ...
        function fg(t, e) {
            e.view.document.registerPostFixer(n=>(function (t, e, n, o) {
                let i = !1;
                const r = function (t) {
                    const e = Array.from(t._renderer.markedAttributes).filter(t=>!!t.parent).filter(pg).filter(t=>gg(t.parent)), n = Array.from(t._renderer.markedChildren).filter(t=>!!t.parent).filter(gg).reduce((t, e)=> {
                        const n = Array.from(e.getChildren()).filter(pg);
                        return [...t, ...n]
                    }, []);
                    return [...e, ...n]
                }(o);
                for (const e of r)i = mg(e, n, t) || i;
                i && function (t, e, n) {
                    const o = Array.from(t.getRanges()).map(t=>e.toViewRange(t));
                    n.setSelection(o, {backward: t.isBackward})
        ...
        function mg(t, e, n) {
            const o = e.toModelElement(t), i = function (t, e) {
                const n = t.childCount > 1, o = !![...e.getAttributes()].length;
                return n || o ? "p" : "span"
            }(o.parent, o);
            if (t.name !== i) {
        ...
        class bg extends Fl {
            init() {
                const t = this.editor, e = t.model, n = e.schema, o = t.conversion;
                n.register("table", {
                    allowWhere: "$block",
                    ...
                    if (Array.from(t.getNames()).includes("table"))return "image" != e.name && "media" != e.name && void 0
                }), o.for("upcast").add(kp()), o.for("editingDowncast").add(Pp({asWidget: !0})), o.for("dataDowncast").add(Pp()), o.for("upcast").add(Oa({
                    model: "tableRow",
                    view: "tr"
                })), o.for("editingDowncast").add(Sp({asWidget: !0})), o.for("dataDowncast").add(Sp()), o.for("downcast").add(t=>t.on("remove:tableRow", (t, e, n)=> {
                    t.stop();
                    const o = n.mapper.toViewPosition(e.position).getLastMatchingPosition(t=>!t.item.is("tr")).nodeAfter, i = o.parent, r = Qo.createOn(o), s = n.writer.remove(r);
                    for (const t of Qo.createIn(s).getItems())n.mapper.unbindViewElement(t);
                    i.childCount || n.writer.remove(Qo.createOn(i))
                }, {priority: "higher"})), o.for("upcast").add(vp("td")), o.for("upcast").add(vp("th")), o.for("editingDowncast").add(Ep({asWidget: !0})), o.for("dataDowncast").add(Ep()), o.attributeToAttribute({
                    model: "colspan",
                    view: "colspan"
                }), o.attributeToAttribute({
                    model: "rowspan",
                    view: "rowspan"
                }), o.for("editingDowncast").add(Np({asWidget: !0})), o.for("dataDowncast").add(Np()), o.for("editingDowncast").add(Ip({asWidget: !0})), o.for("dataDowncast").add(Ip()), fg(t.model, t.editing), t.commands.add("insertTable", new $p(t)), t.commands.add("insertTableRowAbove", new Qp(t, {order: "above"})), t.commands.add("insertTableRowBelow", new Qp(t, {order: "below"})), t.commands.add("insertTableColumnBefore", new Jp(t, {order: "before"})), t.commands.add("insertTableColumnAfter", new Jp(t, {order: "after"})), t.commands.add("removeTableRow", new tg(t)), t.commands.add("removeTableColumn", new eg(t)), t.commands.add("splitTableCellVertically", new Kp(t, {direction: "vertically"})), t.commands.add("splitTableCellHorizontally", new Kp(t, {direction: "horizontally"})), t.commands.add("mergeTableCellRight", new Zp(t, {direction: "right"})), t.commands.add("mergeTableCellLeft", new Zp(t, {direction: "left"})), t.commands.add("mergeTableCellDown", new Zp(t, {direction: "down"})), t.commands.add("mergeTableCellUp", new Zp(t, {direction: "up"})), t.commands.add("setTableColumnHeader", new ig(t)), t.commands.add("setTableRowHeader", new ng(t)), rg(e), lg(e), this.editor.keystrokes.set("Tab", (...t)=>this._handleTabOnSelectedTable(...t), {priority: "low"}), this.editor.keystrokes.set("Tab", this._getTabHandler(!0), {priority: "low"}), this.editor.keystrokes.set("Shift+Tab", this._getTabHandler(!1), {priority: "low"})
            }
            ...
            _getTabHandler(t) {
                const e = this.editor;
                return (n, o)=> {
                    const i = bp("tableCell", e.model.document.selection.getFirstPosition());
                    if (!i)return;
                    o();
                    const r = i.parent, s = r.parent, a = s.getChildIndex(r), c = r.getChildIndex(i), l = 0 === c;
                    if (!t && l && 0 === a)return;
                    const d = c === r.childCount - 1, u = a === s.childCount - 1;
                    let h;
                    if (t && u && d && e.plugins.get(qp).insertRows(s, {at: s.childCount}), t && d) {
        ...
        var kg = n(37), vg = n.n(kg), yg = n(38), xg = n.n(yg), Ag = n(39), Cg = n.n(Ag), Tg = n(40), Mg = n.n(Tg);
        class Pg extends Fl {
            init() {
                const t = this.editor, e = this.editor.t;
                t.ui.componentFactory.add("insertTable", n=> {
                    const o = t.commands.get("insertTable"), i = bf(n);
                    i.bind("isEnabled").to(o), i.buttonView.set({icon: vg.a, label: e("s"), tooltip: !0});
                    const r = new wg(n);
                    ...
                    const n = [{
                        type: "switchbutton",
                        model: {commandName: "setTableColumnHeader", label: e("t"), bindIsOn: !0}
                    }, {type: "separator"}, {
                        type: "button",
                        model: {commandName: "insertTableColumnBefore", label: e("u")}
                    }, {type: "button", model: {commandName: "insertTableColumnAfter", label: e("v")}}, {
                        type: "button",
                        model: {commandName: "removeTableColumn", label: e("w")}
                    }];
                    return this._prepareDropdown(e("x"), xg.a, n, t)
                }), t.ui.componentFactory.add("tableRow", t=> {
                    const n = [{
                        type: "switchbutton",
                        model: {commandName: "setTableRowHeader", label: e("y"), bindIsOn: !0}
                    }, {type: "separator"}, {
                        type: "button",
                        model: {commandName: "insertTableRowBelow", label: e("z")}
                    }, {type: "button", model: {commandName: "insertTableRowAbove", label: e("aa")}}, {
                        type: "button",
                        model: {commandName: "removeTableRow", label: e("ab")}
                    }];
                    return this._prepareDropdown(e("ac"), Cg.a, n, t)
                }), t.ui.componentFactory.add("mergeTableCells", t=> {
                    const n = [{
                        type: "button",
                        model: {commandName: "mergeTableCellUp", label: e("ad")}
                    }, {type: "button", model: {commandName: "mergeTableCellRight", label: e("ae")}}, {
                        type: "button",
                        model: {commandName: "mergeTableCellDown", label: e("af")}
                    }, {
                        type: "button",
                        model: {commandName: "mergeTableCellLeft", label: e("ag")}
                    }, {type: "separator"}, {
                        type: "button",
                        model: {commandName: "splitTableCellVertically", label: e("ah")}
                    }, {type: "button", model: {commandName: "splitTableCellHorizontally", label: e("ai")}}];
                    return this._prepareDropdown(e("aj"), Mg.a, n, t)
                })
            }

            _prepareDropdown(t, e, n, o) {
                const i = this.editor, r = bf(o), s = [], a = new ti;
                for (const t of n)Sg(t, i, s, a);
                return wf(r, a), r.buttonView.set({
                    label: t,
                    icon: e,
                    tooltip: !0
        ...
        function Sg(t, e, n, o) {
            const i = t.model = new af(t.model), {commandName:r, bindIsOn:s}=t.model;
            if ("separator" !== t.type) {
                const t = e.commands.get(r);
                n.push(t), i.set({commandName: r}), i.bind("isEnabled").to(t), s && i.bind("isOn").to(t, "value")
            }
            i.set({withText: !0}), o.add(t)
        }
        ...
        Eg.builtinPlugins = [class extends Fl {
            static get requires() {
                return [Hl, Ql, Xl, gd, Ud]
            }
            ...
            init() {
                ...
                t && (this.editor.plugins.get(Wd).createUploadAdapter = (e=>new Kd(e, t, this.editor.t)))
            }
        }, class extends Fl {
            static get pluginName() {
                return "Autoformat"
            ...
            _addListAutoformats() {
                ...
                t.get("bulletedList") && new Zd(this.editor, /^[*-]\s$/, "bulletedList"), t.get("numberedList") && new Zd(this.editor, /^\d+[.|)]\s$/, "numberedList")
            }

            _addBasicStylesAutoformats() {
                const t = this.editor.commands;
                t.get("bold") && (new Xd(this.editor, /(\*\*)([^*]+)(\*\*)$/g, "bold"), new Xd(this.editor, /(__)([^_]+)(__)$/g, "bold")), t.get("italic") && (new Xd(this.editor, /(?:^|[^*])(\*)([^*_]+)(\*)$/g, "italic"), new Xd(this.editor, /(?:^|[^_])(_)([^_]+)(_)$/g, "italic")), t.get("code") && new Xd(this.editor, /(`)([^`]+)(`)$/g, "code")
            }
            ...
            _addBlockQuoteAutoformats() {
                this.editor.commands.get("blockQuote") && new Zd(this.editor, /^>\s$/, "blockQuote")
            }
        }, class extends Fl {
            static get requires() {
                return [ou, au]
            ...
            afterInit() {
                const t = this.editor;
                t.plugins.get(Gf).register("image", {items: t.config.get("image.toolbar") || [], visibleWhen: Ku})
            }
        }, Jh, class extends Fl {
            static get requires() {
                return [um, ym]
            ...
            afterInit() {
                const t = this.editor, e = t.plugins.get(Gf), n = t.config.get("table.contentToolbar"), o = t.config.get("table.toolbar"), i = t.config.get("table.tableToolbar");
                o && console.warn("`config.table.toolbar` is deprecated and will be removed in the next major release. Use `config.table.contentToolbar` instead."), (n || o) && e.register("tableContent", {
                    items: n || o,
                    visibleWhen: Mp
                }), i && e.register("table", {items: i, visibleWhen: Tp})
            }
        }], Eg.defaultConfig = {
            toolbar: {items: ["heading", "|", "bold", "italic", "link", "bulletedList", "numberedList", "imageUpload", "blockQuote", "insertTable", "mediaEmbed", "undo", "redo"]},

...
var ZeroClipboard_TableTools = {
	...
	dispatch: function(id, eventName, args) {
		// receive event from flash movie, send to customer
	...
	register: function(id, client) {
		// register new customer to receive event
	...
	Client: function(elem) {
		// constructor for new simple upload customer
		this.handlers = {};
		...
		// register customer with singleton to receive flash event

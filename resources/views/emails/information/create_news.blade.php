    ...
    <div style="max-width: 700px; padding:50px 0;  margin: 0px auto; font-size: 14px">
        ...
        <div style="padding: 40px; background: #fff;">
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
                    <td><b>{{ $name }},</b>
                        <p>@lang("strings.email.news_created.line_1")&nbsp;&nbsp;&nbsp; <br><strong>@lang('label.news')</strong>:{!! $news->title !!}</p>

                        <a href="{!! route('news.show',$news->uuid) !!}" style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #32CD32; border-radius: 60px; text-decoration:none;"> @lang("buttons.email.read_news") </a>

                        <p>@lang("strings.email.tender_application.line_2")&nbsp;&nbsp;<a href="{{ route("news.show",$news->uuid) }}">{{ route("news.show",$news->uuid) }}</a></p>

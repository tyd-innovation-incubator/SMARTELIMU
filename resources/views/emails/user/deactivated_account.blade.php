    ...
    <div style="max-width: 700px; padding:50px 0;  margin: 0px auto; font-size: 14px">
        ...
        <div style="padding: 40px; background: #fff;">
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
                    <td><b>{{ $name }},</b>
                        <p>{!! trans('alert.stakeholder.company.sms.deactivated', ['name' => $name]) !!}</p>

                        <a href="{{ route("register") }}" style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #32CD32; border-radius: 60px; text-decoration:none;"> @lang("buttons.email.confirm_account") </a>

                        <p>@lang("strings.email.confirm_account.line_2")&nbsp;&nbsp;<a href="{{ route("register") }}">{{ route("register") }}</a></p>

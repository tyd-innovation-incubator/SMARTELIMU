                ...
                <div class="row">
                    <div class="col-md-9 blog-pull-right">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="service-block bg-white">
                                        ...
                                        <div class="content text-left flip p-25 pt-0">
                                            ...
                                            <a class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10" href="{!! route('lessons.view',$package->uuid) !!}">view details</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        @else
                            ...
                            <span class="text-highlight bg-theme-colored">{!! trans('label.no_course') !!}</span>
                        @endif
                            ...
                            <div class="widget">
                                ...
                                <div class="categories">
                                    ...
                                    <ul class="list list-border angle-double-right">
                                        <li><a href="#">{!! trans('label.primary_level') !!}<span>(19)</span></a></li>
                                        <li><a href="#">{!! trans('label.secondary_level') !!}<span>(21)</span></a></li>
                                        <li><a href="#">{!! trans('label.extra_primary') !!}<span>(15)</span></a></li>
                                        <li><a href="#">{!! trans('label.extra_secondary') !!}<span>(35)</span></a></li>
                                    </ul>
                                </div>
                            </div>
